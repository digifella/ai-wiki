...
## Key Examples
- **[[concepts/cpu-optimized-tts|Kitten TTS]]**: [[concepts/open-source|Open-source]], CPU-optimized [[concepts/text-to-speech-synthesis|text-to-speech]] framework ([[concepts/model-size|model size]] <25MB) for [[concepts/edge-deployment|edge deployment]] and [[concepts/browser-based-applications|browser-based applications]], developed by [[entities/kitten-ml|Kitten ML]].
