...
Here is a [[concepts/markdown|Markdown]] [[concepts/summary|summary]] of the video reviewing **Kitten TTS**.
...
The video demonstrated a comparison between the [[concepts/models|models]] using a [[entities/google-colab|Google Colab]] notebook (running entirely on CPU).
