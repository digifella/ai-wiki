...
The [[concepts/private-archaeology|Danish metal detecting program]] operates within a [[concepts/canvas|structured framework]] where amateur detectorists receive [[concepts/training|training]] and official status before conducting searches. Participants must follow established protocols for documentation and reporting of finds. This system allows archaeologists to benefit from expanded fieldwork capacity while maintaining [[concepts/open-standards|standards]] for artifact [[concepts/preservation|preservation]] and contextual recording. The coordination between amateur detectorists and professional archaeologists helps ensure that discovered artifacts are properly assessed and integrated into the archaeological record.
