...
* **[[concepts/llm-backend|LLM Backend]] Flexibility:** It supports both cloud-based Large Language [[concepts/models|Models]] (LLMs) like [[entities/gemini-ai|Google's Gemini]] family and open-source on-device models. \[1:06\]
