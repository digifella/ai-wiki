...
The system enables robots to learn and execute [[concepts/complex-tasks|complex tasks]] by bridging the divide between virtual [[concepts/training|training]] environments and physical [[concepts/deployment|deployment]]. By developing techniques that allow simulated [[concepts/learning|learning]] to transfer more effectively to real-world robotic systems, DreamDojo AI aims to reduce the costly and time-consuming process of retraining robots in physical settings.
