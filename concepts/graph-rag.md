...
- "[[concepts/graphrag|graph-rag]]"
  ...
  - "graph-traversal"
  - "model-agnostic"
  - "context-[[concepts/accuracy|precision]]"
aliases:
...
[[concepts/graph-retrieval-augmented-generation|Graph Retrieval Augmented Generation]] ([[concepts/llm-rag|Graph RAG]]) leverages [[concepts/knowledge-graphs|Knowledge Graphs]] and [[concepts/large-language-model]]s (LLMs) to query structured [[concepts/relationships|relationships]] for enhanced [[concepts/document-retrieval|retrieval]] in [[concepts/rag]] systems, offering a more precise alternative to traditional [[concepts/vector-search|Vector Search]].
...
|----------------|-------------------------------------|------------------------------------|
| [[concepts/embedding-based-retrieval|Vector Search]]  | Lacks structured relationship querying | Enables precise relationship queries |
