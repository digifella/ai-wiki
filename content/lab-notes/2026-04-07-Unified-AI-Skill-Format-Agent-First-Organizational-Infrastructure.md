...
**Clip title:** [[entities/anthropic-institute|Anthropic]], OpenAI, and Microsoft Just Agreed on One File
...
Anthropic in October. The [[entities/speaker|speaker]] argues that the traditional view of
...
[[concepts/agents|agents]] now making hundreds of skill calls per run, compared to humans
...
PowerPoint, [[concepts/claude|Claude]], and [[concepts/copilot-chat|Copilot]], integrating into broader business and
personal workflows.
...
skills has shifted from humans to [[concepts/ai-connectors|AI agents]], demanding that skills be
...
discovery of best practices. The speaker emphasizes that, unlike prompts,
...
versioning for skills to measure and improve their performance over time.
...
probabilistic reasoning:** This allows for a robust and adaptable AI
...
and AI agents. High-performing teams are adopting a three-tier skill
...
- [Version-controlled assets](https://en.wikipedia.org/wiki/Version-controlled_assets) — [Wikipedia](https://en.wikipedia.org/wiki/Version-controlled_assets)
- Markdown-based [[concepts/instructions|instructions]] — [Wikipedia](https://en.wikipedia.org/wiki/Markdown-based_instructions)
- [Skill trading](https://en.wikipedia.org/wiki/Skill_trading) — [Wikipedia](https://en.wikipedia.org/wiki/Skill_trading)
- Deterministic vs. Probabilistic [[concepts/reasoning|reasoning]] — [Wikipedia](https://en.wikipedia.org/wiki/Deterministic_vs._Probabilistic_reasoning)
...
- [Skill routing signals](https://en.wikipedia.org/wiki/Skill_routing_signals) — [Wikipedia](https://en.wikipedia.org/wiki/Skill_routing_signals)
- Continuous [[concepts/testing|testing]] and versioning — [Wikipedia](https://en.wikipedia.org/wiki/Continuous_testing_and_versioning)
- [Agent-driven skill invocation](https://en.wikipedia.org/wiki/Agent-driven_skill_invocation) — [Wikipedia](https://en.wikipedia.org/wiki/Agent-driven_skill_invocation)
- Skill-driven [[concepts/automation|automation]] — [Wikipedia](https://en.wikipedia.org/wiki/Skill-driven_automation)
- [Agent-first development](https://en.wikipedia.org/wiki/Agent-first_development) — [Wikipedia](https://en.wikipedia.org/wiki/Agent-first_development)
