...
This video details OpenAI's release of new open-source/open-weight models, named **GPT-OSS**, highlighting their capabilities, [[concepts/architecture|architecture]], and safety considerations.
...
* The models are named GPT-OSS and are released under the flexible **[[concepts/apache-2.0-license|Apache 2.0 license]]**, offering benefits like lower cost, [[concepts/customization|customizability]], and local deployment potential.
...
* **Compatibility:** The models are compatible with the Responses API and are designed to be used within agentic frameworks (e.g., Crew AI).
