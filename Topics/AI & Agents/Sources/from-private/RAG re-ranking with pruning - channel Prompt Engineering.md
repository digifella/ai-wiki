...
## Related Concepts
- [[concepts/rag-re-ranking|RAG re-ranking]] — [Wikipedia](https://en.wikipedia.org/wiki/RAG_re-ranking)
- [[concepts/model-pruning|Pruning]] — [Wikipedia](https://en.wikipedia.org/wiki/Pruning)
- [[concepts/efficient-information-retrieval|Efficient Information Retrieval]] — [Wikipedia](https://en.wikipedia.org/wiki/Efficient_Information_Retrieval)
- Context Pruning — [Wikipedia](https://en.wikipedia.org/wiki/Context_Pruning)
- Provence — [Wikipedia](https://en.wikipedia.org/wiki/Provence)