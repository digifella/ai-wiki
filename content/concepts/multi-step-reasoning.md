...
The process of decomposing a complex problem into a sequence of discrete, logical operations or "steps" to arrive [[concepts/assistive-technology|at]] a final [[concepts/solution|solution]] or conclusion.
...
- Relies on the ability to process and integrate disparate data types (e.g., [[concepts/text|text]], [[concepts/code|code]], and [[concepts/computer-vision|vision]]) within a single logical [[concepts/flow|flow]].
- Often implemented through Chain-of-Thought (CoT) architectures.

### Advancements in Large Language Models
- **[[entities/gemini-3|Gemini 3]] [[concepts/adoption|Implementation]]:**
	- Capable of executing 10-15 sequential steps of [[concepts/reasoning|reasoning]] within a single task.
	- Simultaneous processing of video, [[concepts/images|images]], and [[concepts/software|code]] to inform the reasoning chain.
