...
- **Functionality**: Eliminates data access limitations by connecting AI [[concepts/models|models]] directly to external sources and systems; without MCP, models are restricted to data uploaded directly into the chat.
