...
Tracking software [[concepts/version-numbers|versioning]], feature releases, and CLI [[concepts/software-updates|updates]] within the [[concepts/knowledge-base|knowledge base]].

## Recent Updates

### Claude Code (v2.0.70 - v2.0.72)
*   **Date:** December 2025
*   **Source:** [[entities/ray-amjad|Ray Amjad]] channel ([[concepts/claude-code|Claude Code]])
*   **Link:** <https://www.youtube.com/watch?v=rXTvax9pyhs>

#### Key Features
*   **[[entities/claude-in-chrome|Claude in Chrome]] (Beta)**
    *   Direct CLI control over the [[concepts/claude|Claude]] in Chrome [[concepts/chrome-extension|browser extension]].
    *   Bridges [[concepts/cli|terminal]] [[concepts/commands|commands]] with web browser workflows.
