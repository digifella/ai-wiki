...
Here is a summary and review of **Junie**, JetBrains' new [[concepts/smart-coding-agent|smart coding agent]], based on the provided video transcript.
...
* **Model Flexibility:** It utilizes top-tier models like [[entities/claude-4|Claude]] 3.5 Sonnet, [[concepts/gemini|Gemini]] 1.5 Pro, and GPT-4o.
