...
Smart Objects are special layer containers in [[concepts/photoshop|Adobe Photoshop]] that preserve the original source content of an image or imported file while allowing editors to apply transformations and [[concepts/adjustments|adjustments]] without permanently altering the underlying data. When a layer is converted to a Smart Object, Photoshop stores a linked or embedded version of the source material, enabling users to scale, rotate, and warp [[concepts/images|images]] multiple times without degradation. This non-destructive approach is particularly valuable in [[concepts/photo-editing|photo editing]] workflows where adjustments need to be refined or reversed during the creative process.
