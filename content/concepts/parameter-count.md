...
The number of [[concepts/parameters|Parameters]] in a [[concepts/large-language-model]] (LLM) directly determines model capacity, [[concepts/training|training]] complexity, and resource requirements. For example, [[entities/nvidia|NVIDIA]]'s [[entities/llama|Llama]] 3.1 [[entities/nemotron|Nemotron]] 70B (70.6 billion [[concepts/parameters|parameters]]) requires ~150GB [[entities/storage|storage]] [[concepts/assistive-technology|at]] [[concepts/full-precision|full precision]] (32-bit), distributed across 30+ [[concepts/files|files]] (~5GB each).
...
- [[concepts/large-language-model]]: Model class where parameter count correlates strongly with [[concepts/capabilities|capabilities]] but also with computational [[concepts/cost|cost]].
- [[entities/nemotron]]: NVIDIA's [[entities/nemotron|Nemotron-3]] family (released April 2026) includes [[entities/nano|Nano]] (30B total, 3B active via [[concepts/mixture-of-experts|Mixture-of-Experts]]), Super (100B total, 10B active), and Ultra (500B total, 50B active), offering scalable [[concepts/open-source|open-source]] LLMs with reduced active parameter counts.
