...
- **Configuration**: Sub-agents are deployed using [[concepts/task-specific-configurations|task-specific configurations]] involving [[concepts/specialized-tools|specialized Tools]] and tailored instructions.
