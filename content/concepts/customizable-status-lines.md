...
A feature in [[entities/claude-code]] that allows users to personalize the status line located [[concepts/assistive-technology|at]] the bottom of the terminal interface.
