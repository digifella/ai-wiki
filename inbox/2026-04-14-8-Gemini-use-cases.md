...
# 8 [[concepts/gemini|Gemini]] [[concepts/use-cases|use cases]]

---
---
<https://www.youtube.com/watch?v=65C5VSSqWZk>
Here is a [[concepts/summary|summary]] of the 8 insane use cases for [[entities/gemini-ai|Google's Gemini]] 3 model, structured in [[concepts/markdown|Markdown]].

# 8 Insane Use Cases for [[entities/google|Google]]’s [[entities/gemini-3|Gemini 3]]

**Context:** Google’s [[entities/gemini|Gemini]] 3 is their most intelligent model yet. It can execute 10-15 steps of [[concepts/coherent-reasoning|coherent reasoning]], process video/images/code simultaneously, and integrate directly with [[concepts/google-workspace|Google Workspace]] tools.
**Essential Setting:** For most of these use cases, ensure you select **"[[concepts/thinking-with-3-pro|Thinking with 3 Pro]]"** and enable **"[[entities/canvas|Canvas]]"** under the Tools menu.

* * *

## 1\. [[concepts/ai-generated-markdown-presentations|Automated Presentation Creation]]

Gemini 3 can analyze data and generate full [[concepts/google-slides|Google Slides]] presentations, including [[concepts/design|design]] and [[concepts/structure|structure]].

* **The [[concepts/workflow|Workflow]]:**
	* Upload raw data [[concepts/files|files]] (e.g., CSVs of marketing performance).
	* **Prompt:** Ask it to create a 10-slide presentation telling the story of the quarter. Include a "Visual [[concepts/style|Style]] Guide" in the prompt (defining hex codes, fonts, and shapes) to ensure branding consistency.
...
* **The Workflow:**
	...
	* **The Result:** A fully functional, clickable [[entities/react|React]] application (Single Page App) [[concepts/running|running]] inside the [[concepts/gemini-canvas|Gemini Canvas]].
...
* **The Workflow:**
	* Go to the "Build" section in [[entities/ai-studio|AI Studio]].
	...
	* **Killer Feature:** The code can be exported to [[entities/github|GitHub]] or deployed directly to [[entities/google-cloud|Google Cloud]].

## 6\. AI Sales Coach App

_Note: This uses [[entities/google-ai|Google AI]] Studio._
Build internal tools to analyze audio and performance.

* **The Workflow:**
	* **Prompt:** "Build a sales coaching intelligence platform where users upload an audio file." Ask for [[entities/speaker|speaker]] diarization, sentiment tracking, and coaching tips.
...
* **The Workflow:**
	...
	* **Killer Feature:** **"Export to Docs"** puts the finished article directly into your [[concepts/google-drive|Google Drive]].
