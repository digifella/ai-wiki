...
VideoRefer Suite is an [[concepts/open-source|open-source]] video model developed by [[entities/alibaba|Alibaba]] ([[concepts/apache-2-license|Apache 2 license]]) that enhances [[concepts/large-language-model]]s with [[concepts/spatial-temporal-object-understanding|spatial-temporal object understanding]]. It enables fine-grained tracking and [[concepts/reasoning|reasoning]] about specific objects throughout video content.
...
- [[concepts/local-model|Local Model]] [[concepts/deployment|Deployment]]
