...
This guide details the "Master Workflow" for using the **Claude Code Desktop App**. By combining [[concepts/coding|local coding]], [[concepts/cloud-agents|cloud agents]], and a "Co-Pilot CEO" strategy within a single window, you can dramatically increase [[concepts/development-speed|development speed]] (10x) by running multiple work streams in parallel.
