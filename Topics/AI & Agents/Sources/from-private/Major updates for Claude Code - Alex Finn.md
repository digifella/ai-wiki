...
3. **Usage Statistics (**`**/stats**`**)**: Use the `/stats` command to track your activity. It provides a dashboard showing your token usage, favorite models (like [[entities/opus|Opus]] or Sonnet), current streaks, and peak usage hours, helping you manage your plan limits.
