---
wiki-ingested: true
title: "Anthony Morganti - remove chain link fence from photos"
...
---
# [[entities/anthony-morganti|Anthony Morganti]] - remove chain link fence from photos

---
---
<https://www.youtube.com/watch?v=1C4-CIEFTcU>
Here is a [[concepts/summary|summary]] of the video [[concepts/tutorial|tutorial]] by Anthony Morganti on how to remove chain-link fences from photos using [[entities/adobe-photoshop|Adobe Photoshop]].

# How to Remove Chain Link Fences in [[concepts/photoshop|Photoshop]]
...
## Method 2: [[concepts/generative-fill|Generative Fill]] (The "Game Changer")
...
* Press **Command + A** (Mac) or **Control + A** (PC) to select the whole [[entities/canvas|canvas]].
