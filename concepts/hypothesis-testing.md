...
- **Alternative Hypothesis (H₁):** This statement proposes a specific effect or difference, often what the [[entities/tomasz-janowski|researcher]] wants to prove.

### Steps in Hypothesis Testing
1. **State the hypotheses:** Clearly define both the null and alternative hypotheses.
2. **Choose the level of significance:** Decide on an acceptable [[concepts/probability|probability]] threshold for incorrectly rejecting H₀ ([[concepts/type-i-error|Type I error]]).
...
4. **Determine critical values or p-value:** Find out the criterion against which you [[entities/will|will]] judge whether to reject H₀.
...
### Backlinks
2026 04 12 Feynmans Three Step [[concepts/scientific-method|Scientific Method]] Guess [[concepts/feynmans-three-step-scientific-method|Compute]] [[concepts/feynmans-three-step-scientific-method|Compare]] Validate w
## Source Notes
