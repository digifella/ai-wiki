---
wiki-ingested: true
title: "Using Perplexity Labs for marketing and video production"
...
# Using [[concepts/perplexity-labs|Perplexity Labs]] for marketing and video production

---
---
<https://www.youtube.com/watch?v=g8JM3prvEf4>

[[entities/greg-isenberg|Greg Isenberg]] reviews and demonstrates the [[concepts/capabilities|capabilities]] of Perplexity Labs, an [[concepts/ai-agent|AI agent]] product from the search engine company Perplexity. He tests its performance against other [[concepts/ai-tools|AI tools]] like [[entities/chatgpt|ChatGPT]], [[concepts/manus|Manus]], and [[concepts/claude|Claude]] by using it to act as a salesperson, copywriter, film director, viral social media consultant, and financial analyst.

Timestamps:
00:00 - Introduction to Perplexity Labs
01:18 - [[concepts/film-director-ai|Film director AI]] Agent
07:04 - [[concepts/salesperson-ai|Salesperson AI]] Agent
11:11 - [[concepts/content-strategy-consultant-ai|Content strategy Consultant AI]] Agent
20:13 - [[concepts/financial-analyst-ai|Financial Analyst AI]] Agent
24:08 - Salesperson AI Agent (pt2)

Key Points:

• I test Perplexity Labs' AI [[concepts/agents|agents]] against other AI tools like ChatGPT, demonstrating its capabilities for various business functions
...
• It developed a COMPLETE character profile
...
• Dashboards
• Exportable data
• [[concepts/multi-step-reasoning|Step-by-step reasoning]]
...
* **Viral Social Media Person:** The host asks the AI to create a strategy to replicate the success of influencer Dan Koe for a new niche (AI & Productivity), with the goal of gaining 100,000 followers in 90 days. The AI delivers a complete playbook, including an executive [[concepts/summary|summary]], niche analysis, a target audience profile, a content strategy framework based on Dan Koe's [[concepts/methods|methods]], and a 90-day content calendar. It even creates charts showing projected follower growth.
...
The host is consistently impressed with Perplexity Labs' ability to conduct [[entities/deep-research|deep research]], synthesize information, and create complex assets like dashboards and detailed plans, concluding that it is an incredibly powerful tool and a strong contender in the AI agent space.
