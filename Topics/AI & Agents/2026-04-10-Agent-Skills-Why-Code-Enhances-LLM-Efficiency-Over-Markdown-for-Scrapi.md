...
**Clip title:** [[entities/agent|Agent]] Skills: Code Beats Markdown (Here's Why)
**Author / channel:** [[entities/sam-witteveen|Sam Witteveen]]
**URL:** https://www.youtube.com/watch?v=IjiaCOt7bP8

### Summary
This video provides an in-depth look at [[concepts/agent-skills|Agent Skills]] (formerly [[concepts/claude-skills|Claude Skills]]) and [[concepts/best-practices|best practices]] for developing efficient [[concepts/scraping|scraping]] skills for
[[concepts/large-language-models|large language models (LLMs)]]. The presenter highlights that [[concepts/automated-skill-invocation|Agent Skills]]
have become a "killer tool" for helping both models and [[concepts/agent-harnesses|agent harnesses]]
achieve tasks effectively. These skills have evolved into an [[concepts/open-standard|open standard]],
adopted by major AI companies like [[entities/anthropic|Anthropic]] ([[concepts/claude-code|Claude Code]]), [[entities/openai|OpenAI]] ([[entities/codex|Codex]]),
and [[entities/google-deepmind|Google DeepMind]] (Antigravity, [[concepts/gemini|Gemini]] CLI), leading to a proliferation
of available [[concepts/ai-capabilities|AI capabilities]] and marketplaces like skills.sh and
...
4.  **Defining Output Schemas:** Establish a strict [output schema](https://en.wikipedia.org/wiki/Output_Schema) for
...
round-trips and save time and cost, rather than performing sequential
fetches.
...
resource usage, particularly when dealing with pagination.
...
over time.
8.  **Hardcoding Knowns:** Store unchanging [[concepts/configuration|configuration]] details like base
...
adhering to [[concepts/best-practices|best practices]] focused on efficiency and [[concepts/token-management|token management]]. By
...
[[concepts/ai-applications|AI applications]] and agents.
...
- [HTML Stripping](https://en.wikipedia.org/wiki/HTML_Stripping) — [Wikipedia](https://en.wikipedia.org/wiki/HTML_Stripping)
- [CSS Selectors](https://en.wikipedia.org/wiki/CSS_Selectors) — [Wikipedia](https://en.wikipedia.org/wiki/CSS_Selectors)
- Output Schema — [Wikipedia](https://en.wikipedia.org/wiki/Output_Schema)
- [Sandboxed Execution](https://en.wikipedia.org/wiki/Sandboxed_Execution) — [Wikipedia](https://en.wikipedia.org/wiki/Sandboxed_Execution)
