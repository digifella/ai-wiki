...
The **g-factor** (or gyromagnetic ratio) is a dimensionless quantity characterizing the magnetic moment of a particle relative to its angular momentum. For the electron, the Dirac equation predicts $g = 2$, but quantum electrodynamics (QED) corrections yield $g \approx 2.002319$. The deviation $a = (g-2)/2$ is the **anomalous magnetic dipole moment**.

The **[[concepts/muon|muon]] g-factor** is exceptionally sensitive to contributions from [[concepts/vacuum-fluctuations|virtual particles]] not included in the [[concepts/standard-model-of-particle-physics|Standard Model]], making it a critical probe for new [[concepts/physics|physics]].
