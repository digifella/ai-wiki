...
In physics, tensor products appear naturally when describing composite systems. [[concepts/quantum-mechanics|Quantum mechanics]] relies heavily on tensor products to represent states of multi-particle systems, where the combined state space is the tensor product of individual particle spaces. Similarly, in relativity and field [[concepts/theory|theory]], tensors formed through tensor products encode information about physical quantities that transform in specific ways under coordinate changes.
