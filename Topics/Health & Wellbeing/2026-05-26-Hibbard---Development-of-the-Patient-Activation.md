---
wiki-ingested: true
title: Hibbard - Development of the Patient Activation
author: Judith H. Hibbard, Jean Stockard, Eldon R. Mahoney, Martin Tusler, Lo Sasso, Public Policy, 119 Hendricks Hall, Survey Research, Literature Review
published_date: 2002
source_url: "http://www.blackwell-synergy.com"
...
---
preface_schema: '1.0'
title: 'Judith H. Hibbard, Jean Stockard, Eldon R. Mahoney, and'
source_type: '[[concepts/consulting|Consulting]] Company'
publisher: 'Ey'
publishing_date: '2002'
authors: ['Judith H. Hibbard', 'Jean Stockard', 'Eldon R. Mahoney', 'Martin Tusler', 'Lo Sasso', 'Public Policy', '119 Hendricks Hall', '[[concepts/survey|Survey]] Research', 'Literature Review']
available_at: 'http://www.blackwell-synergy.com'
[[concepts/keywords|keywords]]: ['[[concepts/health|health]]', 'care', 'activation', 'measure', 'patient', 'stage', 'chronic', 'patients']
abstract: 'Development of the [[concepts/emotional-engagement|Patient Activation]] Measure (PAM): Conceptualizing and Measuring Activation in Patients and Judith H. Hibbard, Jean Stockard, Eldon R. Mahoney, and'
---
## Page 1
...
Consumers
Judith H. Hibbard, Jean Stockard, Eldon R. Mahoney, and
Martin Tusler
...
Methods. We used the convergence of the ﬁndings from a national expert consensus
panel and patient [[concepts/2026-04-14-how-to-get-tack-sharp-photos-with-any-camera|focus groups]] to deﬁne the concept and identify the domains of
...
ogy. The third stage reﬁned and extended the measure. The fourth stage used a national
[[concepts/probability|probability]] sample to assess the measure’s psychometric performance overall and
within different subpopulations.
Study Sample. Convenience samples of patients with and without chronic illness, and
a national probability sample (N 5 1,515) are included at different stages in the research.
C
...
sional, probabilistic Guttman-like scale that reﬂects a developmental model of
activation. Activation appears to involve four stages: (1) believing the patient role is
important, (2) having the conﬁdence and knowledge necessary to take action, (3)
actually taking action to maintain and improve one’s health, and (4) staying the course
even under [[concepts/stress|stress]]. The measure has good psychometric properties indicating that it can
...
Two signiﬁcant emerging policy directions put patients and consumers in a
key role for inﬂuencing health care quality and costs. First, consumer-directed
...
prudent health and health care choices when they are given ﬁnancial
...
approach also assumes that the combination of ﬁnancial incentives and
...
with the [[concepts/skills|skills]], knowledge, and [[concepts/motivation|motivation]] to participate as effective members
of the care team (Von Korff et al. 1997).
A key [[concepts/healthcare-policy|health policy]] question is, what would it take for consumers to
...
Smith), self-efﬁcacy in self-managing behaviors (Lorig et al. 1996), and
readiness to change health-related behaviors (Di
...
knowledge, skills, beliefs, and behaviors that a [[concepts/patient-needs|patient needs]] to manage a
chronic illness.
...
Oregon–1209, Department of Planning, Public Policy, and Management, 119 Hendricks Hall,
Eugene, OR 97403-1209. Jean Stockard, Ph.D., is a Professor at the University of Oregon. Eldon
Mahoney, Ph.D., is Director, Survey Research and Development, PeaceHealth, Bellevue,
Washington. Martin Tusler, M.S., is a data analyst at the Department of Planning, Public Policy,
...
arch and Development, PeaceHealth, Bellevue,
Washington. Martin Tusler, M.S., is a data analyst at the Department of Planning, Public Policy,
and Management, University of Oregon.
1006
...
conceptualization and appropriate psychometric methods. The PAM was
developed in four stages:
Stage 1. Conceptually deﬁning activation involved a literature review,
...
mains identiﬁed in stage one and operationalizing them with survey
items within each domain. Steps included generating, reﬁning, and
[[concepts/testing|testing]] a large item pool. We used Rasch psychometric methods to
...
the range of the measure, reﬁning the response categories, and testing
whether the measure could be used with respondents who had no
chronic illnesses.
Stage 4. In the fourth and ﬁnal stage a national probability sample was
...
Findings. The review ﬁndings indicated that being an engaged and active
...
chronic diseases to self-manage their di
...
self-efﬁcacy, preventive actions, and health outcomes (Bandura 1991;
Grembowski et al. 1993; O’Leary 1985; Day, Bodmer, and Dunn 1996;
Kaplan, Greenﬁeld, and Ware 1989).
1007
...
Collaborating on care and engaging in shared clinical [[concepts/decision-making|decision making]]
are also linked with better health outcomes (Von Korff et al. 1997; Kaplan,
Greenﬁeld, and Ware 1989; Glasgow 2002). Coaching patients to be more
...
Greenﬁeld, Kaplan, and Ware 1985; Greenﬁeld et al. 1988).
Several
studies
document
the
...
these six domains as

iders; (5) select providers
and provider organizations based on performance or quality; and (6) navigate
the health care system, are likely to have better health outcomes. We used
...
inﬂuence of one respondent on another, we gathered input through mailed
surveys.
The process involved two rounds of [[entities/contact|contact]], and 18 of the 21 experts
...
The ﬁrst round was designed to elicit a broad range of [[concepts/ideas|ideas]] about
...
a total of 18 possible domains: beliefs, knowledge, and skills for each of the six
domains. Within each of these 18 domains we listed a number of subdomains
involving speciﬁc characteristics, attributes, or behaviors. (Figure 1a shows
...
Findings. The results of the ﬁrst round indicated considerable consensus in
conceptualizing activation with many of the experts providing similar
comments and additions. On the basis of this expert [[concepts/feedback|feedback]] our original
classiﬁcation of beliefs, knowledge, and skills was altered slightly to include
‘‘accessing emotional support.’’
In the second expert consensus round the expert respondents were
given an expanded set of subdomains that more clearly deﬁned the larger
...
The domains where there was expert consensus are identiﬁed in Figure 1b.
Patient Focus Groups
Methods. Two focus groups explored the same potential domains with a
convenience sample of chronic disease patients. One [[entities/focus-group|focus group]] had ten
...
Has the Skills for Maintaining Fun

could also
edit or add to the list. The participants were recruited with ads in the local
newspaper and were paid $35 for their participation. The average age was 55
Has the Skills for Maintaining Function, [[concepts/preventive-care|Prevention]], and Making Lifestyle Changes
Subdomains
...
3. Maintains recommended diet and [[concepts/exercise|exercise]] regimens or other lifestyle / environmental
recommendations.
...
Subdomains 1–3 were rated as important or very important to deﬁning the domain
...
we derived a conceptual deﬁnition of health activation in patients and
...
care. We used this deﬁn

kills and behavioral
repertoire to manage their condition, collaborate with their health providers,
maintain their health functioning, and access appropriate and high-quality
care. We used this deﬁnition as the basis for developing the measure.
...
Identiﬁed by experts and patients as a key component and retained in later stages of
scale development
Identiﬁed only by experts as a key component and omitted in later stages of scale
development
Identiﬁed by experts as a key component and identiﬁed by patients as a secondary
component and retained for preliminary scale development
1010

> **[Image 1]**: [Image: could not be described — [[concepts/computer-vision|vision]] model error]
...
t be described — vision model error]
...
none existed. The items in the pool were categorized under the domains they
were intended to measure and were reviewed by a subset of the expert panel
for face and content validity.
All 80 items were further reﬁned with three rounds of face-to-face
...
categories. Seventy-ﬁve items were retained after the cognitive interviews
...
unidimensional, probabilistic Guttman-like [[concepts/musical-scales|scales]] from ordinal data such as
rating scale responses to survey questions. The measurement model calibrates
the ‘‘difﬁculty’’ of the items in terms of response probabilities. The calibration
...
each respondent possesses. In th
...
yet these two [[concepts/parameters|parameters]] are statistically independent of each other. This
...
Likewise, the precision of each individual respondent’s estimated scale
location is speciﬁed by the standard error of measurement of that person.
Item selection is based on item ﬁt statistics representing how much
responses to an item deviate from the model’s expectations. A ﬁt value of 1.0
indicates perfect ﬁt to model expectations. Fit values 41.0 indicate more
...
ﬁt values o1.0 indicate that responses to the item by persons of different
activation levels do not vary as much as the model expects.
Two item ﬁt statistics are calculated. Inﬁt is an information-weighted
residual and is most sensitive to item ﬁt when the item’s scale location is close
to the respondent’s scale location. Outﬁt is more sensitive to item ﬁt for items
with a scale location that is distant from the respondent’s scale location.
[[concepts/simulation|Simulation]] studies and experience suggest that item ﬁt values between .5
and 1.5 produce sufﬁcient unidimensionality and expected response
variability for useful rating scale measurement (Smith 1996). All

on studies and experience suggest that item ﬁt values between .5
and 1.5 produce sufﬁcient unidimensionality and expected response
variability for useful rating scale measurement (Smith 1996). All analyses
were conducted with the Winsteps Rasch models [[concepts/software|software]] application (Linacre
2002).
Findings
Table 1 shows the 21 items constituting the preliminary activation measure,
the calibrated scale location (difﬁculty) of each item, and the ﬁt and item
discrimination statistics. Item difﬁculty calibration on the ‘‘calibration’’ shown
...
where 0 5 the lowest possible activation and 100 5 the highest possible
...
range from 40–60, not tapping what would be [[entities/theoretically-media|theoretically]] the lowest or
highest ranges of the construct.
All the domains derived through the conceptualization stage (Figure 1b)
are reﬂected in the 21 items, except for the domain of accessing appropriate
and high-quality care. While items addressing this domain correlate with the
21-item measure, ﬁt statistics revealed these items tap a different construct than
activation.
...
1.28
1.28
How conﬁdent are you that you can tell your health care provider
...
1.20
1.12
How conﬁdent are you that you can ﬁnd trustworthy sources
of information about your health condition and your health choices?
48.9
1.2
1.10
1.03
How conﬁdent are you that you can follow through on medical
treatments you need to do at home?
50.0
1.2
0.87
0.81
How conﬁdent are you that you can identify when it is necessary to
get medical care and when you can handle the problem yourself?
50.2
1.2
0.92
1.10
How conﬁdent are you that you can take actions that will help prevent or
minimize some symptoms or problems associated with your condition?
51.2
1.2
0.92
0.88
How conﬁdent are you that you can follow through on

are you that you can take actions that will help prevent or
minimize some symptoms or problems associated with your condition?
51.2
1.2
0.92
...
0.88
0.90
To what extent are you able to handle symptoms on your own at home?
54.4
1.2
1.02
1.01
How well have you been able to maintain these lifestyle changes?
55.2
1.2
0.73
0.74
...
0.76
0.76
Even if I’m dissatisﬁed, it is usually too much of a hassle to change
health care providers.
57.7
1.1
1.04
1.12
How conﬁdent are you that you can ﬁgure out solutions
when new situations or problems arise with your condition?
57.7
1.1
0.74
0.73
How conﬁdent are you that you can keep the symptoms of
your disease from interfering with the things you want to do?
59.5
1.1
1.02
1.04
Ordering is by difﬁculty calibration.
SEM: SEM is the standard error of measurement in estimation of the item difﬁculty. SEM is the
precision of the item difﬁculty estimation and is shown in 0–100 units.
Inﬁt: Inﬁt mean square error is one of two [[concepts/quality-control|quality control]] ﬁt statistics assessing item dimensionality
(the degree to which the item falls on the same single, real [[concepts/number-line|number line]] as the rest of the items). Inﬁt
is an information-weighted residual of observed responses from model expected responses and is
most sensitive to item ﬁt when the item is located near the person’s scale location.
Outﬁt: Outﬁt mean square error ﬁt statistic is most sensitive to item dimensionality when the item
...
difﬁculty order of items on the scale suggests that they reﬂect a developmental
...
activation is required to be able to endorse these items. Skills and conﬁdence
appear to come at later developmental steps. Items at the midpoint of the scale
involve conﬁdence that one can identify when medical care is needed, and
...
having the conﬁdence to handle new situations or problems, and keeping
chronic illness from interfering with one’s life.
[[concepts/software-reliability|Reliability]] Assessments
...
of the misﬁt in the responses is due to departure of the data from the model’s
...
on the assumption that the data ﬁt model expectations and that the misﬁt in the
data is due to the probabilistic nature of the model. This is the upper-bound
reli

Model person reliability is based
on the assumption that the data ﬁt model expectations and that the misﬁt in the
data is due to the probabilistic nature of the model. This is the upper-bound
...
at each time point. The SEM times 1.96 provides the 95 percent conﬁdence
...
r each person’s measured (estimated) activation. Twenty-eight
of the 30 respondents had a retest activation estimate within the 95 percent CI
of their test activation estimate.
1014
...
study: ﬁve who scored at the lowest end of the activation scale, and ﬁve who
...
independently categorized each [[concepts/text-transcript|transcript]] as that of a person ‘‘low’’ or ‘‘high’’
in activation.
The three independent judges’ classiﬁcation of respondents agreed with
their measured activation level (high or low) 83 percent of the time (or 25 of
the 30 classiﬁcations were correct). Cohen’s kappa for measured activation
and each judge’s classiﬁcation were .80, .90, and .90 ( po.001 for all three
kappas). No one respondent was misclassiﬁed by all three judges. These
ﬁndings suggested that the preliminary measure had criterion validity when
evaluated using the key criterion of self-described behavior.
STAGE 3: EXTENSION AND REFINEMENT OF THE PAM
Our goals for the third phase of scale development were to reﬁne the measure
...
60), we tested items for possible inclusion that might extend the item difﬁculty.
...
rehabilitation patients (n 5 120) and employees of a large [[concepts/health-system|health system]] in a
1015
...
second community (n 5 366). The employee sample responded to a
...
reported no chronic disease (n 5 118) and the remainder reported from 1 to
8 chronic illnesses.
Findings
...
administration, the ﬁndings conﬁrm the item [[concepts/hierarchy|hierarchy]] observed in the
...
In comparing this reﬁned measure to our conceptual deﬁnition of
activation, it appears that activation has four stages: The ﬁrst involves beliefs
about the importance of the patient role. The second involves the conﬁdence
and knowledge necessary to tak

tion of
activation, it appears that activation has four stages: The ﬁrst involves beliefs
about the importance of the patient role. The second involves the conﬁdence
and knowledge necessary to take action, including knowledge of medications
and lifestyle changes, conﬁdence in talking to health care providers and
knowing when to seek help, and (at slightly higher levels of activation)
conﬁdence in following through on recommendations, knowing the nature
...
under stress. Patients who endorse these items are conﬁdent they can maintain
...
The [[concepts/structure|structure]] of this probabilistic hierarchy of item difﬁculty implies that
...
self-care, but appear to lack some of the skills and conﬁdence needed to carry
...
Figure 2:
Final Patient Activation Measure (PAM) with Item Calibrations
Ordering is by difﬁculty calibration.
SEM: The standard error of measurement in estimation of the item difﬁculty. SEM is the
precision of the item difﬁculty estimation and is shown in 0–100 units.
Inﬁt: Inﬁt mean square error is one of two quality control ﬁt statistics assessing item
dimensionality (the degree to which the item falls on the same single, real number line
as the rest of the items). Inﬁt is an information-weighted residual of observed responses
from model expected responses and is most sensitive to item ﬁt when the item is
located near the person’s scale location.
Outﬁt: Outﬁt mean square error ﬁt statistic is most sensitive to item dimen-
sionality when the item scale location is distant from the person’s scale location.
1017

> **[Image 1]**: The photograph shows a research chart from a 2005 University of Oregon study, presenting survey data on health beliefs with a bar graph and numerical results. The main subject is the chart detailing responses to questions about health management and lifestyle. The setting is a printed academic document with grayscale colors and black text. It includes columns for survey items, statistical measures like SEM, and fit indices.

---

## Page 14

t and lifestyle. The setting is a printed academic document with grayscale colors and black text. It includes columns for survey items, statistical measures like SEM, and fit indices.

---

## Page 14

conﬁdence, but may be derailed from their course when they are under stress
or encounter unexpected health events.2
The items have inﬁt values between .76 and 1.32, well within the range
...
signiﬁcant differences in item calibrations could be attributed to administration
method.
...
Study Sample
A national probability sample (N 5 1,515) of people 45 years and older was
...
he sample under the age of 65. Half the sample
had a high school education or less and 32 percent had a household income of
less than $25,000. Seventy-nine percent of the sample reported at least one
...
Table 2:
Reliability of 22-Item PAM (National Sample)
N
%
Rasch Person
Real
...
hierarchy of items and that the items maintain this same difﬁculty structure for
both those with and without chronic illness.
Reliability
Assessments of the 22-item PAM using national sample data show a high level
of reliability with inﬁt values ranging from .71 to 1.44. All but one of the outﬁt
statistics are between .80 and 1.34.
The Rasch person reliability statistics for the measure are shown in
Table 2 for the entire sample and meaningful subsamples. The [[concepts/logical-consistency|consistency]] of
performance of the measure is apparent in the reliability coefﬁcients across
...
of activation levels were examined, such as healt

eptually related to activation were examined for their relationship to
measured activation. In addition, outcomes that are hypothesized to be a result
...
speciﬁc chronic illnesses. It was hypothesized that those with higher activation
would be more likely to engage in speciﬁc self-care and preventive behaviors.
Further, those with higher activation who have a speciﬁc chronic disease
should be more likely to engage in the self-care behaviors speciﬁc to their
...
information, being persistent in getting clear answers from providers, and
...
the PAM. Those with higher activation report signiﬁcantly better health as
measured by the SF 8 (r 5 .38, po.001), and have signiﬁcantly lower rates of
doctor ofﬁce visits, emergency room visits, and hospital nights (r 5  .07,
po.01). Those with higher activation are signiﬁcantly more likely to exercise
regularly, follow a low-fat diet, eat more fruits and vegetables, and not smoke
(Table 3). In addition, those with higher activation are signiﬁcantly more likely
to engage in con

likely to exercise
regularly, follow a low-fat diet, eat more fruits and vegetables, and not smoke
(Table 3). In addition, those with higher activation are signiﬁcantly more likely
to engage in consumeristic health behaviors, such as ﬁnding out about a new
provider’s qualiﬁcations. Self-management behaviors associated with speciﬁc
conditions are also signiﬁcantly associated with measured activation levels.
...
These ﬁndings indicate that the measure has a high degree of construct
...
development of a measure to assess patient activation; (2) The identiﬁcation
...
Table 3:
Association between Scale Calibration and Construct Validity
[[concepts/indicators|Indicators]]
Variable Answer Category (n)
Mean Score on Measure
F; df
P
General Preventive Behaviors
Follow a low-fat diet: Always or almost always (798)
61.1
72.8; 1,1512
.001
Sometimes or never (716)
56.2
Follow regular exercise schedule: Yes (884)
61.3
116.3; 1,1511
.001
No (629)
...
68.1; 1,1512
.001
At least four days per week (755)
61.2
Three days per week or less (759)
56.4
Smoke tobacco: Yes (262)
56.3
15.1; 1,1512
.001
No (1,252)
59.3
Disease-Speciﬁc Behaviors
Diabetes
Use glucose journal: Always or almost always (110)
57.7
4.9; 1,157
.05
...
53.8
Arthritis
Arthritis exercise: Always or almost always (254)
60.6
60.2; 1,571
.001
Sometimes or never (319)
53.9
High Cholesterol
Follow a low-fat diet: Always or almost always (256)
60.4
37.6; 1,456
.001
Sometimes or never (202)
54.2
Consumeristic Behaviors
Before I go to a new health care provider, I ﬁnd out
as much as I can about his or her qualiﬁcations.
182.2; 2,1416
.001
Disagree or strongly disagree (232)
54.0
Agree (880)
56.5
Strongly agree (307)
...
322.9; 2,1491
.001
Disagree or strongly disagree (79)
50.4
Agree (992)
55.3
Strongly agree (423)
68.5
As far as I know medical [[concepts/science|science]] has developed
...
81.3; 1,1431
.001
Very likely or likely (526)
55.6
Unlikely o

next 5 years how likely do you think it is that
you will develop a new or additional health
condition that requires ongoing medical care?
81.3; 1,1431
.001
...
supporting and increasing patient activation. The ﬁrst step of developing a
...
demographic and health status groups, it can also be used at the [[concepts/aggregate-level|aggregate
level]] to evaluate and [[concepts/feynmans-three-step-scientific-method|compare]] the efﬁcacy of interventions and health care
delivery systems.
...
of providers or delivery systems, and be employed for [[concepts/quality-assessment|quality assessment]] and
public [[concepts/accountability|accountability]] purposes. Consumers will likely want to know which
providers and systems are performing well in this area and comparative data
could [[concepts/ambition|drive]] purchaser and consumer choices.
...
activation. For example, those at early stages of a
...
to increase their skills and conﬁdence in the different self-management
...
useful measure is the ﬁrst step toward the goal of informed and engaged
patients and ultimately to more effective and efﬁcient delivery systems.
The measurement properties of the Patient Activation Measure (PAM)
when assessed using the stringent Rasch model suggest that it could fulﬁll
that role.
Having a valid and reliable measure is the very ﬁrst step in
...
and cost containment. Of course, the validity of the measure is limited by our
...
that reﬁnement of the measure will be necessary.
ACKNOWLEDGMENTS
The authors wish to acknowledge The Robert Wood Johnson Foundation who
provided funding for this work. Also acknowledged are Sarah Jane Satre and
Summer Meyer of the PeaceHealth Methods, Outcomes Measurement and
Statistics Team for conducting data collection, and the eighteen experts who
...
accurate scores. To obtain a copy of the score table and [[concepts/instructions|instructions]], contact the
ﬁrst author.
...
Psychometrica 43 (4): 561–73.
Bandura, A. 1991. ‘‘Self-efﬁcacy Mechanism in Physiological Activation and Health-
Promoting Behavior.’’ In Adaption, [[concepts/learning|Learning]] and Affect, edited by J. Madden, S.
Matthysse, and J. Barchas, pp. 226–69. New York: Raven Press.
...
Medical Association 288 (19): 2469–75.

.
Bodenheimer, T., K. Lorig, H. Holman, and K. Grumbach. 2002. ‘‘Patient Self-
Management of Chronic Disease in Primary Care.’’ Journal of the American
Medical Association 288 (19): 2469–75.
Bond, T., and C. Fox. 2001. Applying the Rasch Model: Fundamental Measurement in the
Human Sciences. Mahwah, NJ: Erlbaum.
Day, J., C. W. Bodmer, and O. M. Dunn. 1996. ‘‘Development of a Questionnaire
Identifying Factors Responsible for Successful Self-management of Insulin-
Treated Diabetes.’’ Diabetic Medicine 13 (6): 564–73.
1024
...
DiClemente, C. C., J. O. Prochaska, S. K. Fairhurst, W. F. Velicer, M. M. Velasquez,
and J. S. Rossi. 1991. ‘‘The Process of Smoking Cessation: An Analysis of
Precontemplation, Contemplation and [[concepts/preparation|Preparation]] Stages of Change.’’ Journal of
Consulting and Clinical [[concepts/psychology|Psychology]] 59 (2): 295–304.
Gabel, J. R., A. T. Lo Sasso, and T. Rice. 2002. ‘‘Consumer-Driven Health Plans: Are
They More Than Talk Now?’’ Health Affairs Web exclusive, available at http://
www.healthaffairs.org/WebExclusives/2201Gabel.pdf.
Glasgow, R. E., M. M. Funnell, A. E. Bonomi, C. Davis, V. Beckham, and E. H.
Wagner. 2002. ‘‘Self-management Aspects of the Improving Chronic Illness
Care Breakthrough Series: [[concepts/adoption|Implementation]] with Diabetes and Heart Failure
Teams.’’ Annals of Behavioral Medicine 24 (2): 80–7.
Glasgow, R. 2002. ‘‘Technology and Chronic Care.’’ Paper presented at the Congress
on Improving Chronic Care: Innovations in Research and Practice. September
8–10, Seattle, Washington.
Greenﬁeld, S., S. Kaplan, and J. E. Ware. 1985. ‘‘Expanding Patient Involvement in
Care. Effects on Patient Outcomes.’’ Annals of Internal Medicine 102 (4): 520–8.
Greenﬁeld, S., S. Kaplan, J. E. Ware, E. M. Yano, and H. J. Frank. 1988. ‘‘Patients’
Participation in Medical Care: Effects on Blood Sugar Control and [[concepts/quality-of-life|Quality of
Life]] in Diabetes.’’ Journal of General Internal Medicine 3 (5): 448–57.
Grembowski

J. Frank. 1988. ‘‘Patients’
Participation in Medical Care: Effects on Blood Sugar Control and Quality of
Life in Diabetes.’’ Journal of General Internal Medicine 3 (5): 448–57.
Grembowski, D. E., D. L. Patrick, P. Diehr, M. Durham, S. Beresford, E. Kay, and
J. Hecht. 1993. ‘‘Self-Efﬁcacy and Health Behavior among Older Adults.’’ Journal
of Health and Social Behavior 34 (2): 89–104.
Hibbard, J. H., J. J. Jewett, S. Engelmann, and M. Tusler. 1998. ‘‘Can Medicare
Beneﬁciaries Make Informed Choices?’’ Health Affairs 17 (6): 181–93.
Hibbard, J. H., M. Greenlick, H. Jimison, J. Capizzi, and L. Kunkel. 2001. ‘‘The Impact
of a Community-Wide Self-Care Information Project on Self-Care and Medical
Care Utilization.’’ Evaluation and the Health Professions 24 (4): 404–23.
Isaacs, S. L. 1996. ‘‘Consumer’s Information Needs: Results of a National Survey.’’
Health Affairs 15 (4): 31–41.
Kahn, D. A., J. P. Docherty, D. Carpenter, and A. Frances. 1997. ‘‘Consensus Methods
in Practice Guideline Development: A Review and Description of a New
Method.’’ Psychopharmacology Bulletin 33 (4): 631–9.
Kaplan, S., S. Greenﬁeld, and J. E. Ware. 1989. ‘‘Assessing the Effects of Physician–
Patient Interactions on the Outcomes of Chronic Disease.’’ Medical Care 27 (3,
supplement): S110–27.
Linacre, J. M. 2002. Winsteps Manual. Chicago: Winsteps.
Lorig, K. 1996. Outcome Measures for [[concepts/health-promotion|Health Education]] and Other Health Care Interventions.
Thousand Oaks, CA: Sage.
Lorig, K. R., D. S. Sobel, A. L. Stewart, B. W. Brown, A. Bandura, P. Ritter, V. M.
Gonzalez, D. D. Laurent, and H. R. Holman. 1999. ‘‘Evidence Suggesting That a
Chronic Disease Self-Management Program Can Improve Health Status While
Reducing Hospitalization: A [[concepts/randomized-control-trial|Randomized Trial]].’’ Medical Care 37 (1): 5–14.
Marshall, M. N., P. G. Shekelle, R. H. Brook, and S. Leatherman. 2000. ‘‘Use of
Performance Data to Change Physician Behavior.’’ Journal o

Randomized Trial.’’ Medical Care 37 (1): 5–14.
Marshall, M. N., P. G. Shekelle, R. H. Brook, and S. Leatherman. 2000. ‘‘Use of
Performance Data to Change Physician Behavior.’’ Journal of the American Medical
Association 284 (9): 1079.
1025
...
Science 79 (8): 516–52.
O’Leary, A. 1985. ‘‘Self-Efﬁcacy and Health.’’ Behaviour Research and Therapy 23 (4):
437–51.
Prochaska, J. O., C. A. Redding, and K. E. Evers. 1997. ‘‘The Transtheoretical Model
and Stages of Change.’’ In Health Behavior and Health Education, 2d ed.,
edited by K. Glanz, F. M. Lewis, and B. K. Rimer, pp. 60–84. San Francisco:
Jossey-Bass.
Rasch, G. 1960. Probabilistic Models for Some Intelligence and Attainment Tests (reprint, with
Foreword and Afterword by B. D. Wright, Chicago: University of Chicago Press,
1980). Copenhagen, Denmark: Danmarks Paedogogiske Institut.
Smith, R. M. 1996. ‘‘Polytomous Mean-Square Fit Statistics.’’ Rasch Measurement
Transactions 10 (3): 516–7.
Thorndike, R. M., and E. P. Hagen. 1991. Measurement and Evaluation in Psychology and
Education. New York: Macmillan.
Von Korff, M., J. E. Moore, K. Lorig, D. C. Cherkin, K. Saunders, V. M. Gonzalez, D.
Laurent, C. Rutter, and F. Comite. 1998. ‘‘A Randomized Trial of a Lay Person-
Led Self-Management Group Intervention for Back Pain Patients in Primary
Care.’’ Spine 23 (23): 2608–15.
Von Korff, M., J. Gruman, J. Schaefer, S. J. Curry, and E. H. Wagner. 1997.
‘‘Collaborative Management of Chronic Illness.’’ Annals of Internal Medicine 127
(12): 1097–102.
Von Korff, M., W. Katon, T. Bush, E. H. Lin, G. E. Simon, K. Saunders, E. Ludman, E.
Walker, and J. Unutzer. 1998. ‘‘Treatment Costs, Cost Offset, and Cost-
Effectiveness of Collaborative Management of Depression.’’ Psychosomatic
Medicine 60 (2): 143–9.
Wallston, K. A., M. J. Stein, and C. A. Smith. 199

‘‘Treatment Costs, Cost Offset, and Cost-
Effectiveness of Collaborative Management of Depression.’’ Psychosomatic
Medicine 60 (2): 143–9.
Wallston, K. A., M. J. Stein, and C. A. Smith. 1994. ‘‘Form C of the MHLC Scales: A
Condition-Speciﬁc Measure of Locus of Control.’’ Journal of Personality Assessment
63 (3): 534–53.
Wasson, J. H., T. A. Stukel, J. E. Weiss, R. D. Hays, A. M. Jette, and E. C. Nelson. 1999.
‘‘A Randomized Trial of the Use of Patient Self-Assessment Data to Improve
Community Practices.’’ Effective [[entities/clinical-practice|Clinical Practice]] 2 (1): 1–10.
Winsteps. 2002. Winsteps: Rasch Model Statistical Software (Version 337). Chicago:
Winsteps.
Wright, B. D., and G. Masters. 1982. Rating Scale Analysis. Chicago: Mesa Press.
Wright, B. D., and M. H. Stone. 1979. Best Test [[concepts/design|Design]]. Chicago: Mesa Press.
1026

## Related Concepts
- [[concepts/health-care|Patient Activation]] — [Wikipedia](https://en.wikipedia.org/wiki/Patient_Activation)
- [[concepts/health-care|Health Care]] — [Wikipedia](https://en.wikipedia.org/wiki/Health_Care)
- [[concepts/chronic-patients|Chronic Patients]] — [Wikipedia](https://en.wikipedia.org/wiki/Chronic_Patients)
- Patient Activation Measure — [Wikipedia](https://en.wikipedia.org/wiki/Patient_Activation_Measure)
- Self-management — [Wikipedia](https://en.wikipedia.org/wiki/Self-management)
- [[concepts/quality-of-care|Health Care Quality]] — [Wikipedia](https://en.wikipedia.org/wiki/Health_Care_Quality)
- [[concepts/ai-conceptscost-optimizationcost-optimization|Cost Control]] — [Wikipedia](https://en.wikipedia.org/wiki/Cost_Control)
- Consumer-directed Health Plans — [Wikipedia](https://en.wikipedia.org/wiki/Consumer-directed_Health_Plans)
- Chronic Illness Care Model — [Wikipedia](https://en.wikipedia.org/wiki/Chronic_Illness_Care_Model)
- Rasch Methodology — [Wikipedia](https://en.wikipedia.org/wiki/Rasch_Methodology)
- Psychometric Properties — [Wikipedia](https://en.wikipedia.org/wiki/Psychometric_Properties)
- Expert Consensus Panel — [Wikipedia](https://en.wikipedia.org/wiki/Expert_Consensus_Panel)
- Patient Focus Groups — [Wikipedia](https://en.wikipedia.org/wiki/Patient_Focus_Groups)
- National Probability Sample — [Wikipedia](https://en.wikipedia.org/wiki/National_Probability_Sample)
- Financial Incentives — [Wikipedia](https://en.wikipedia.org/wiki/Financial_Incentives)
- Comparative Cost Information — [Wikipedia](https://en.wikipedia.org/wiki/Comparative_Cost_Information)
- Activation Stages — [Wikipedia](https://en.wikipedia.org/wiki/Activation_Stages)
- Patient Role Importance — [Wikipedia](https://en.wikipedia.org/wiki/Patient_Role_Importance)
- Health Knowledge and Confidence — [Wikipedia](https://en.wikipedia.org/wiki/Health_Knowledge_and_Confidence)

## Related Entities
- [[entities/judith-h-hibbard|Judith H. Hibbard]] — [Wikipedia](https://en.wikipedia.org/wiki/Judith_H._Hibbard)
- [[entities/jean-stockard|Jean Stockard]] — [Wikipedia](https://en.wikipedia.org/wiki/Jean_Stockard)
- [[entities/eldon-r-mahoney|Eldon R. Mahoney]] — [Wikipedia](https://en.wikipedia.org/wiki/Eldon_R._Mahoney)
- [[entities/martin-tusler|Martin Tusler]] — [Wikipedia](https://en.wikipedia.org/wiki/Martin_Tusler)
- [[entities/lo-sasso|Lo Sasso]] — [Wikipedia](https://en.wikipedia.org/wiki/Lo_Sasso)
- [[entities/public-policy|Public Policy]] — [Wikipedia](https://en.wikipedia.org/wiki/Public_Policy)
- Bodenheimer — [Wikipedia](https://en.wikipedia.org/wiki/Bodenheimer)
- Gabel — [Wikipedia](https://en.wikipedia.org/wiki/Gabel)
- Rice — [Wikipedia](https://en.wikipedia.org/wiki/Rice)
- [[entities/ey|Ey]] — [Wikipedia](https://en.wikipedia.org/wiki/Ey)
- Blackwell Synergy — [Wikipedia](https://en.wikipedia.org/wiki/Blackwell_Synergy)
- Hendricks Hall — [Wikipedia](https://en.wikipedia.org/wiki/Hendricks_Hall)