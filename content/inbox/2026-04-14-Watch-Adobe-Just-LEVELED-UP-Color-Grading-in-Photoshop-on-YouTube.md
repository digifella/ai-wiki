---
wiki-ingested: true
title: "Watch Adobe Just LEVELED UP Color Grading in Photoshop on YouTube"
...
---
# Watch [[entities/adobe|Adobe]] Just LEVELED UP Color Grading in [[concepts/photoshop|Photoshop]] on [[entities/youtube|YouTube]]

---
---
<https://www.youtube.com/watch?v=ufLkBKtmgZM>

Here is a [[concepts/summary|summary]] of the video [[concepts/tutorial|tutorial]] by [[entities/blake-rudis|Blake Rudis]] ([[entities/f64-academy|f64 Academy]]) regarding the new **Color and Vibrance** tool in [[entities/photoshop-2025|Photoshop 2025]].
...
* **Vs. Photo Filter:** Photo Filters often drastically alter the luminosity (brightness) of an image. The Color and Vibrance tool changes [[concepts/color-temperature|color temperature]] while preserving tonal values much better.
...
4. _Optional:_ Create a second layer, shift to **Cool (Blue)**, and paint [[entities/into-the-shadows|into the shadows]] to create [[concepts/color-contrast|color contrast]].
...
4. **Result:** The blue tint is restricted _only_ to the darkest shadows, leaving the [[concepts/highlights|highlights]] unaffected. This creates a "baked sunlight" effect where shadows remain cool while the sun stays warm.
