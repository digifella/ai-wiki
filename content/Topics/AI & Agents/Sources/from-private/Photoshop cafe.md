...
This video provides a detailed overview of [[concepts/photoshop|Photoshop]]'s new "Harmonize" feature, found in the [[entities/photoshop-beta|Photoshop Beta]] version, explaining its functionality, limitations, and how to work around them for optimal results.
**Key Features and [[concepts/workflow|Workflow]]:**

* **Accessing Harmonize:** The feature is currently available in **[[entities/adobe|Adobe]] Photoshop (Beta)**. Users can download it via the Creative Cloud app by navigating to "Apps" and then selecting the "Beta" tab.
* **Basic Application:** Start with a subject image and easily **remove its background** using the "Remove Background" button in the contextual task bar. Use the **Move Tool** to drag the cut-out subject layer into a new background image document (by dragging it onto the tab of the target image). **Resize and reposition** the subject using **Ctrl+T (Cmd+T on Mac)** for Free Transform. Click the "Harmonize" button in the contextual task bar. Photoshop's Generative AI (Firefly) [[entities/will|will]] automatically **adjust the subject's lighting, color, and add realistic [[concepts/shadows|shadows]]** to match the new background scene. The feature provides **three different variations** of the harmonized result, allowing users to choose the best fit.
...
2. **Shadow & Light [[concepts/integration|Integration]]:**
...
## Related Concepts
- [[concepts/subject-removal|Subject Removal]] — [Wikipedia](https://en.wikipedia.org/wiki/Subject_Removal)
- [[concepts/blend-if|Image Composition]] — [Wikipedia](https://en.wikipedia.org/wiki/Image_Composition)
- [[concepts/image-editing|Image Editing]] — [Wikipedia](https://en.wikipedia.org/wiki/Image_Editing)
- [[concepts/beta-software|Beta Software]] — [Wikipedia](https://en.wikipedia.org/wiki/Beta_Software)
- [[concepts/workflow-automation|Workflow Optimization]] — [Wikipedia](https://en.wikipedia.org/wiki/Workflow_Optimization)
- Harmonize Feature — [Wikipedia](https://en.wikipedia.org/wiki/Harmonize_Feature)
...
- [[concepts/remove-background|Background Removal]] — [Wikipedia](https://en.wikipedia.org/wiki/Background_Removal)

## Related Entities
- [[entities/adobe-photoshop|Adobe Photoshop]] — [Wikipedia](https://en.wikipedia.org/wiki/Adobe_Photoshop)
- [[entities/creative-cloud-app|Creative Cloud App]] — [Wikipedia](https://en.wikipedia.org/wiki/Creative_Cloud_App)