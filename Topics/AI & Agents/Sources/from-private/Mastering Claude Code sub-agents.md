...
* **Flexible Permissions:** Granting sub-agents tool-specific access and setting [[concepts/secure|security]] boundaries. \[2:01, 2:09\] This helps prevent powerful tools from being misused by general-purpose agents. \[2:11\]
