...
instance, a common local [[concepts/setup|setup]] previously limited to an 8K [[concepts/token-context-window|token context window]] might now comfortably handle a 32K token context, making tasks like
