...
---
<https://www.youtube.com/watch?v=6Ealkbzfud0>
Here are **10 Quick Tips for Painting in [[entities/adobe|Adobe]] [[concepts/photoshop|Photoshop]]** presented by Julieanne Kost.

### 1\. Changing [[concepts/brush-size|Brush Size]] & Hardness
...
* **[[concepts/hud|Heads Up Display]] (HUD):**
	* **Mac:** Hold **Control + Option** and drag.
	* **[[entities/windows|Windows]]:** Hold **Control + Alt + Right-click** and drag.
	* _Drag Left/Right_ changes size; _Drag Up/Down_ changes hardness.
	* **Tip:** You can change the vertical movement to control **[[concepts/opacity|Opacity]]** instead of hardness via _Settings/Preferences > Tools > Uncheck "Vary Round [[concepts/brush-hardness|Brush Hardness]] based on HUD vertical movement."_

### 2\. [[entities/cursor|Cursor]] Display Options

* **Caps Lock:** Toggles the cursor between your preferred brush tip and "Precise" (crosshairs) mode.
* **Brush Tip Preferences:** Go to _Settings/Preferences > Cursors_.
	* **Normal Brush Tip:** Shows the area where the brush paints with greater than 50% effect. Soft brushes [[entities/will|will]] paint outside this circle.
	* **Full Size Brush Tip:** Shows the area of _all_ pixels being painted.
...
Painting tools usually retain their own individual settings (size, opacity). To erase using your _current_ brush settings:

* Hold the **Tilde (~)** key while using the Brush tool to turn it into an eraser with the exact same size and shape.
* _Note:_ This changes the blend mode to "Clear."
...
* **Disable:** If you prefer to see a warning instead (to prevent accidental painting on the wrong layer), uncheck **"Create new layer when brushing"** in _Settings/Preferences > General_.

## Related Concepts
- [[concepts/brush-size-control|Brush Size Control]] — [Wikipedia](https://en.wikipedia.org/wiki/Brush_Size_Control)
- [[concepts/hardness-adjustment|Hardness Adjustment]] — [Wikipedia](https://en.wikipedia.org/wiki/Hardness_Adjustment)
- [[concepts/hud-heads-up-display|HUD (Heads Up Display)]] — [Wikipedia](https://en.wikipedia.org/wiki/HUD_%28Heads_Up_Display%29)
- [[concepts/hud-heads-up-display|Heads Up Display (HUD)]] — [Wikipedia](https://en.wikipedia.org/wiki/Heads_Up_Display_%28HUD%29)
