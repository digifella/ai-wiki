---
wiki-ingested: true
title: "Claude coworker - Grace Leung channel"
...
# [[entities/claude|Claude]] coworker - [[entities/grace-leung|Grace Leung]] channel

---
---
<https://www.youtube.com/watch?v=l_Iy4ZCK1lY>
Here is a comprehensive [[concepts/markdown|Markdown]] [[concepts/summary|summary]] of the video, structured by the key workflows and features discussed.

# [[entities/claude-co-work|Claude Cowork]] for Marketing: 6 Advanced Workflows

This guide covers how to utilize the [[concepts/claude|Claude]] ecosystem—specifically **[[concepts/claude-chat|Claude Chat]]**, **[[entities/claude-cowork|Claude Cowork]]**, and **[[concepts/claude-code|Claude Code]]**—to build automated [[concepts/marketing-workflow|marketing workflow]] [[concepts/systems|systems]].

## 1\. Understanding the Three Modes

To maximize efficiency, use the right mode for the right stage of work:

* **[[entities/claude-chat|Claude Chat]]:** For **thinking and planning**. Use this for [[concepts/brainstorming|brainstorming]], organizing projects, and strategy. [[concepts/files|Files]] are stored in the cloud.
...
* **[[entities/claude-code|Claude Code]] (Desktop/Terminal):** For **creating and building**. The engine behind Cowork, used for more technical [[concepts/personalization|customization]] and [[concepts/coding|coding]] tasks.

* * *

## 2\. The 6 Major [[concepts/scenarios|Use Cases]]
...
* **[[concepts/setup|Setup]]:** Create a local project folder with context files (Brand Guidelines, Presentation [[concepts/templates|Templates]], Transcripts).
* **Action:** In Cowork, point to the local folder.
* **[[concepts/workflow|Workflow]]:** Prompt Claude to read the [[concepts/text-transcript|transcript]] and guidelines, then generate a `.pptx` file.
...
* **Result:** Claude spins up separate [[concepts/sub-agents|sub-agents]]. It generates image files locally and updates the [[entities/excel|Excel]] spreadsheet with status tags and file paths automatically.
...
**The Unlock:** Give Claude real-time browsing [[concepts/capabilities|capabilities]] to audit live websites.

* **Tool:** **Claude in Chrome** ([[concepts/model-context-protocol|Model Context Protocol]] connector).
* **Workflow:**
	1. Create a "[[concepts/skill|Skill]]" (a set of reusable [[concepts/instructions|instructions]]) for a "Landing Page Audit."
...
* **Scenario:** Tracking [[concepts/ai-search|AI Search]] Results ([[entities/google|Google]] AI Overviews) for SEO.
* **Workflow:**
...
> "Don't just use [[entities/claude|Claude]] as a chatbot. Build your [[concepts/skills|skills]], package your [[concepts/workflow|workflow]], and let it do the work for you."