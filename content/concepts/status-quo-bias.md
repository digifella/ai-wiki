...
Status quo bias refers to the cognitive bias where individuals prefer things to stay as they are and show reluctance towards changing their [[concepts/habits|habits]] or making decisions that may lead to uncertainty. This psychological trait is often observed in various aspects of life, including personal finance, business practices, and social norms.

- **Definition**: The preference for the current state of affairs, regardless of its desirability.

- **Causes**:
  - Familiarity with existing systems
  - Fear of loss or risk associated with change
  - Cognitive ease in maintaining routines
