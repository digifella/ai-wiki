...
Here is a [[concepts/summary|summary]] of the video "What is OpenRAG?" featuring IBM’s David Jones-Gilardi, formatted as a [[concepts/markdown|Markdown]] document.
...
As [[concepts/generative-ai|Generative AI]] [[concepts/models|models]] mature, **Context [[entities/windows|Windows]]** have become significantly larger. However, even with the potential for "infinite" context windows, **[[concepts/traditional-rag|Retrieval-Augmented Generation]] (RAG)** remains a critical [[concepts/architecture|architecture]] for modern AI systems.
...
1. **[[concepts/cost|Cost]]:** Most model providers charge by the token. Ingesting an entire library for every query is prohibitively expensive.
