...
The first human spaceflight occurred in 1961 with Yuri Gagarin's orbital mission. Since then, human spaceflight activities have expanded from initial orbital flights to include lunar landings, space station operations, and long-duration missions in low Earth orbit. The field has evolved from competition-driven programs to include international cooperation, most notably through the International Space Station, which has maintained continuous human presence in orbit since 2000.
