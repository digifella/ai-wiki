...
* **[[concepts/marketing-campaigns|Marketing Campaigns]]:** Strict brand guidelines (colors, lighting, model clothing).
* **UI/UX [[concepts/design|Design]]:** Specific hex codes, button sizes, and layout consistency.
* **Technical Diagrams:** Precise labeling and component [[concepts/relationships|relationships]].
* **Tools:** "Renderer" [[concepts/models|models]] (like [[entities/dall-e-3|DALL-E 3]] or specific Stable Diffusion fine-tunes) that prioritize [[concepts/instruction-following|instruction following]] over artistic interpretation.
...
## Live Example: The [[entities/alien|Alien]] App
