...
Git Based Deployment is a deployment methodology that leverages [[concepts/app-updates|version control]] systems—primarily Git—as the central mechanism for triggering, tracking, and managing application releases. Rather than using separate deployment tools or manual processes, this approach treats infrastructure and application code changes as Git [[concepts/commits|commits]], making the deployment pipeline transparent and auditable through commit history.
