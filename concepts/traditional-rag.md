...
[[concepts/rag|Traditional RAG]] ([[concepts/answer-generation|Retrieval-Augmented Generation]]) is a foundational framework that enhances LLM responses by [[concepts/retrieving|retrieving]] relevant external documents before generation. It combines [[concepts/document-retrieval|retrieval]] systems with [[concepts/tts-model|generative models]] to improve [[concepts/factual-accuracy|factual accuracy]] and reduce hallucinations.
...
2026 04 14 [[entities/discover-ai-channel|Discover AI channel]] [[concepts/graph-rag|Graph RAG]] evolved
## Source Notes
