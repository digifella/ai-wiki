...
Protons are positively charged [[concepts/subatomic-particles|subatomic particles]] found in the nucleus of all atoms. Each proton carries an elementary positive charge and has a mass of approximately 1.67 × 10⁻²⁷ kilograms, making it roughly 1,836 times heavier than an electron. The number of protons in an atom's nucleus determines its atomic number and thus its chemical identity as a particular element.
