...
The process of isolating specific elements within an image from the background for [[concepts/masking]] and digital manipulation.

## Automation & AI Integration
- [[concepts/ai-powered-tools]]: Utilized to automate subject identification and edge detection within [[entities/adobe-photoshop]].
