...
**1\. Context Engineering Defined (0:00 - 1:26)** Context engineering is defined as "the art and [[concepts/science|science]] of filling the context window with just the right information at each step of an [[concepts/agents|agent's trajectory]]." This includes instructions, external knowledge, and tool feedback.
