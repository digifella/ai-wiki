...
A technique where an [[concepts/ai-agent|AI agent]] attempts to generate a complete [[concepts/solution|solution]] (e.g., full application or complex feature) in a single prompt. Prone to failure due to **[[concepts/context-window-limitations|context window limitations]]** in large [[concepts/models|models]].
...
- [[concepts/ai-coding|AI Coding]] [[entities/agent|Agent]]
- Long-[[concepts/running|Running]] Tasks
