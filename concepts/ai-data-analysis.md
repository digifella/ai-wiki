...
- "ai"
  ...
  - "data-processing"
  - "[[concepts/thematic-analysis|pattern-recognition]]"
  - "[[concepts/workflow-automation|workflow-automation]]"
aliases:
  - "automated data analysis"
  - "[[concepts/customizable-extraction|ai-driven data processing]]"
group: data-pipelines-sync-[[entities/storage|storage]]

# AI Data Analysis

The use of [[concepts/ai-technologies|Artificial Intelligence]] to automate Data Processing, pattern recognition, and the transformation of traditional workflows into [[concepts/voice-assistants|autonomous systems]].

## Emerging Tooling
- [[entities/tryshortcutai|TryShortcut.ai]] (Shortcut): An "AI version of [[entities/excel|Excel]]" designed to replace traditional [[entities/google-sheets]] and [[entities/microsoft-excel|Excel]] workflows.
- [[concepts/chatgpt-agent|ChatGPT Agent]]: A new capability by [[entities/openai|OpenAI]] combining Operator, [[concepts/visualization-generation|Deep Research]], and [[entities/chatgpt|ChatGPT]]'s [[concepts/conversational-fluency|conversational fluency]]. Functions as a virtual computer handling [[concepts/complex-tasks|complex tasks]], including website interactions, [[concepts/code-execution|code execution]], and analysis.
