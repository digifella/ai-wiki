...
- "zero-trust"
  ...
  - "[[concepts/agentic-systems|agentic-ai]]"
  - "least-privilege"
...
- [[concepts/secure|Secure]] all data in transit and [[concepts/assistive-technology|at]] rest
...
- Requires [[concepts/concept-of-nothingness|Zero]] Trust applied to:
...
- Traditional security [[concepts/models|models]] insufficient for [[entities/openclaw|autonomous agent]] ecosystems
- **Video [[concepts/summary|Summary]] ([[entities/ibm|IBM]] Channel, 2026-04-14):** 2026 04 14 Ai zero trust [[concepts/setup|setup]] IBM channel
  ...
  - Key points:
    - Zero Trust principles applied to [[concepts/ai-agents|AI agents]]
