...
The system draws on several foundational concepts, particularly the [[concepts/five-elements-theory|Five Elements Theory]] (wood, fire, earth, metal, and water), which are understood to interact and balance one another in all things. Another central concept is yin and yang—complementary opposites that must be in equilibrium. Space arrangement considers factors including cardinal directions, spatial proportions, color choices, and the placement of objects and furniture to either encourage or redirect energy flow. Different schools of Feng Shui have developed varying methodologies, from the Compass School (which emphasizes directional alignments) to the Form School (which focuses on natural landscape features).
