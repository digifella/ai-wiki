...
tools, the scripts, the [[concepts/markdown|markdown]] [[concepts/files|files]], the [[concepts/obsidian|Obsidian]] setup.
...
Knowledge without [[concepts/connection|connection]] is just [[entities/storage|storage]]. And storage doesn't make you
