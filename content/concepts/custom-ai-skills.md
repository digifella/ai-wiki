...
Specialized, programmable [[concepts/plugins|extensions]] for LLMs that enable the execution of specific, repeatable tasks beyond standard [[concepts/text-generation|text generation]], facilitating autonomous agentic [[concepts/workflow|workflows]].
