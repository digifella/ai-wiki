...
**Definition:** A distribution is a mathematical construct that generalizes the [[entities/notion|notion]] of functions and measures, allowing for the description of singular or generalized functions such as impulses and their derivatives. It finds [[concepts/software|applications]] in various fields including probability [[concepts/theory|theory]], [[concepts/physics|physics]] (e.g., [[concepts/quantum-mechanics|quantum mechanics]]), and engineering.
