...
# [[entities/rick-mulready|Rick mulready]] - [[concepts/claude|Claude]] [[concepts/skills|skills]]

---
---
<https://www.youtube.com/watch?v=HCwfRe5EHGQ>
Here is a comprehensive [[concepts/markdown|Markdown]] [[concepts/summary|summary]] of the video regarding **Claude Skills** (also known as [[concepts/agent-skills|Agent Skills]]).

# Claude Skills: The Ultimate Guide & [[concepts/scenarios|Use Cases]]

**Presenter:** Rick Mulready ([[entities/the-ai-playbook|The AI Playbook]])

## 1\. What Are Claude Skills?

Think of **Claude Skills** as a "[[concepts/personal-recipe-book|personal recipe book]]" for your AI.

* **The Problem:** Without skills, you must provide full context and [[concepts/instructions|instructions]] every time you want Claude to do a specific task. Long conversations degrade output quality and consume unnecessary [[concepts/tokens|tokens]].
...
* **[[concepts/progressive-disclosure|Progressive Disclosure]]:** Unlike pasting a massive prompt, Claude does not load the entire [[concepts/skill|skill]] at once. It loads information in stages **only when needed**.
	* **Benefit:** Faster [[concepts/responses|responses]], better results, and saved tokens.
...
## 3\. [[concepts/claude-projects|Claude Projects]] vs. Claude Skills
...
| **Best For** | Ongoing work with consistent context. | Repeatable, specific workflows. |
...
To build a skill, you need a specific file [[concepts/structure|structure]] zipped together:
...
3. **Tip:** Only add context to the skill that Claude _doesn't_ already have to keep it [[concepts/lean|lean]].
...
* **How it works:** You upload your HEX codes, fonts, [[concepts/tone|tone]] of voice, and logo usage rules.
...
* **How it works:**
	...
	3. It generates an **[[entities/excel|Excel]] Spreadsheet**.
...
* **How it works:** The skill contains specific mental frameworks (e.g., First Principles, 80/20 Analysis, [[concepts/systems|Systems]] Thinking, Jobs-to-be-Done).
...
### 5\. [[concepts/survey|Survey]] Data Analyzer
