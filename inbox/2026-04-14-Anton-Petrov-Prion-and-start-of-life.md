---
wiki-ingested: true
title: "Anton Petrov - Prion and start of life"
...
# [[entities/anton-petrov|Anton Petrov]] - [[concepts/prion|Prion]] and [[concepts/start-of-life|start of life]]
...
# The [[concepts/protein-world-hypothesis|Protein World Hypothesis]]: Did Prions Start Life?

## 1\. The [[concepts/historical-context|Historical Context]]: The [[entities/fore-tribe|Fore Tribe]] & [[entities/kuru|Kuru]]

The video begins with a medical mystery from the 1980s in [[entities/papua-new-guinea|Papua New Guinea]] involving the **Fore tribe**.
...
* **The Discovery:** It was discovered that Kuru was not caused by bacteria or viruses, but by a "[[concepts/rogue-protein|rogue protein]]" called a **prion**. This proved that proteins could transmit disease without genetic material (DNA/RNA).
...
## 3\. The Flaw in the "[[concepts/rna|RNA]] World" Hypothesis
...
The video [[concepts/highlights|highlights]] that "prion-like" behavior is ancient and essential for healthy biological functions:
...
* **Chemical Evidence:** Simple reactions using [[concepts/hydrogen-atom|Hydrogen]] Cyanide, Hydrogen Sulfide, and UV [[concepts/light|light]] can produce precursors for _both_ RNA and proteins simultaneously.
