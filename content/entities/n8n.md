...
- **Core Problem**: RAG systems rely on breaking down large documents or web pages into smaller "chunks" that are then converted into vectors and stored in a [[concepts/vector-database|vector database]].
...
- **[[concepts/agentic-ai|AI Agents]]**: Capabilities are enhanced by integrating with [[concepts/mcp|Model Context Protocol]].
