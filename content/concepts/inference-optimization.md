...
### Summary
[[entities/chroma|Chroma Context-1]] is a [[concepts/efficient-rag|self-editing search agent]] derived from [[entities/gpt-oss-20b|gpt-oss-20B]] that achieves efficient [[concepts/retrieval-performance|retrieval performance]] in RAG.
