...
Role responsible for guiding team execution, resolving blockers, and fostering collaboration toward shared objectives.
...
## Key Metrics
| Metric                | Target [[concepts/range|Range]] | Importance |
|-----------------------|--------------|------------|
| Team Velocity         | Consistent ↑ | Critical   |
| Retention Rate        | >85%         | High       |
| Cycle Time Reduction  | 20-30% YoY   | [[entities/medium|Medium]]     |
