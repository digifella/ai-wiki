...
Here is a [[concepts/summary|summary]] of the video review for **[[concepts/multimodal-capabilities|Mistral 3 Large]]**, formatted in [[concepts/markdown|Markdown]].

## Overview

The video covers the release of the **Mistral 3** family of [[concepts/models|models]], specifically focusing on **Mistral 3 Large**. It is a 675-billion parameter [[entities/mixture-of-experts|Mixture-of-Experts]] (MoE) model released under the [[concepts/apache-2.0-license|Apache 2.0 license]]. The host tests the model through various [[concepts/coding|coding]], creative, and logic challenges via [[entities/openrouter|OpenRouter]].
