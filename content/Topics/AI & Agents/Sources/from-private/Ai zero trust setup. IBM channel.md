...
Here is a [[concepts/summary|summary]] of the video **"[[concepts/zero|Zero]] Trust for AI [[concepts/agents|Agents]]"** featuring Jeff Crume, Distinguished Engineer at IBM, formatted in [[concepts/markdown|Markdown]].
