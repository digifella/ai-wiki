...
---
# Using [[concepts/ffmpeg|ffmpeg]]

---
---
<https://www.youtube.com/watch?v=6uB65PdasQI>
Here is a detailed [[concepts/summary|summary]] of the video, organized by topic and including the specific command-line codes provided for using FFmpeg.
...
* **[[concepts/purpose|Purpose]]:** A complete, cross-platform [[concepts/solution|solution]] to record, convert, and stream audio and video. It is described as the "Swiss Army Knife" of media manipulation.
* **The Barrier:** It uses a [[concepts/command-line-interface-cli|Command Line Interface (CLI)]], which can be intimidating due to the sheer number of [[concepts/flags|flags]] and switches available.

* * *

## Practical FFmpeg [[concepts/commands|Commands]]

_Note: All commands assume you have FFmpeg installed and are [[concepts/running|running]] them in your terminal._
...
* **[[entities/linux|Linux]]:** Varies (uses V4L2, ALSA, or PulseAudio).
...
* **To capture the mouse [[concepts/cursor|cursor]]:** Add flag `-capture_cursor 1`.
...
FFmpeg allows you to manipulate media with professional precision completely for free. While the syntax is dense, mastering just 4-5 basic [[concepts/commands|commands]] (for GIFs, compression, resizing, and stripping audio) can replace a dozen separate ad-heavy software tools.