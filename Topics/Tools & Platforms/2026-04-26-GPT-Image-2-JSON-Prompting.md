...
To trigger this, make sure ChatGPT is in [[concepts/thinking-mode|thinking mode]]. Then after your initial image is generated, prompt something like: "I want you to create a total of five images, using this prompt as the starting point of a story. Create them like a storyboard that tells the story of what these characters are doing."
