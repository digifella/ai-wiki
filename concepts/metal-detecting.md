...
The [[concepts/private-archaeology|Danish metal detecting program]] operates within a [[concepts/canvas|structured framework]] where amateur detectorists receive training and official status before conducting searches. Participants must follow established protocols for documentation and reporting of finds. This system allows archaeologists to benefit from expanded fieldwork capacity while maintaining standards for artifact [[concepts/preservation|preservation]] and contextual recording. The [[concepts/coordination|coordination]] between amateur detectorists and professional archaeologists helps ensure that discovered artifacts are properly assessed and integrated into the archaeological record.
...
- 2026-04-10 [2026-04-10-Gemma-4-E2B-LLM-Fine-Tuning-Custom-Dataset-Unsloth-Local-Tutorial](2026-04-10-Gemma-4-E2B-LLM-Fine-Tuning-Custom-Dataset-Unsloth-Local-Tutorial.md) ← [[entities/gemma-4-e2b|Gemma 4 E2B]] Llm [[concepts/model-fine-tuning|Fine Tuning]] Custom Dataset [[entities/unsloth|Unsloth]] Local Tutorial
## Source Notes
