...
Non Terrestrial Internet (NTI) refers to internet [[concepts/service-delivery|service delivery]] infrastructure based on satellites and orbital networks rather than traditional ground-based systems. The concept encompasses both geostationary and low Earth orbit (LEO) satellite constellations, as well as potential future network architectures that operate partially or entirely outside Earth's terrestrial boundaries. [[entities/spacex|SpaceX]]'s Starlink is the most developed commercial implementation, consisting of thousands of LEO satellites designed to provide broadband coverage globally.
