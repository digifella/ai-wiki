...
Ingredient mix-ins refer to the various components added to fried rice during the cooking process to build flavor, [[concepts/texture|texture]], and nutritional variety. These additions are incorporated according to specific timing and techniques that ensure even [[concepts/distribution|distribution]] and optimal texture in the finished dish. Mix-ins form a core element of the [[concepts/fried-rice-formula|fried rice formula]], working in conjunction with properly treated rice to create a cohesive dish.

## Categories of Mix-Ins

Common categories of mix-ins include proteins (such as eggs, meat, and seafood), vegetables (both fresh and previously cooked), aromatics (garlic, ginger, and onions), and finishing ingredients (sesame oil, soy sauce, and fresh herbs). The selection and proportions of mix-ins can be adjusted based on available ingredients and dietary preferences, making fried rice a flexible cooking technique.
