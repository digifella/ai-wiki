...
The readiness of Artemis 3, NASA's planned crewed [[concepts/lunar-landing|lunar landing]] mission, depends significantly on the maturation of both the [[concepts/human-landing-system|Human Landing System]] (HLS) and Space Launch System (SLS). CLPS payloads contribute to this readiness by delivering experiments and infrastructure to lunar sites in advance of crewed operations. Delays or challenges in commercial payload delivery directly impact the timeline and risk profile of Artemis 3, as these missions provide essential data about landing zones and environmental conditions.
