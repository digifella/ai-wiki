...
CI/CD pipelines are [[concepts/automations|automated systems]] that enable [[concepts/coding|software development]] teams to build, test, and deploy code changes with minimal manual intervention. CI/CD stands for Continuous Integration and Continuous [[concepts/deployment|Deployment]] (or Continuous Delivery). These pipelines are fundamental to modern software development practices, allowing teams to release updates more frequently and reliably.
...
CI/CD pipelines are implemented using specialized platforms such as Jenkins, GitLab CI/CD, GitHub Actions, and CircleCI. These tools orchestrate workflows that include code compilation, [[concepts/automated-software-testing|automated testing]], security scanning, and deployment steps. Configuration is typically managed through code files stored alongside the application, enabling teams to version control and review pipeline changes as part of the development process.
