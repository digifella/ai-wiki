...
Parameters in [[concepts/machine-learning|machine learning]] and AI are essential elements that define the model's architecture, influence its [[concepts/training-process|training process]], and affect its performance. These settings can include hyperparameters (like [[concepts/learning|learning]] rate, batch size) and parameters learned during training ([[concepts/weights|weights]] and [[concepts/biases|biases]]). Adjusting these values optimizes the model for specific tasks or datasets.
...
- [[entities/adam-lucek|Adam Lucek]] discusses [[concepts/parameter-reduction|quantization]] of LLMs, highlighting the challenge of massive models like [[entities/nvidia|NVIDIA]]'s [[entities/llama|Llama]] 3.1 [[entities/nemotron|Nemotron]] 70B with 70.6 billion parameters, which require significant [[entities/storage|storage]] (30+ GB).
## Source Notes
