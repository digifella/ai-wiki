...
Data reclamation operates within the bounds of publicly available information but raises questions about scale, [[concepts/automation|automation]], and intended use. Analysis of LinkedIn data can reveal patterns about labor market discrimination, wage trends, skill obsolescence, and corporate practices without violating individual [[concepts/privacy|privacy]], since the data being analyzed is information users have chosen to make visible. However, the practice exists in a contested space between platform terms of service and legitimate research interests.
