...
Internet Service Providers (ISPs) monitor user activity by observing **[[concepts/dns|DNS]] requests** (revealing visited domains), even when **HTTPS** encrypts content (passwords, emails). This makes users "the product" sold for advertising.
