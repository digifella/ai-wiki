...
aliases:
  - "luminance-contrast"
  - "color-contrast"
summary: "Image contrast is the difference in luminance or color intensity between adjacent regions of an image, essential for defining shape, depth, and visibility."
updated: 2026-04-26
group: design-systems-ui-infographics
---
# Image contrast

The difference in Luminance or [[concepts/color-saturation|color intensity]] between adjacent regions of an image, essential for defining shape, depth, and visibility.

## Presence & Localized Contrast
In Adobe [[entities/lightroom-classic|Lightroom Classic]], "Presence" sliders allow for the manipulation of mid-[[concepts/tone|tone]] and edge-based contrast:

- **[[concepts/texture|Texture]]**: Enhances fine-scale details and surface micro-contrast without altering larger structural shapes.
- **[[concepts/lightroom]]**: Increases contrast in the mid-tones, affecting edge [[concepts/slms|definition]] and larger structural transitions.
- **Dehaze**: Adjusts atmospheric haze to either recover shadow detail or add atmospheric depth, impacting both contrast and Color Saturation.
