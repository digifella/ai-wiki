...
The core strategy of secondary prevention is systematic screening of asymptomatic populations or at-risk groups. Common examples include mammography for breast cancer, colonoscopy for colorectal cancer, blood pressure monitoring for hypertension, and cholesterol testing for cardiovascular disease. These screening programs aim to catch disease before it progresses to symptomatic stages, when intervention is typically less invasive and more successful. Effective screening requires balancing the benefits of early detection against potential harms such as false positives, overdiagnosis, and unnecessary treatment.
