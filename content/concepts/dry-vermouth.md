...
The production of dry vermouth involves steeping a blend of herbs, flowers, roots, and spices in fortified wine. Common botanicals include wormwood, which gives vermouth its characteristic bitter note, along with ingredients such as anise, chamomile, juniper, and citrus peels. The specific recipe varies by producer and region, with French dry vermouth (particularly from Chambéry) and Italian varieties each having distinct flavor profiles. After maceration, the liquid is filtered, blended for [[concepts/logical-consistency|consistency]], and typically aged before bottling.
