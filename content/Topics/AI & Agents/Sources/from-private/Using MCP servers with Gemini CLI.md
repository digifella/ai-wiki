...
1. **Initial Check (0:08):** The video starts by showing that the [[entities/gemini-cli|Gemini CLI]] initially has "No MCP servers configured" when [[concepts/running|running]] the `/mcp` command.
