...
Here is a comprehensive [[concepts/markdown|Markdown]] [[concepts/summary|summary]] of the video regarding **[[entities/claude-4|Claude]] [[concepts/skills|Skills]]** (also known as [[concepts/agent-skills|Agent Skills]]).
...
* **Progressive Disclosure:** Unlike pasting a massive prompt, Claude does not load the entire [[concepts/skill|skill]] at once. It loads information in stages **only when needed**.
...
- [[concepts/personal-recipe-book|personal recipe book]] — [Wikipedia](https://en.wikipedia.org/wiki/personal_recipe_book)
...
## Related Entities
- Rick Mulready (The AI Playbook) — [Wikipedia](https://en.wikipedia.org/wiki/Rick_Mulready_%28The_AI_Playbook%29)
- [[entities/rick-mulready|Rick Mulready]] — [Wikipedia](https://en.wikipedia.org/wiki/Rick_Mulready)
- The AI Playbook — [Wikipedia](https://en.wikipedia.org/wiki/The_AI_Playbook)