...
- [[entities/data-formulator|Data Formulator]] (Microsoft):
	- **Installation**: Use [[concepts/python|Python]]'s [[entities/pip|PIP]] via `pip install data_formulator`.
	- **Backend**: Leverages [[concepts/large-language-model|large language model]] (LLM) to drive data visualization.
