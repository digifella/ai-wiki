...
summary: 3D Manipulation is the process of transforming two-dimensional images into three-dimensional space to enable rotation, perspective adjustment, and depth simulation for enhanced visual realism.
updated: 2026-07-11
...
**Definition:** The process of transforming two-dimensional (2D) images or objects into three-dimensional (3D) space to allow for rotation, [[concepts/perspective-adjustment|perspective adjustment]], and other manipulations that simulate depth and spatial [[concepts/relationships|relationships]].

### Related Concepts
- [[concepts/3d-modeling|3d-modeling]]
- [[concepts/perspective-adjustment|perspective-adjustment]]
- [[concepts/image-adjustments|image-editing]]-tools

### Key Features of 3D Manipulation

- **Rotation:** Ability to rotate objects around any axis.
- **Perspective Adjustment:** Adjust the perspective view of an image or object for a more realistic [[concepts/presence|appearance]].
- **[[concepts/portrait-mode|Depth Effects]]:** Simulate depth and [[concepts/shadows|shadows]] to enhance visual realism.
