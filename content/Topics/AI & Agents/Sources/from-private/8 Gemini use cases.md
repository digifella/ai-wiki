...
Here is a [[concepts/summary|summary]] of the 8 insane [[concepts/use-cases|use cases]] for [[entities/gemini-ai|Google's Gemini]] 3 model, structured in [[concepts/markdown|Markdown]].
