...
**Core Mechanisms**:
- [[concepts/embedding-models|Embedding models]] (e.g., Sentence-BERT) convert text into [[concepts/vector-representations|vector representations]] where semantic proximity correlates with vector distance.
...
For [[concepts/implementation-details|implementation details]], see 2026 04 14 [[entities/adam-lucek|Adam Lucek]] [[concepts/rag-embedding|RAG embedding]] model fine tuning.
