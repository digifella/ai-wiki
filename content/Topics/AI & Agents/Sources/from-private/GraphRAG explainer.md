...
This [[concepts/setup|setup]] allows the n8n agent to leverage both a traditional vector store and the powerful, interconnected data within the knowledge graph, resulting in significantly more detailed and context-aware responses.
