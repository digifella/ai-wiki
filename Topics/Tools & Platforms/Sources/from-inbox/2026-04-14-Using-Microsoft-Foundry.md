...
* **Model Catalog:** Features a massive catalog of models from providers like [[entities/azure-openai|Azure OpenAI]], [[entities/mistral-ai|Mistral AI]], Meta, DeepSeek, and for the first time, **[[entities/anthropic|Anthropic]]**.
