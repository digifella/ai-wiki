...
- **Bohr Model**: Simplified model where electrons orbit [[concepts/assistive-technology|at]] fixed distances from the nucleus.
...
- The video by [[entities/numberphile|Numberphile]] explores why we need trillions of [[concepts/decimal-places|decimal places]] for [[concepts/computational-testing|computational testing]]:
