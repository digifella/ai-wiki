...
Salt should be added to raw eggs before cooking, as it breaks down proteins and allows them to retain more moisture during the cooking process. The liquid ratio—typically a small amount of water, cream, or milk mixed into the beaten eggs—helps create a softer, more delicate final [[concepts/texture|texture]] by adding steam and reducing the density of the cooked egg proteins.
