...
- [[concepts/rollback-procedures|Coding agents]] — [Wikipedia](https://en.wikipedia.org/wiki/Coding_agents)
...
- The Bitter Lesson (AI) — [Wikipedia](https://en.wikipedia.org/wiki/The_Bitter_Lesson_%28AI%29)
- Context [[concepts/token-optimization|token efficiency]] — [Wikipedia](https://en.wikipedia.org/wiki/Context_token_efficiency)
- [[concepts/text-classification|Online text classification]] — [Wikipedia](https://en.wikipedia.org/wiki/Online_text_classification)
