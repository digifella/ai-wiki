...
Defined parameters, context, and [[concepts/open-source-philosophy|logic]] provided to [[concepts/llm]]s and [[concepts/agentic-ai|AI Agents]] to govern output, [[concepts/coding|coding]] standards, and [[concepts/system-prompts|behavioral constraints]].
