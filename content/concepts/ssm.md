...
- **[[entities/jamba|Jamba]] 1.7 ([[entities/ai21-labs|AI21 Labs]])**: A recent release (available in Jamba Mini and Jamba Large) that utilizes a hybrid [[concepts/architecture|architecture]] to support a 256k [[concepts/context-window|context window]].
