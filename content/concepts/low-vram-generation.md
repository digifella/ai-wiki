...
## Key Techniques
- LoRA ([[concepts/low-rank-adaptation|Low-Rank Adaptation]]) for efficient [[concepts/fine-tuning|fine-tuning]]
...
- **Goal**: Train a model to reliably generate [[concepts/images|images]] of a specific person ([[entities/adam-lucek|Adam Lucek]]) in various [[concepts/scenarios|scenarios]] using low [[concepts/vram|VRAM]].
