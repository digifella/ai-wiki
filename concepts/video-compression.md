...
Efficiently reducing video file size while preserving quality through [[concepts/encoding|encoding]] techniques. Key approaches include:
...
## Key tools
- Handbrake: Free, [[concepts/open-source|open-source]] cross-platform tool ([[entities/windows|Windows]]/Mac/Linux) for [[concepts/transcoding|transcoding]] and compressing video without significant quality loss. Originally designed for [[concepts/dvd-ripping|DVD ripping]], now supports multiple codecs.
