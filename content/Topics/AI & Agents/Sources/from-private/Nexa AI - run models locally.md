...
The video [[concepts/highlights|highlights]] several key features that differentiate Nexa SDK from other tools like [[entities/llama|Ollama]], llama.cpp, and LM Studio:
...
  clean        remove all cached [[concepts/models|models]]
