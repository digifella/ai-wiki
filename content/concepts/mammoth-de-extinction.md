...
Research into mammoth cloning has revealed significant obstacles to successful de-extinction. A long-term Japanese study on serial [[concepts/mammalian-cloning|cloning in mammals]] documented over 20 years found that repeated cloning cycles accumulate [[concepts/genetic-mutations|genetic mutations]] and degradation, suggesting fundamental biological limits to the approach. DNA recovered from frozen mammoth specimens is fragmentary and degraded, requiring extensive reconstruction using Asian elephant genomes as a reference—introducing genetic alterations from a separate species.
