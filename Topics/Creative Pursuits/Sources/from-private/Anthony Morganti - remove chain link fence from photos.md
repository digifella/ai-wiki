...
Here is a summary of the video [[concepts/tutorial|tutorial]] by Anthony Morganti on how to remove chain-link fences from photos using [[entities/adobe|Adobe]] [[concepts/photoshop|Photoshop]].
...
* Select the Partner Model: **[[entities/gemini-3|Gemini 3]] (with [[entities/nano-banana-pro|Nano Banana Pro]])**.
	* _Note:_ The [[entities/speaker|speaker]] emphasizes using this specific third-party model over the standard [[entities/adobe-firefly|Adobe Firefly]] models for this task.
