...
**Agentic Research** is a paradigm of [[concepts/information-synthesis|information synthesis]] where AI [[concepts/agentic-ai|agents]] autonomously execute multi-step [[concepts/workflow|workflows]] to fulfill complex investigation goals. It moves beyond static retrieval toward active, iterative discovery, [[concepts/verification|verification]], and [[concepts/reasoning|reasoning]].

## Key Characteristics
- **Autonomous [[concepts/reasoning|Reasoning]]**: The ability to decompose high-level research queries into actionable sub-tasks.
- **Tool-Augmented Investigation**: Utilizing external environments and [[concepts/software|software]] (e.g., web browsers, [[concepts/code|code]] interpreters, and specialized platforms like [[entities/notebooklm]]) to gather data.
...
## Related Entities
- [[concepts/agentic-ai]]
- [[concepts/rag]] ([[concepts/traditional-rag|Retrieval-Augmented Generation]])
