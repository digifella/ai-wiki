---
wiki-ingested: true
title: "Landscape processing in Lightroom Classic - Anthony Morganti"
...
---
# Landscape processing in [[entities/lightroom-classic|Lightroom Classic]] - [[entities/anthony-morganti|Anthony Morganti]]

---
---
<https://www.youtube.com/watch?v=-_VRZp-0zeM>
This video provides a detailed [[concepts/tutorial|tutorial]] on utilizing the "Landscape" [[concepts/masking|masking]] feature in [[entities/adobe-lightroom|Adobe Lightroom]] Classic, which also applies to [[entities/lightroom-cc|Lightroom CC]] and [[concepts/camera-raw|Camera Raw]].
Here's a breakdown of the key steps and concepts demonstrated:

1. **Initial [[concepts/image-preparation|Image Preparation]]:**
	The presenter starts with a landscape image that has already undergone basic [[concepts/adjustments|adjustments]]: [[concepts/straightening|straightening]] and minor tweaks to [[concepts/exposure|Exposure]], [[concepts/highlights|Highlights]], [[concepts/shadows|Shadows]], [[concepts/whites|Whites]], and [[concepts/blacks-sliders|Blacks sliders]] in the Basic panel.
	
2. **Accessing [[concepts/landscape-masking|Landscape Masking]]:**
...
3. **[[concepts/lightroom|Lightroom]]'s [[concepts/ai-detection|AI Detection]]:**
...
9. **Second Example (Pond Scene):**
	A second landscape image with a pond and trees is briefly shown, demonstrating that the same efficient workflow (bulk [[concepts/mask-creation|mask creation]], then individual refinement) can be applied to different scenes, highlighting the versatility of the feature.
	
10. **Conclusion & Future Outlook:**
	The presenter emphasizes the power of landscape masking for adding significant enhancements to images. He anticipates that [[entities/adobe|Adobe]] will continue to improve the accuracy of these AI-driven selections over time, making manual refinements less necessary in future updates.