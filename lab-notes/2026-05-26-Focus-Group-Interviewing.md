...
author: B R Simon Rosser, J Michael Wilkerson, Derek J Smolenski, J Michael Oakes, Joseph Konstan
published_date: 2011-04-01
source_url: "http://www.ncbi.nlm.nih.gov/pmc/articles/PMC3345812/"
...
authors: []
available_at: 'http://www.ncbi.nlm.nih.gov/pmc/articles/PMC3345812/'
...
[[concepts/keywords|keywords]]: ['focus', 'group', 'interviewing', 'research', 'methods', 'university', 'minnesota', '[[concepts/notes|notes]]']
abstract: 'Focus Group Interviewing Research Methods University of Minnesota Notes [[concepts/feynman|Richard]] A. Krueger, Ph.D. and Mary Anne Casey, Ph.D. rkrueger@umn.edu casey016@umn.edu September 2015 Table of Contents OVERVIEW Characteristics of focus group interviews..………………………… 2 MODERATING Moderator [[concepts/skills|skills]]..……………………………………………………… 3 Example of a focus group introduction …………………………….. 4 Outline of a focus group introduction ………………………………. 5 Moderator checklist …………………………………………………...6 Suggestions for creating a discussion.……………………………...7 Assistant moderator role..……………………………………………..8 Note taking..………………………………………………………….... 9 How to give an oral [[concepts/summary|summary]] [[concepts/assistive-technology|at]] the end of the focus group ….…11 DEVELOPING QUESTIONS Good questions..………………………………………………………12 Act

�……………….... 9 How to give an oral summary at the end of the focus group ….…11 DEVELOPING QUESTIONS Good questions..………………………………………………………12 Active questions that engage the participants..……………………13 Generic questions – Consumer product..…………………………. 14 Generic questions – Program evaluation..…………………………15 PLANNING Planning the focus group study……………………………………..16 Developing a focus group plan……………………………………...17 RECRUITMENT Systematic notification procedures, selection, incentives……..….18 ANALYSIS & REPORTING Analysis choices………………………………………………………19 Tips for transcribing focus group interviews……………………….20 Sys'
---
...
[[concepts/audio-modality|Audio]] recorded
...
Understands [[concepts/purpose|purpose]] and questioning route
...
[[entities/make|Make]] a smooth & snappy introduction
...
[[concepts/power|Control]] reactions to participants Verbal and nonverbal

Head nodding

Short verbal [[concepts/responses|responses]]
...
Good evening and welcome. Thanks for taking the time to join [[entities/us|us]] to talk about [[concepts/health|health]] and [[concepts/wellness|wellness]] in your community. My name is Dick Krueger and with me is Tom Olson. We're both with the . Sarah Casey, who is with the county [[concepts/population-health|public health]] office, asked us to get some information from community residents about health and wellness. The public health office is developing a new strategic plan to decide what priorities they should have over the next five years. They want your input about health issues, what worries people here in the community, and what could be done to improve the health of people who live in the county. Your input, along with input from other groups being held across the county, [[entities/will|will]] be used to set priorities for the coming years.
...
s. Convey sense of relaxed informality.
...
Review the report for [[concepts/accuracy|accuracy]].
...
Call on someone who has not spoken and ask for their comment. “[[entities/alicia|Alicia]], you haven’t had a chance to say anything.”
...
Give [[concepts/motivation|incentive]] if there is one

Thank each person for participating

Debrief with moderator

Give [[concepts/feedback|feedback]] on analysis and reports
...
Clarity and [[concepts/logical-consistency|consistency]] of note taking

Anticipate that others will use your field notes. Sometimes an analyst might not look at field notes for days or weeks following the focus group when [[concepts/memory|memory]] has faded. Consistency and clarity are essential.
...
Listen for notable quotes, the well-said statements that illustrate an important point of view. Listen for sentences or phrases that are particularly enlightening or eloquently express a particular point of view. Place name or initials of [[entities/speaker|speaker]] after the quotations. Usually, it is impossible to capture the entire quote. Capture as much as you can with [[concepts/attention-mechanisms|attention]] to the key phrases. Use three periods ... to indicate that part of the quote is missing.
...
Big [[concepts/ideas|ideas]], hunches, or thoughts of the recorder
...
ach names to transcripts. If so, the assistant moderator might write down the name and the first few words each time someone talks. Later, these notes can be merged with the transcript.

Other factors

Make note of factors that might aid analysis such as passionate comments, body language, or non-verbal activity. Watch for head nods, physical excitement, eye [[entities/contact|contact]] between certain participants, or other clues that would indicate level of agreement, support, or interest.

# How to Give an Oral Summary

at the End of the Focus Group

Before the focus group, be sure you know the key questions and the approximate time the moderator plans to spend on each key question.

Be clear about the purpose of the focus group. The summary should tie closely to this purpose.

Take two kinds of notes: a) Notes that will help you provide a brief oral summary, and, b) Notes for detailed analysis after the focus group.

Make sure to leave enough time for the summary. If you give the summary two minutes before you said the discussion would be over, participants may be eager to leave and may not offer feedback.

Begin your oral summary with the most important findings regardless of when they were discussed in the focus group. Don't worry about the question sequence when you construct your summary.

Begin your summary with findings—what was actually said. Attempt to capture common themes but also acknowledge differing points of view. This descriptive summary repeats what was said but is very brief. After you've given the summary of what was said, consider offering interpretation. The interpretative summary attaches additional meaning and goes beyond the actual words.

Listen for what was not said, but might have been expected. If these areas are important, then in the summary you might say: "Some things were not mentioned like . . . . Are they important to you or not?" Look at the participants while you're saying this and watch for reactions.

important, then in the summary you might say: "Some things were not mentioned like . . . . Are they important to you or not?" Look at the participants while you're saying this and watch for reactions.

Cite key phrases used in the discussion. This demonstrates connectedness and careful listening.

Keep the summary to three minutes or less. If you ramble, people will tune out.

When finished, look at the participants and ask, "What would you add to that summary?" Or, "Does that reflect the conversation you heard?" Or, "What would you change about this summary?"
...
Draw [[concepts/diagrams|diagrams]], flowchart, etc
...
(e.g., video, demonstration) and then discuss
...
4. Put your thoughts in [[concepts/writing|writing]]
...
Travel expenses for moderator team, travel expenses for participants, incentives, food, room charge, childcare, transcription charges, digital recording and transcription equipment, supplies like flip charts, markers, [[concepts/art|art]] supplies.
...
6. Balance [[concepts/cost|cost]] and quality
...
A “transcription kit” with a foot pedal allows you to control the playback [[concepts/speed|speed]] without removing your fingers from the keyboard. Check to see if your [[concepts/software|software]] has noise-reduction features that minimize the background sounds on recordings.

Minimize distractions

Type transcripts at a time and place with few distractions or interruptions.

Use a consistent [[concepts/style|style]]

Include name of study, date and location of focus group, type of participants, number of participants, name of moderator and assistant moderator.

istractions or interruptions.

Use a consistent style

Include name of study, date and location of focus group, type of participants, number of participants, name of moderator and assistant moderator.

Identify moderator comments using a consistent style such as bolding, capitalization or underlining. We prefer bolding.

Single space all comments.

Double space between speakers.

Don’t type verbal fillers such as “umm”, “ahh”, or “you know”

Number all pages. Place a header on all pages indicating date and group name.
...
elps you improve your future moderating and helps you in the analysis. For greatest benefit, prepare the transcript soon after the focus group is completed.
...
[[concepts/feynmans-three-step-scientific-method|Compare]] and [[concepts/contrast|contrast]] this focus group to other groups
...
Ideal—moderator/asst moderator transcribes and reviews before next focus group—this improves the quality of data gathered in next group. Look for [[entities/places|places]] where moderating can be improved and where additional data are needed. (Think of what the client needs.)
...
. Compare all like-groups first. (For example, compare teenager groups then compare parent groups.)
...
Share report for [[concepts/verification|verification]] with other researchers
...
Responses are triggered by a stimulus—a question asked by the moderator or a comment from another participant. Find the triggering stimulus and then interpret the comment in that context. Interpret responses in [[concepts/light|light]] of the preceding discussion and by the tone and intensity of the oral comment.

INTERNAL CONSISTENCY

Sometimes participants in focus groups change or even reverse their positions after hearing what others have said. This phenomenon rarely occurs in individual interviews due to a lack of interaction with others. When there is a shift in opinion, the researcher typically traces the [[concepts/flow|flow]] of the conversation to determine clues that might explain the change.
...
onfuse these. One topic could be brought up a lot, but only by one participant. Frequency and extensiveness are factors to consider when the analyst is deciding what weight to give a topic.

INTENSITY

Look for emotion. Pay attention when participants talk about a topic with a special intensity or depth of feeling. Intensity may be difficult to spot from transcripts because it is communicated by the [[concepts/tone|voice]] tone, speed, emphasis on certain words, and body language. Individuals will differ on how they display strength of feeling and for some it will be a speed or excitement in the voice whereas others will speak slowly and deliberately.
...
10. Begin the [[concepts/coding|coding]] process
...
1. Prepare your transcripts for analysis. You will save time and agony later if you are careful when preparing your transcripts. Be sure they follow a consistent style. For example, single space comments and double space between speakers. Bold, [[entities/cap|cap]], or underline the comments of the moderator so they are easy to see.
...
ristics of participants (users, non-users and employees, or teens, young adults and older adults, etc.). This arrangement helps you be alert to changes that may be occurring from one group to another.
...
to what was already said and putting like things together.
...
pile of unused quotes. Think big picture. Invite a research colleague to look over your work and offer feedback.
...
Rather than [[concepts/human-cognition|thinking]] of "a report," think of what type of [[concepts/communication|communication]] strategy is needed. A variety of reports might be used to keep people informed. Consider: e-mails, postcards, phone calls, bulleted summaries, selected quotes, moderator comments, mid-project or final project reports, personal visits by members of the research team, etc.
...
rs should indicate why the study is important, why the findings are meaningful, begin with the most important findings, engage the listener in an active manner, and allow plenty of time for questions.
...
Share questions or [[concepts/challenges-discussed|discussion topics]] in advance
...
At the end, you might indicate that if they have any additional thoughts that weren’t covered, or if something occurs to them later, that you would appreciate their [[entities/email|email]] comments.

Internet Focus Groups

Internet groups show enormous potential, but technical glitches remain a problem

One concern is the platform or computer system that handles the groups. Market researchers contract this out to technical firms. Often public, non-profit and academic communities don’t have the budget for this out-sourcing and therefore, try to adapt in-house systems (such as Moodle, [[entities/adobe|Adobe]] Connect, or forum features in other systems.)
...
s Moodle, Adobe Connect, or forum features in other systems.)
...
incentives are based on how many days they submit responses. The questions in a bulletin board group should have a focus and move in a general direction over the course of several days.
...
Houston, T.K., et al. (2011). Culturally appropriate [[concepts/storytelling|storytelling]] to improve blood pressure. Annals of Internal Medicine. 154(2) 77-84.
...
Morgan, D. L. (1997). Focus groups as [[concepts/qualitative-research|qualitative research]]. Thousand Oaks, CA: Sage.
...
Rosser, B.R.S., et al. (2011). The future of Internet-based HIV [[concepts/preventive-care|prevention]]: A report on key findings from the men’s INTernet (MINTS-I, II) sex studies. NIH Public Access. 	http://www.ncbi.nlm.nih.gov/pmc/articles/PMC3345812/

11). The future of Internet-based HIV prevention: A report on key findings from the men’s INTernet (MINTS-I, II) sex studies. NIH Public Access. 	http://www.ncbi.nlm.nih.gov/pmc/articles/PMC3345812/

Vaughn, S., Schummn, J. S., & Sinagub, J. (1996). Focus group interviews in education and [[concepts/psychology|psychology]]. Thousand Oaks, CA: Sage.

qualcore.com QualCore.com [[entities/inc|Inc.]] is a firm providing traditional and Internet-based qualitative research services. It is located in Minneapolis, MN.

www.itracks.com itracks is a company that specializes in providing bulletin board services for market researchers. It is located in Saskatoon, SK, Canada.
...
Participants: People who make decisions to buy this product | Consumer Product
Purpose: Better understand what features consumers look for in a product
Participants: People who make decisions to buy this product | Consumer Product
Purpose: Better understand what features consumers look for in a product
...
| 5. | When you decide to purchase .... , what do you look for? Take a piece of paper and jot down three things that are important to you when you purchase ..... | 10 |
| 6. | Let's list these on the flip chart. If you had to pick only one factor that was most important to you, what would it be? You can pick something that you mentioned or something that was said by others. | 10 |
| 7. | X is most important to a number of you. Talk about that. | 15 |
| 8. | Y is most important to others. Talk about that. | 15 |
| 9. | Have you ever changed brands or types of ..... (Raise hands

| 7. | X is most important to a number of you. Talk about that. | 15 |
| 8. | Y is most important to others. Talk about that. | 15 |
| 9. | Have you ever changed brands or types of ..... (Raise hands)
What brought about the change? | 10 |
| 10. | If you had one minute to give advice to the people who [[concepts/design|design]] …, what would you say? | 10 |
| | | 105 |

**Table 2:**
| Program Evaluation
Purpose: To gain input on strengths of the program and what could be improved.
Participants: Adults who have been in the program at least two years. | Program Evaluation
Purpose: To gain input on strengths of the program and what could be improved.
Participants: Adults who have been in the program at least two years. | Program Evaluation
Purpose: To gain input on strengths of the program and what could be improved.
...
| 3. | Let’s talk about strengths. 
a. Take this piece of paper and write down three things (name of program) does particularly well. (Give time to write.) 
b. OK. Let’s go around the table and each of you tell me what you wrote down and give me a one-sentence description of that thing. (List each item on a flip chart. If an item is mentioned more than one time, put a check mark next to it for each additional time it is mentioned.) 
c. (Pick the one with the most check marks and say) A number of you said X was a strength. Talk more about that. (Discuss two or three items—as time allows.) | 25 |
| 4. | Now let’s talk about what needs improvement. Let’s use the same process.
a. Using the same piece of paper, write down three things (name of program) could improve.
b. OK. Let’s go around the table and each of you tell me what you wrote down and give me a one-sentence de

a. Using the same piece of paper, write down three things (name of program) could improve.
b. OK. Let’s go around the table and each of you tell me what you wrote down and give me a one-sentence description of that thing. (List each item on a flip chart. If an item is mentioned more than one time, put a check mark next to it for each additional time it is mentioned.) 
c. (Pick the one with the most check marks and say) A number of you said X could be improved. Talk about that. What is the problem and how could it be improved? (Discuss two or three things—as time allows.) | 25 |
| 5. | Suppose that you were in charge and could do whatever you wanted to improve the program better. What change would you make? | 10 |
| 6. | What can participants do to make the program better? | 10 |
| 7. | One of the problems that the staff struggle with is declining participation. How could they get more people to participate? | 15 |
...
**Table 3:**
| The Focus Group Plan | The Focus Group Plan |
| --- | --- |
| 1. Name of the study | |
...
**Table 4:**
| ANALYSIS TYPE | Memory- based analysis | Note-based analysis | Abridged
transcript
analysis | Transcript- based analysis |
| --- | --- | --- | --- | --- |
| DESCRIPTION | Moderator analyzes based on memory and past experiences Gives oral debriefing & PowerPoint to client | Moderator prepares a brief written description based on summary comments, field notes and selective review of recording | Moderator prepares written report based on an abridged transcript after listening to audio plus field notes and moderator debriefing | Analyst prepares written report based on complete transcripts. Some use of field notes and moderator debriefing |
| ORAL OR WRITTEN REPORTS | Usually oral report & PP | Usually oral and written report | Usually oral and written report | Usually oral and written report |
| TIME REQUIRED PER GROUP | Very fast 
1 hour per group | Fast
About 1-3 hours per group | Slower
About one day per group | Slow
...
## Related Concepts
- [[concepts/group-dynamics|Group Dynamics]] — [Wikipedia](https://en.wikipedia.org/wiki/Group_Dynamics)
- [[concepts/structured-conversation|Structured Conversation]] — [Wikipedia](https://en.wikipedia.org/wiki/Structured_Conversation)
- [[concepts/2026-04-14-how-to-get-tack-sharp-photos-with-any-camera|Focus]] — [Wikipedia](https://en.wikipedia.org/wiki/Focus)
- [[concepts/internet-of-things|Data Collection]] — [Wikipedia](https://en.wikipedia.org/wiki/Data_Collection)
- [[concepts/open-ended-questions|Open-Ended Questions]] — [Wikipedia](https://en.wikipedia.org/wiki/Open-Ended_Questions)
- [[concepts/internet-of-things|Focus Group Interviewing]] — [Wikipedia](https://en.wikipedia.org/wiki/Focus_Group_Interviewing)
- Moderator [[concepts/skills|Skills]] — [Wikipedia](https://en.wikipedia.org/wiki/Moderator_Skills)
- Discussion Facilitation — [Wikipedia](https://en.wikipedia.org/wiki/Discussion_Facilitation)
- Active Engagement — [Wikipedia](https://en.wikipedia.org/wiki/Active_Engagement)
- Study Planning — [Wikipedia](https://en.wikipedia.org/wiki/Study_Planning)
- Participant Recruitment — [Wikipedia](https://en.wikipedia.org/wiki/Participant_Recruitment)
- [[concepts/motivation|Incentive]] Strategies — [Wikipedia](https://en.wikipedia.org/wiki/Incentive_Strategies)
- [[concepts/ai-data-analysis|Qualitative Data Analysis]] — [Wikipedia](https://en.wikipedia.org/wiki/Qualitative_Data_Analysis)
- [[concepts/text-transcript|Transcription]] — [Wikipedia](https://en.wikipedia.org/wiki/Transcription)
- [[concepts/thematic-analysis|Thematic Coding]] — [Wikipedia](https://en.wikipedia.org/wiki/Thematic_Coding)
- Systematic Analysis — [Wikipedia](https://en.wikipedia.org/wiki/Systematic_Analysis)
- Reporting Results — [Wikipedia](https://en.wikipedia.org/wiki/Reporting_Results)
- Telephone [[concepts/2026-04-14-how-to-get-tack-sharp-photos-with-any-camera|Focus Groups]] — [Wikipedia](https://en.wikipedia.org/wiki/Telephone_Focus_Groups)
- Program Evaluation — [Wikipedia](https://en.wikipedia.org/wiki/Program_Evaluation)
- Consumer Research — [Wikipedia](https://en.wikipedia.org/wiki/Consumer_Research)

## Related Entities
- [[entities/focus-group|Focus Group]] — [Wikipedia](https://en.wikipedia.org/wiki/Focus_Group)
- University of Minnesota — [Wikipedia](https://en.wikipedia.org/wiki/University_of_Minnesota)
- Richard A. Krueger — [Wikipedia](https://en.wikipedia.org/wiki/Richard_A._Krueger)
- Mary Anne Casey — [Wikipedia](https://en.wikipedia.org/wiki/Mary_Anne_Casey)
- NCBI — [Wikipedia](https://en.wikipedia.org/wiki/NCBI)
