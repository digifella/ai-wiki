...
4. **Kiro's Strategic Vision: Vertically Integrated SDLC:**
	The combination of Spec, Steering, and Hooks suggests Kiro aims for a much larger scope in the [[concepts/app-creation|Software Development]] Life Cycle (SDLC). Instead of just being a "transactional" task-completion tool (like some other [[concepts/agents|agents]]), Kiro wants to be involved from analysis and [[concepts/design|design]] through implementation, [[concepts/testing|testing]], and deployment, becoming more "vertically integrated" across the entire development process.
