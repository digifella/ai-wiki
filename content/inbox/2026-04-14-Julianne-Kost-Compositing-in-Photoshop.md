---
wiki-ingested: true
title: "Julianne Kost Compositing in Photoshop"
...
---
# [[entities/julianne-kost|Julianne Kost]] Compositing in [[concepts/photoshop|Photoshop]]

---
---
<https://www.youtube.com/watch?v=bMXJwZuzP14>
Here is a step-by-step guide to the compositing [[concepts/workflow|workflow]] demonstrated in the video, utilizing both traditional Photoshop tools and new AI-powered features.

# Compositing in [[entities/adobe-photoshop|Adobe Photoshop]]: New & Traditional Techniques

**Instructor:** [[entities/julieanne-kost|Julieanne Kost]]

* * *

## 1\. Document [[concepts/setup|Setup]] & Importing

1. **Create New Document:** Set dimensions to **20x20 inches** at **300 ppi**, **16-bit**, in **[[concepts/adobe-rgb|Adobe RGB]]**.
2. **Import from [[concepts/lightroom|Lightroom]]:** Select images in [[entities/lightroom-classic|Lightroom Classic]], right-click, and choose **Edit In > Open as Smart Object Layers in Photoshop**.
	* _Why [[concepts/smart-objects|Smart Objects]]?_ They retain raw data for non-destructive edits (like temperature/tint) and allow resizing/transforming without quality loss.
...
* **Sky:** Transform to fit. Double-click the Smart Object thumbnail to open **[[concepts/camera-raw|Camera Raw]]**. Adjust **Temperature** to shift the color from pink to blue (avoids banding compared to standard HSL [[concepts/adjustments|adjustments]]).
...
1. Go to **firefly.[[entities/adobe|adobe]].com** and choose **Generate Image**.
...
1. **[[concepts/texture|Texture]]:** Add a photo of paper texture. Set **Blend Mode** to **Soft Light**.
...
**Key Takeaway:** By combining traditional [[concepts/masking|masking]] and photography with the power of Generative Fill and Adobe Firefly, you can create high-resolution, surreal composites that maintain a cohesive photographic look.