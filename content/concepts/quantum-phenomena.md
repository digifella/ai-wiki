...
- entanglement: A phenomenon where particles become correlated such that the state of one particle instantaneously influences the state of another, regardless of distance.
- wave-particle duality: The inherent property of quantum entities to exhibit both wave-like and particle-like characteristics.
- quantum tunneling: The process by which particles traverse potential energy barriers that would be impassable according to classical [[concepts/physics|physics]].
