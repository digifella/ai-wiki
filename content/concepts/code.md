...
Code exists in many forms depending on its [[concepts/motivation|purpose]] and context. Source code is the human-readable text that programmers write directly. This code is typically written in one of hundreds of existing programming languages—such as [[entities/python|Python]], JavaScript, Java, or C++—each with different syntax and [[concepts/design-philosophies|design philosophies]]. Before a computer can execute source code, it must be processed through a compiler or interpreter, which translates the human-written instructions into machine code that the processor understands.
