...
authors: ['Ram A. Dixit', '2 Stephen Hurst', '3 Katharine T. Adams', '2 Christian Boxley', 'Kristi Lysen-Hendershot', '4 Sonita S. Bennett', '2 Ethan Booker', 'Raj M. Ratwani', '3MedStar [[concepts/simulation|Simulation]] Training', 'Education Lab', '4MedStar Telehealth [[concepts/innovation|Innovation]]', '3007 Tilden Street NW']
...
tise. These capabilities were developed over the course of a 3-week
...
Features:
Summary metrics, weekly tables, bar graphs and line charts of
...
•
Incorporates end user date ﬁltering allowing control over calcu-
