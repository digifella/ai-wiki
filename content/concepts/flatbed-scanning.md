...
Flatbed scanning is a method of digitizing film negatives and [[entities/google-slides|slides]] using a standard [[concepts/flatbed-scanner|flatbed scanner]], typically the kind used for scanning documents and photographs. This process allows individuals to convert analog film materials into digital format without requiring specialized [[concepts/film-scanning|film scanning]] equipment or professional lab services. Most flatbed scanners designed for this [[concepts/motivation|purpose]] include transparency adapters or specialized [[concepts/software|software]] that enables them to capture [[concepts/images|images]] from transparent media.
