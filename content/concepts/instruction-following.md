...
For [[concepts/running|running]] well-instructed [[concepts/large-language-model]]s on a 48GB [[concepts/vram|VRAM]] NVIDIA GPU, the following quantized models are strong contenders:
