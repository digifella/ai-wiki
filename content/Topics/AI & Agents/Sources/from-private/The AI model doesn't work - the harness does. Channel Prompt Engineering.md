...
Despite frontier [[concepts/models|models]] like **[[concepts/gpt-52|GPT-5.2]]**, **[[entities/claude-4|Claude 4]].6**, and **[[entities/gemini-30|Gemini 3]]** scoring 90%+ on standard benchmarks, they fail at real-world professional tasks.

* **The APEX Benchmark:** A new benchmark [[concepts/testing|testing]] [[concepts/agents|agents]] on [[concepts/long-horizon-professional-work|long-horizon professional work]] (consultancy, law, investment analysis).
...
* **The New [[concepts/setup|Setup]]:** They gave the agent a single tool—**arbitrary bash execution** (grep, cat, ls) inside a sandbox.
