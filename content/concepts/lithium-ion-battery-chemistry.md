...
- *   EV battery degradation rates are markedly lower than smartphone batteries due to robust [[concepts/thermal-regulation|thermal regulation]], precision cell balancing, and conservative [[concepts/state-of-charge]] operating [[entities/windows|windows]] [[lab-notes/2026-05-11-EV-Battery-Longevity-Actual-Degradation-Data-for-Buyers|EV Battery Longevity: Actual Degradation Data for Buyers]].
- *   Real-world telemetry refutes rapid-[[concepts/battery-degradation-rate|capacity-loss]] assumptions; degradation curves demonstrate retention sufficient for full vehicle lifecycle.
- **Chemistry Impact:**
...
## Key Metrics
- **State of [[concepts/health|Health]] (SoH):** Ratio of current maximum capacity to nominal [[concepts/design|design]] capacity.
