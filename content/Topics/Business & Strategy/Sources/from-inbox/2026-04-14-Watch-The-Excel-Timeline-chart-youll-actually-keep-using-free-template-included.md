...
---
# Watch The [[entities/microsoft-excel|Excel]] Timeline chart you'll actually keep using (free template included) on [[entities/youtube|YouTube]]
...
Before creating the chart, organize your data into an [[entities/excel-table|Excel Table]] ([[entities/ctrl-t|Ctrl + T]]) with three columns:
