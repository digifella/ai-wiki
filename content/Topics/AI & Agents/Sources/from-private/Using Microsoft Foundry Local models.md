...
group: needs-review
---
![[./_resources/Using_Microsoft_Foundry_Local_models.resources/image.png]]![[./_resources/Using_Microsoft_Foundry_Local_models.resources/image.1.png]]

To install [[entities/foundry|Foundry]] Local using PowerShell, I'll run `winget install Microsoft.FoundryLocal`.

|     |     |     |     |     |     |
| --- | --- | --- | --- | --- | --- |
| Alias | Device | Task | File Size | License | Model ID |
| phi-4 | GPU | chat-completion | 8.37 GB | [[entities/mit-license|MIT]] | Phi-4-cuda-gpu:1 |
...
| mistral-7b-v0.2 | GPU | chat-completion | 3.98 GB | [[concepts/apache-2.0|apache-2.0]] | mistralai-Mistral-7B-Instruct-v0-2-cuda-gpu:1 |
...
## Related Concepts
- [[concepts/winget|winget]] — [Wikipedia](https://en.wikipedia.org/wiki/winget)
- [[concepts/vram|GPU]] — [Wikipedia](https://en.wikipedia.org/wiki/GPU)
- [[concepts/chat-completion|chat-completion]] — [Wikipedia](https://en.wikipedia.org/wiki/chat-completion)
- [[entities/foundry|Foundry]] Local — [Wikipedia](https://en.wikipedia.org/wiki/Foundry_Local)
- PowerShell — [Wikipedia](https://en.wikipedia.org/wiki/PowerShell)
- [[concepts/microsoft-support|Microsoft]] — [Wikipedia](https://en.wikipedia.org/wiki/Microsoft)

## Related Entities
- Foundry Local — [Wikipedia](https://en.wikipedia.org/wiki/Foundry_Local)
- Phi-4 — [Wikipedia](https://en.wikipedia.org/wiki/Phi-4)
- Phi-3.5-mini — [Wikipedia](https://en.wikipedia.org/wiki/Phi-3.5-mini)
- phi-3-mini-128k — [Wikipedia](https://en.wikipedia.org/wiki/phi-3-mini-128k)
- phi-3-mini-4k — [Wikipedia](https://en.wikipedia.org/wiki/phi-3-mini-4k)
- mistral-7b-v0.2 — [Wikipedia](https://en.wikipedia.org/wiki/mistral-7b-v0.2)
- deepseek-r1-14b — [Wikipedia](https://en.wikipedia.org/wiki/deepseek-r1-14b)
- DeepSeek-R1-Distill-Qwen-14B — [Wikipedia](https://en.wikipedia.org/wiki/DeepSeek-R1-Distill-Qwen-14B)
- qwen2.5-coder-0.5b — [Wikipedia](https://en.wikipedia.org/wiki/qwen2.5-coder-0.5b)