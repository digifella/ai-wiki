...
pH is a logarithmic scale that measures the concentration of hydrogen ions in a substance, ranging from 0 to 14. A pH of 7 indicates neutrality, values below 7 indicate acidity, and values above 7 indicate alkalinity (or basicity). Because the scale is logarithmic, each unit change represents a tenfold difference in hydrogen ion concentration.
