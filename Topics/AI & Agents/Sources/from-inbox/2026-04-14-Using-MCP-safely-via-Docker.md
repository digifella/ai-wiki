...
Here is a detailed [[concepts/markdown|Markdown]] summary of the video transcript regarding the evolution of the [[concepts/model-context-protocol|Model Context Protocol (MCP)]] and Docker's new solutions.
...
* **Inefficiency:** Agents become slow and expensive because they are aware of too many tools they [[entities/will|will]] never use in a specific session.
