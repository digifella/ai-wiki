...
- **[[concepts/cpu|Processor]]:** X-Processor 5
- **Autofocus System:** Advanced Hybrid Autofocus (up to 187 phase-detection points)
- **ISO Range:** Auto, 160 - 12800 (expandable up to ISO 409600)
- **Shutter Speeds:** Electronic front curtain shutter (30 min - 1/180 sec) and mechanical shutter (1/4000 sec - 30 min)

## Lock Feature
The Fujifilm X-T5 incorporates a robust "Lock" feature designed to prevent [[concepts/accidental-changes|accidental changes]] to [[concepts/camera-settings|camera settings]], ensuring stability during critical shooting sessions. This feature can be activated through specific menu options or by pressing dedicated [[concepts/buttons|buttons]].

### Comprehensive Guide and Usage Explained
- **[[entities/tasia-custode|Author]] / channel:** [[entities/pal2tech|pal2tech]]
- **URL:** https://www.youtube.com/watch?v=C2ZN6ByntPk
- **Summary:**
  This video provides a comprehensive guide to Fujifilm's often misunderstood "Lock" feature, demonstrating how to access and utilize this feature on Fujifilm X-T5 and [[entities/x-s20|X-S20]] cameras. It highlights the [[concepts/value|importance]] of understanding the principles behind the [[concepts/autofocus-mode|lock feature]] which apply across various Fujifilm models.
