...
---
# [[entities/qwen-tts-model|Qwen TTS model]] - [[entities/sam-witteveen-channel|Sam Witteveen channel]]
...
* **[[concepts/open-source|Open Source]]:** The [[entities/qwen-team|Qwen team]] recently open-sourced the Qwen3-TTS family, which includes features like [[concepts/voice-design|voice design]], [[concepts/voice-cloning|voice cloning]], and [[concepts/text-to-speech-generation|text-to-speech generation]]. These models are available on [[entities/hugging-face|Hugging Face]].
* **Model Sizes:** There are two main sizes:
	* **0.6B Model:** A smaller version supporting 9 premium [[concepts/timbres|timbres]] across 10 languages, suitable for [[concepts/low-latency-streaming|low-latency streaming]].
	* **1.7B Model:** A larger, more powerful version with advanced [[concepts/capabilities|capabilities]] like [[concepts/instruction-control|instruction control]] for voice design and high-quality voice cloning.
* **Key Features:**
...
* **Demos:** The models can be tested via a Hugging Face Space demo or through provided Colab notebooks, which showcase various tasks like multi-[[entities/speaker|speaker]] comparison, batch [[concepts/inference|inference]], and long-form [[concepts/text-generation|text generation]].