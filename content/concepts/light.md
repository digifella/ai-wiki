...
Light exhibits several key properties including reflection, [[concepts/refraction|refraction]], diffraction, and interference. When light encounters a surface, it may be absorbed, reflected, or transmitted depending on the material's properties. Refraction occurs when light passes between media of different densities, causing its path to bend. These properties form the basis for optical technologies including lenses, mirrors, and fiber [[concepts/optics|optics]].
