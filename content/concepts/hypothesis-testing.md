...
5. **[[entities/make|Make]] a decision:** Based on the comparison between the test statistic and critical values (or p-value), decide to either reject or fail to reject H₀.
...
- **Compare/Validate with [[entities/nature|Nature]]:** Test these computed consequences against observed natural phenomena.
