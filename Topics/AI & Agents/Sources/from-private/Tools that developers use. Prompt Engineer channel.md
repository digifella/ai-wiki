...
This video provides a summary and comparison of two recent developer surveys focused on AI tool and tech stack [[concepts/adoption|adoption]]:
...
6. **Openness to Chinese Models:** 55% would be willing to use LLMs from China-based [[entities/ai-labs|AI labs]], if hosted outside of [[entities/china|China]].
