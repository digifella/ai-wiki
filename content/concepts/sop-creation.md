...
Sop Creation refers to the process of developing Standard Operating Procedures (SOPs) within [[concepts/ai-productivity-agents|AI agent systems]], particularly in the context of evaluating and implementing new capabilities in [[concepts/large-language-model-llm|large language models]]. In April 2026, AI researcher [[entities/jeff-su|Jeff Su]] conducted a comprehensive month-long evaluation of [[concepts/gemini|Gemini]] 3.0, systematically [[concepts/testing|testing]] its performance across various [[concepts/scenarios|use cases]] to identify meaningful improvements over previous versions.
