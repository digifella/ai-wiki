...
- **[[concepts/customizable-status-lines|Customizable Status Lines]] (v1.0.71):**
    ...
    - **[[concepts/capabilities|Capabilities]]:** Can display real-time information such as weather, [[concepts/session|session]] duration, or active [[concepts/llm]] model [[concepts/metadata|metadata]].
