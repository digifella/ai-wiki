...
Here is a comprehensive [[concepts/markdown-guide|Markdown guide]] based on the [[concepts/workflow|workflow]] detailed in the video.

* * *

# 🎥 The "[[concepts/admin-privileges|Admin Privileges]]" [[concepts/ai-video-workflow|AI Video Workflow]]
...
* **Editing:** [[entities/capcut|CapCut]] / [[entities/premiere-pro|Premiere Pro]]
...
3. **Generate Strategy (Master Prompt #1):**
	...
	* **Objective:** Find [[concepts/hooks|hooks]], retention gaps, and [[concepts/structure|structure]] a unique angle.
...
1. **Generate Script (Master Prompt #2):**
	...
	* **[[concepts/instructions|Instructions]]:** No scene headers, use specific hooks found in Phase 1.
2. **Export:**
...
2. **Model:** `Nano Banana` (or `Nano Banana Pro`).
	* _Tip:_ If you hit the limit on Pro, switch to the [[concepts/standard-model|standard model]] (it is unlimited and free).
...
3. **Visuals Second:**
	...
	* Because you generated clips in **5-second chunks** based on the Shot List Table, simply drop the clips in order. They will naturally sync with the script lines they were generated for.
