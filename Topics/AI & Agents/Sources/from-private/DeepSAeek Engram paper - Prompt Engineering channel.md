...
Here is a comprehensive [[concepts/markdown|Markdown]] summary of the video regarding [[entities/deepseek|DeepSeek]]'s "[[concepts/engram|Engram]]" paper.

* * *

# [[entities/engram|DeepSeek Engram]]: Conditional [[concepts/memory|Memory]] via Scalable Lookup

**Paper Title:** _Conditional Memory via Scalable Lookup: A New Axis of Sparsity for Large Language Models_

## 1\. The Core Problem: Wasteful Computation

The fundamental inefficiency in current Transformer architectures is that they do not distinguish between tasks requiring deep thought and tasks requiring simple [[concepts/recall|recall]].
...
3. **Massive Embedding Table:** The indices point to a massive table (billions of [[concepts/parameters|parameters]]) to retrieve [[concepts/vector-representations|embeddings]].
...
## 4\. The U-Shaped [[concepts/scaling-law|Scaling Law]]
...
* Because Engram handles local dependencies, the [[concepts/attention|Attention]] mechanism is freed up to focus on long-[[concepts/range|range]], global dependencies.
...
* **Not RAG:** This is not [[concepts/traditional-rag|retrieval-augmented generation]]; it does not connect to an external live database (internet/files). The lookup table is fixed after training.
* **Limited Order:** Currently uses only 2-grams and 3-grams; longer patterns might be missed.

## Summary: The Bigger Picture

[[concepts/engram|Engram]] represents a shift toward **[[concepts/disconnection|Separation]] of Concerns** in AI [[concepts/architecture|architecture]], mirroring human [[concepts/cognition|cognition]]:
...
## Related Concepts
- [[concepts/conditional-memory|Conditional Memory]] — [Wikipedia](https://en.wikipedia.org/wiki/Conditional_Memory)
- [[concepts/scalable-lookup|Scalable Lookup]] — [Wikipedia](https://en.wikipedia.org/wiki/Scalable_Lookup)
- [[concepts/scalable-lookup|Transformer Architecture]] — [Wikipedia](https://en.wikipedia.org/wiki/Transformer_Architecture)
- [[concepts/large-language-models|Large Language Models]] — [Wikipedia](https://en.wikipedia.org/wiki/Large_Language_Models)

## Related Entities
- [[entities/deepseek-engram|DeepSeek Engram]] — [Wikipedia](https://en.wikipedia.org/wiki/DeepSeek_Engram)