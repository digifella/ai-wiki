---
wiki-ingested: true
title: "Claude Code  Blotato Automating AI Viral Video Creation"
...
**Clip title:** [[entities/claude-code|Claude Code]] + Blotato = Automated Shorts in Minutes
([[concepts/tutorial|Tutorial]])
**Author / channel:** Koen | [[concepts/ai-content-systems|AI Content Systems]]
...
specifically [[concepts/claude-code|Claude Code]], to fully automate the creation and multi-platform
...
method of building complex N8N [[concepts/automation|automation]] workflows, which can be
time-consuming and error-prone, with the conversational simplicity and
efficiency offered by [[entities/claude-code|Claude Code]].

The core of the [[concepts/automation|automation]] process involves using [[concepts/claude|Claude]] Code as an
intelligent [[entities/agent|agent]]. Users simply type a command like `/generate-and-post`,
and [[concepts/ai-assisted-coding|Claude Code]] initiates a [[concepts/dialogue|dialogue]], asking [[concepts/clarifying-questions|clarifying questions]] about the
desired video's niche, aspect ratio (e.g., 9x16 for shorts), duration, and
preferred social media platforms for distribution. Based on these inputs,
...
[[entities/blotato|Blotato]], a [social media API](https://en.wikipedia.org/wiki/Social_media_API) trusted by platforms, handles the simultaneous
...
the problem, identified missing [[concepts/files|files]] and [[concepts/configuration|configuration]] issues, and
...
[[concepts/problem-solving|problem-solving]] dramatically simplifies the automation setup process.
...
## Related Concepts
- [[concepts/ai-video-creation|AI video creation]] — [Wikipedia](https://en.wikipedia.org/wiki/AI_video_creation)
- [[concepts/multi-platform-content-distribution|Multi-platform content distribution]] — [Wikipedia](https://en.wikipedia.org/wiki/Multi-platform_content_distribution)
...
- [[concepts/ai-generated-shorts|AI-generated shorts]] — [Wikipedia](https://en.wikipedia.org/wiki/AI-generated_shorts)
- [[concepts/ai-content-workflows|AI content automation]] — [Wikipedia](https://en.wikipedia.org/wiki/AI_content_automation)
- [[concepts/seo|Multi-platform posting]] — [Wikipedia](https://en.wikipedia.org/wiki/Multi-platform_posting)
...
- [Conversational programming](https://en.wikipedia.org/wiki/Conversational_programming) — [Wikipedia](https://en.wikipedia.org/wiki/Conversational_programming)
...
- [Automated posting](https://en.wikipedia.org/wiki/Automated_posting) — [Wikipedia](https://en.wikipedia.org/wiki/Automated_posting)
- Automated setup — [Wikipedia](https://en.wikipedia.org/wiki/Automated_setup)
