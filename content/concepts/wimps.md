...
WIMPs ([[concepts/wimp-particles|Weakly Interacting Massive Particles]]) are hypothetical particles proposed as candidates for [[concepts/dark-matter|dark matter]], the invisible matter that comprises most of the universe's mass. Unlike [[concepts/baryonic-matter|ordinary matter]], WIMPs interact only through [[concepts/gravitational-pull|gravity]] and the weak nuclear force, making them extremely difficult to detect directly. Their name reflects their fundamental characteristics: they are massive particles that interact only weakly with normal matter.
