...
Techniques and tools for automating web browser interactions programmatically, enabling [[concepts/workflow|workflow]] efficiency and [[concepts/testing|testing]].

## Tools & Implementations

### Claude Code
Recent CLI features allow direct [[concepts/browser-control|browser control]] via extensions.
