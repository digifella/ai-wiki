...
Rate limits are restrictions imposed on how frequently requests can be made to [[concepts/claude-ai|Claude]] through the API. They control the number of requests per minute and [[concepts/tokens|tokens]] processed per minute, varying by subscription tier and account status. Understanding and working within these limits is essential for building reliable [[concepts/software|applications]] and avoiding service interruptions.
