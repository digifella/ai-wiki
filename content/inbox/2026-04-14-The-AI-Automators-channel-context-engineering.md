---
wiki-ingested: true
title: "The AI Automators channel context engineering"
...
---
# [[entities/the-ai-automators|The AI Automators]] channel [[concepts/context-engineering|context engineering]]

---
---
<https://www.youtube.com/watch?v=WmG-PanaaSk>
Okay, I will retry and provide a detailed markdown of the video's content.

* * *

### 00:00 - 00:04: Introduction to Context Engineering

**Spoken Text:** Everyone's talking about context engineering right now. And for good reason.
**Visuals:**

* A blog post on a website "PHILSCHMID" with the title "The New Skill in AI is Not Prompting, It's Context Engineering".
* Text on the page: "Context Engineering is new term gaining traction in the AI world. The conversation is shifting from '[[concepts/prompt-engineering|prompt engineering]]' to a broader, more powerful concept: **Context Engineering**. **Tobi Lutke** describes it as 'the art of providing all the context for the task to be plausibly solvable by the LLM.' and he is right."
* The speaker, Alan Walsh, is visible in a small window at the bottom right.
...
* A screen capture of an n8n workflow interface. The workflow is titled "The AI Automators - TheAIAutomators.com - HA...".
...
* The workflow starts with "When chat message received" and leads to "Telegram Response".
...
* Inside, overlapping circles represent: "[[concepts/instructions|Instructions]] / [[concepts/system-prompt|System Prompt]]," "State / History (Short-term Memory)," "User Prompt," "Long-Term Memory," "Retrieved Information (RAGs)," "Available Tools," and "[[concepts/structured-output|Structured Output]]."
...
* **00:22:** An n8n workflow titled "The AI Automators - Newsletter AI Agent Team".
...
* **00:25:** A LangChain blog post titled "General categories of context engineering".
* **00:26:** The LangChain article highlights problems like "exceed the size of the [[concepts/context-window|context window]]," "balloon cost / latency," "degrade agent performance."
* **00:27:** Specific issues listed: "Context Poisoning," "Context Distraction," "Context Confusion," "Context Clash."
* **00:28:** A diagram of "Turn 1" and "Turn 2" showing "Human," "System Message," "Tool call," "LLM," "Feedback" interactions.
...
* **01:07:** The "Simple Memory" node's parameters are shown. "Context Window Length" is set to "5". "How many past interactions the model receives as context" is displayed.
...
### 02:08 - 03:31: Strategy 2: Long-Term Memory (with Google Docs Example)

**Spoken Text:** Next up is long-term memory. There are lots of different ways to do this within n8n, but one of the easiest ways is just to use a Google Doc. In this case, when a chat message is received, the AI agent has the choice to update its long-term memories. So it decides if that message contains information that will be useful in the future. And the AI agent can then use this information long into the future. So I'll just start with a simple message, "My name is Alan." From there it's going to get the previous memories where there's currently nothing in there. And it's going to the LLM. It's saved something to the long-term memories. And it's going to respond to us. Now if I go into the Google Doc, it's added this line, "The user's name is Alan." Now if I follow up with that to say, "I use the n8n automation platform." From there, I'm also expecting that to be saved to the long-term memory as well. And you see that's been saved separately. But if I ask another message like, "What is 9 x 5?" Then I'm expecting that not to be saved to the long-term memory. And there you go. It saved it to the short-term memory, but not the long-term memory. And the document was not updated.
**Visuals:**
...
* **04:08:** A clean ChatGPT 4o interface.
...
* **11:51:** The "When Executed by Another Workflow" input data is manually set to `{"url": "https://www.theaiautomators.com/"}` for testing.
...
* **15:53:** A new website "Firecrawl" is shown, specifically their dashboard. It highlights integrations with Python, JS/TS SDK, Langchain, LlamaIndex, Make, Discord, and CrewAI.
