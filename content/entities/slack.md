...
[[entities/slack]] is a cloud-based collaboration and communication platform owned by [[entities/salesforce]].

## AI Strategy & Work Transformation
- A key element in [[entities/salesforce]]'s strategic positioning regarding the profound impact of [[concepts/ai-technologies|Artificial Intelligence]] and [[concepts/agentic-ai|Agents]] on the [[concepts/future-of-work|future of Work]].
- Serves as a primary interface for [[concepts/work-transformation|Work Transformation]] driven by [[concepts/ai]] and [[concepts/agentic-ai|agentic workflows]].
- **Framework [[concepts/integration|Integration]]:** Acts as a critical application interface for [[concepts/open-source|open-source]], [[concepts/local-ai-assistant|local AI assistant]] frameworks like [[entities/openclaw|OpenClaw]], enabling the integration of personalized AI "brains" and automated pipelines into daily communication [[concepts/workflow|workflows]].
- **Agentic Connectivity:** Serves as a primary connector for [[concepts/openclaw|Clawdbot (OpenClaw)]] to interface with [[entities/gmail|Gmail]], [[entities/asana|Asana]], and [[entities/telegram|Telegram]] to execute [[concepts/real-world-tasks|real-world tasks]].

### Recent Insights from Marc Benioff
