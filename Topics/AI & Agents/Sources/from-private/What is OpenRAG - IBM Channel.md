...
As Generative AI (GenAI) models have matured, their context windows have become massive. This has led to discussions in the tech community suggesting that **RAG ([[concepts/traditional-rag|Retrieval-Augmented Generation]])** might no longer be necessary.
