...
## Types of Caching
- **Browser Caching**: Stores static assets ([[concepts/images|images]], CSS, JS) locally.
- **Proxy Caching**: Intermediate servers store [[concepts/responses|responses]] for frequently accessed content.
...
- **[[concepts/logical-consistency|Consistency]]**: Maintaining data consistency across caches.
...
- **Cloudflare [[concepts/setup|Setup]]**: Configured caching rules for static assets and API [[concepts/responses|responses]].
