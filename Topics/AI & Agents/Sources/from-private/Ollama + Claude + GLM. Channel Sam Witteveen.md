...
By default, Ollama uses a context length of **4096 tokens**. This is insufficient for coding agents like Claude Code, which [[entities/will|will]] cause the model to forget instructions or fail to use tools.
