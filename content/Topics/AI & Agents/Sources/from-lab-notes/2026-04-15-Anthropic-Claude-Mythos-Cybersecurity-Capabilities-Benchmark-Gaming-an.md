---
wiki-ingested: true
title: "Anthropic Claude Mythos Cybersecurity Capabilities Benchmark Gaming and Deception"
...
## Related Concepts
- [[concepts/anthropic-ai|Anthropic AI]] — [Wikipedia](https://en.wikipedia.org/wiki/Anthropic_AI)
- [[concepts/gaming|Gaming]] — [Wikipedia](https://en.wikipedia.org/wiki/Gaming)
- [[concepts/mythos|Mythos]] — [Wikipedia](https://en.wikipedia.org/wiki/Mythos)
- [[concepts/system-instructions|AI alignment]] — [Wikipedia](https://en.wikipedia.org/wiki/AI_alignment)
- Autonomous cyber threats — [Wikipedia](https://en.wikipedia.org/wiki/Autonomous_cyber_threats)
- Deception in AI — [Wikipedia](https://en.wikipedia.org/wiki/Deception_in_AI)
- Gameability of benchmarks — [Wikipedia](https://en.wikipedia.org/wiki/Gameability_of_benchmarks)
- Optimization bias — [Wikipedia](https://en.wikipedia.org/wiki/Optimization_bias)
- Robustness testing — [Wikipedia](https://en.wikipedia.org/wiki/Robustness_testing)
- [[concepts/secure|Security]] evaluation — [Wikipedia](https://en.wikipedia.org/wiki/Security_evaluation)
- Superintelligence — [Wikipedia](https://en.wikipedia.org/wiki/Superintelligence)
- [[concepts/vulnerability|Vulnerability]] exploitation — [Wikipedia](https://en.wikipedia.org/wiki/Vulnerability_exploitation)

## Related Entities
- [[entities/two-minute-papers|Two Minute Papers]] — [Wikipedia](https://en.wikipedia.org/wiki/Two_Minute_Papers)
- Anthropic Claude Mythos Preview — [Wikipedia](https://en.wikipedia.org/wiki/Anthropic_Claude_Mythos_Preview)
- [[entities/anthropic|Anthropic]] — [Wikipedia](https://en.wikipedia.org/wiki/Anthropic)
- Jan Leike — [Wikipedia](https://en.wikipedia.org/wiki/Jan_Leike)
