...
---
# Use [[concepts/claude-code|Claude code]] for more than [[concepts/coding|coding]] eg for research

---
---
<https://www.youtube.com/watch?v=RV9vBRtXagQ>
Here is a [[concepts/summary|summary]] of the video titled **"How to Make Claude Code Cook"**, detailing how to repurpose [[entities/anthropic|Anthropic]]'s coding tool into a general-[[concepts/purpose|purpose]] [[concepts/autonomous-agent-system|autonomous agent system]].
...
The speaker demonstrates a custom file-based architecture called the **Open Agent System**. Instead of [[concepts/writing|writing]] complex [[concepts/software|software]], this system relies on [[concepts/markdown|Markdown]] files to define "[[concepts/agents|agents]]."
...
4. **The Instagram Agent (Created Live):** The speaker asks Claude to create a _new_ agent on the fly. Claude reads the system structure, creates the definition file, creates the slash command, and immediately uses the new agent to generate a social media post about the content.
...
| **Compatibility** | **Claude Code Only.** | **Universal.** Works with Claude Code, Codex, Cursor, [[entities/gemini-cli|Gemini CLI]], etc. |
