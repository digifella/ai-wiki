...
Here is a summary of the video titled **"How to Make Claude Code Cook"**, detailing how to repurpose [[entities/anthropic|Anthropic]]'s coding tool into a general-purpose [[concepts/autonomous-agent-system|autonomous agent system]].
...
The speaker demonstrates a custom file-based architecture called the **Open Agent System**. Instead of [[concepts/writing|writing]] complex [[concepts/software|software]], this system relies on [[concepts/markdown|Markdown]] files to define "agents."
