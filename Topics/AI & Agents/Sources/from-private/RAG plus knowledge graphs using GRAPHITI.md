...
* **Neo4j Setup:** Can be run via Neo4j Desktop or as part of a [[concepts/docker|Docker]] Compose [[concepts/local-ai|local AI]] package for a fully self-hosted [[concepts/solution|solution]].
