...
## Key Characteristics
- **Misfolded Proteins:** Prion diseases are unique because they are caused by a misfolded protein rather than by a virus, bacterium, or other infectious [[entities/agent|agent]].
...
- **Transmissibility:** Some prion diseases can be transmitted through [[concepts/exposure|exposure]] to infected tissue, making them a [[concepts/public-health|public health]] concern.

## Types of Prion Diseases
- **Creutzfeldt-Jakob Disease (CJD):** The most common form of prion disease in humans, causing rapid mental deterioration and [[concepts/exercise|movement]] problems.
- **[[entities/kuru|Kuru]]:** A disease observed in the [[entities/fore-tribe|Fore tribe]] of [[entities/papua-new-guinea|Papua New Guinea]], linked to cannibalistic funeral rituals.
...
- **Public [[concepts/health|Health]]:** Efforts to prevent the spread of prion diseases through proper disposal of infected tissue and [[concepts/regulation|regulation]] of food sources.

## Related Concepts
- [[entities/anton-petrov|Anton Petrov]]
- [[concepts/protein-world-hypothesis|Protein World Hypothesis]]
- [[concepts/fore-tribe|Fore Tribe]]
- [[concepts/kuru|Kuru]]
