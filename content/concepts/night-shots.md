...
The feature is available in beta form, meaning it remains under active development. The application initially experienced performance issues, including phone overheating during use, though Adobe has worked to address these problems. The feature is restricted to iPhone 13 Pro and later devices, reflecting [[concepts/hardware-requirements|hardware requirements]] for processing the computational photography involved.
