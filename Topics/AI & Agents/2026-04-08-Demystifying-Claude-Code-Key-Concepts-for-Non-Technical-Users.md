...
**Clip title:** Every [[concepts/ai-assisted-coding|Claude Code]] Concept Explained for Non-techies
...
- [[concepts/workspace-management|Workspace management]] — [Wikipedia](https://en.wikipedia.org/wiki/Workspace_management)
- [[concepts/system-integration|System integration]] — [Wikipedia](https://en.wikipedia.org/wiki/System_integration)
- [[concepts/software-commands|CLI commands]] — [Wikipedia](https://en.wikipedia.org/wiki/CLI_commands)
- [[concepts/coding-fundamentals|Coding fundamentals]] — [Wikipedia](https://en.wikipedia.org/wiki/Coding_fundamentals)
- [Repository](https://en.wikipedia.org/wiki/Repository) — [Wikipedia](https://en.wikipedia.org/wiki/Repository)
- [Terminal/CLI](https://en.wikipedia.org/wiki/Terminal/CLI) — [Wikipedia](https://en.wikipedia.org/wiki/Terminal/CLI)
- [Frontend vs Backend](https://en.wikipedia.org/wiki/Frontend_vs_Backend) — [Wikipedia](https://en.wikipedia.org/wiki/Frontend_vs_Backend)
