...
aliases:
  ...
  - "NotebookLM Video Export"
  - "AI Commercial Generator"
summary: A guide for converting NotebookLM notebooks into 30-second video commercials using Google Vids and Gemini.
updated: 2026-07-11
...
- "concept"
  - "[[concepts/google-search|google]]-[[concepts/ambition|drive]]"
  - "[[entities/notebooklm|notebooklm]]"
  - "[[entities/google-vids|google-vids]]"
  - "[[entities/gemini|gemini]]"
  - "[[concepts/video-creation|video-creation]]"
  - "[[concepts/ai-automation|ai-automation]]"
aliases:
  - "[[entities/google-drive|Google Drive]] workflows"
...
- 2026-04-23: <https://www.youtube.com/watch?v=g6w4Pz_urDg> Here is a step-by-step guide on how to turn a [[concepts/notebooklm-notebook|NotebookLM notebook]] into a 30-second [[concepts/video-commercial|video commercial]] using [[concepts/google-vids|Google Vids]] and [[concepts/gemini|Gemini]]. ### **Overview** * **Goal:** Create a cinematic 30-second ad based on [[concepts/business-philosophy|business philosophy]] stored in Note (Building a video from [[concepts/ai-integrated-notebooks|NotebookLM]] and Google Veo   Charles Terence [[entities/harper|Harper]] channel)
