...
The feature generates masks for both portrait subjects and landscape elements automatically. Once created, these AI-generated masks can be refined and used as the basis for localized [[concepts/adjustments|adjustments]] to [[concepts/exposure|exposure]], color, clarity, and other [[concepts/parameters|parameters]]. The single-click approach is intended to reduce the time spent on manual [[concepts/layer-masks|masking]], allowing photographers to focus on the creative aspects of editing rather than technical selection tasks.
