---
wiki-ingested: true
title: "Make compelling presentations with Ai - Jeff Su"
...
# Make compelling presentations with Ai - [[entities/jeff-su|Jeff Su]]
...
Most AI presentation tools like Gamma, Pitch, and Beautiful.ai are great at creating slides for "low-stakes presentations." However, they fail at the most critical part of any business presentation: **uncovering the insights that actually matter.**
There is a gap between **[[concepts/insight-generation|Insight Generation]]** (discovering what to say) and **[[concepts/insight-presentation|Insight Presentation]]** (making it look good).

* **What they can't do:** Answer [[concepts/strategic-questions|strategic questions]] like, "What are the [[concepts/opportunities-and-risks|opportunities and risks]] for entering this market?"
...
1. **#1: RESEARCH:** Use ChatGPT's (or [[entities/google-gemini|Google Gemini]]'s) [[entities/deep-research|Deep Research]] feature to identify opportunities and risks. This generates a detailed report.
2. **#2: [[concepts/structure|STRUCTURE]]:** Use a standard ChatGPT model to transform the research findings into a structured outline that tells a clear story, using established [[concepts/consulting|consulting]] frameworks.
...
1. Open ChatGPT and select the latest, most [[concepts/advanced-reasoning|advanced reasoning]] model (these are the "o" [[concepts/models|models]]).
...
* **[[concepts/workflow|WORKFLOW]]:** "1. Frame the research scope... 2. For each market, use Porter's 5 Forces framework to analyze competitive forces... 3. Weigh opportunities vs. risks, rank markets, and craft entry recommendations..."
* **OUTPUT FORMAT:** "1. Executive [[concepts/summary|Summary]] (≤ 200 words) 2. Market Snapshots (table) ... 6. Ranked Market Scorecard 7. Reference List."
...
**Tip 1: Review for Flow and [[concepts/accuracy|Accuracy]]** Do a first run-through to check if the story still flows and if any critical information was lost or misinterpreted during generation. Make simple text edits where necessary (e.g., changing "[[concepts/market-size|market size]]" to the more specific "skincare market size").
**Tip 2: Use "Edit with AI" for Better Titles** If a slide title is weak (e.g., "Indonesia Game Plan — How We Win"), click the **Edit with AI** button (the star icon) on that element and give it a command like, "Use an insights-led title." Gamma will suggest a more impactful title, such as "Capturing Indonesia's 54% YoY Growth: Our 3-Step Market Entry Strategy."
...
So today, I'll show you exactly how to combine ChatGPT's Deep Research [[concepts/capabilities|capabilities]] with Gamma's design features to create presentations that uncover meaningful insights AND look professional.
...
Open ChatGPT and select the latest [[concepts/reasoning-model|reasoning model]] (the "o" models). The model versions change quickly, so just pick the newest reasoning model and toggle on "Deep Research."
...
After [[concepts/running|running]] for about 7 minutes, ChatGPT delivers:
