...
# Paper Banana - AI with [[entities/surya|Surya]] channel

---
---
<https://www.youtube.com/watch?v=MtA7CGOXnko>
Here is a [[concepts/markdown|Markdown]] summary of the video transcript regarding the **PaperBanana** framework.

# PaperBanana: [[concepts/automated-academic-illustration|Automated Academic Illustration]] for AI Scientists

**PaperBanana** is a new framework developed by a team at **[[entities/google|Google]] and [[entities/peking-university|Peking University]]**. It is designed to generate publication-quality diagrams and infographics directly from plain text descriptions, overcoming the limitations of standard [[concepts/one-shot-image-generation-models|one-shot image generation models]].
...
* **Details:** It correctly mapped relationships between the User, Orchestrator, and [[concepts/sub-agents|Sub-agents]]. It visually represented specific tools (BigQuery, Pandas) and protocols (A2A) mentioned in the text.
