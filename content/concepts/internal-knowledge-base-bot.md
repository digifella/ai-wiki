...
## Building Process (via Copilot)
- Uses [[entities/microsoft-365-copilot|Microsoft 365 Copilot]] interface to create custom [[concepts/agents|agents]] without [[concepts/coding|coding]]
- Configures bot to reference organization-specific knowledge sources
