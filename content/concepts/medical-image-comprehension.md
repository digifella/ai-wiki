...
- **[[concepts/dermatology-images|MedGemma 27B]]**: A specialized medical AI model developed by [[entities/google]], built upon the [[concepts/gemma-3-architecture|Gemma 3 architecture]].
	- Engineered specifically for unified medical text and image comprehension tasks.
	- **Model Variants**:
		- 4B multimodal model (available in both pre-trained and instruction-tuned versions).
		- 27B parameter model.
