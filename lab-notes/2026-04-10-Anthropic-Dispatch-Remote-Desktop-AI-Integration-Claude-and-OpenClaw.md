...
platform, effectively acting as a remote control for [[entities/claude|Claude]] [[concepts/running|running]] on a
user's desktop computer via a mobile application. This [[concepts/innovation|innovation]] allows
for a [[concepts/persistent-conversation|persistent conversation]] with [[concepts/claude|Claude]], enabling users to assign tasks
...
that Dispatch, as a mobile [[concepts/ai-agent|AI agent]] with remote control over a [[concepts/desktop-ai|desktop AI]]
...
completion, and it does not yet support [[concepts/scheduled-tasks|scheduled tasks]], which are managed
...
- [[concepts/remote-desktop|Remote Desktop Control]] — [Wikipedia](https://en.wikipedia.org/wiki/Remote_Desktop_Control)
...
- [Personal AI Operating Systems](https://en.wikipedia.org/wiki/Personal_AI_Operating_Systems) — [Wikipedia](https://en.wikipedia.org/wiki/Personal_AI_Operating_Systems)
...
- [[concepts/ai-privacy-mitigation|Security Guardrails]] — [Wikipedia](https://en.wikipedia.org/wiki/Security_Guardrails)
- Policy-based [[concepts/privacy|Privacy]] — [Wikipedia](https://en.wikipedia.org/wiki/Policy-based_Privacy)
- [Multi-step AI Actions](https://en.wikipedia.org/wiki/Multi-step_AI_Actions) — [Wikipedia](https://en.wikipedia.org/wiki/Multi-step_AI_Actions)
- [[concepts/automation|Automation]] of Daily Workflows — [Wikipedia](https://en.wikipedia.org/wiki/Automation_of_Daily_Workflows)
- [[concepts/persistent-memory|Persistent Conversation]] — [Wikipedia](https://en.wikipedia.org/wiki/Persistent_Conversation)
