...
The primary aim of heavy ion collision research is to study the quark-gluon plasma (QGP), a state of matter in which quarks and gluons exist as free particles rather than confined within hadrons. By analyzing the particles produced in these collisions, physicists investigate fundamental properties of quantum chromodynamics, the strong nuclear force, and the behavior of matter under extreme temperatures and densities. These experiments also provide insight into the [[concepts/early-universe|early universe]] and the conditions required for matter formation.
