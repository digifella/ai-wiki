...
Despite frontier [[concepts/models|models]] like **[[entities/gpt-52|GPT-5.2]]**, **[[entities/claude-4|Claude 4]].6**, and **[[entities/gemini-3|Gemini 3]]** scoring 90%+ on standard benchmarks, they fail at real-world professional tasks.

* **The [[concepts/apex-benchmark|APEX Benchmark]]:** A new benchmark testing [[concepts/agents|agents]] on [[concepts/long-horizon-professional-work|long-horizon professional work]] (consultancy, law, investment analysis).
