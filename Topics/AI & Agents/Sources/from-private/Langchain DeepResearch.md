...
This video provides a detailed overview and demonstration of the [[entities/langchain|LangChain]] [[entities/chatgpt-deep-research|Deep Research]] [[entities/agent|Agent]], an [[concepts/open-source|open-source]], highly configurable agent built on the [[concepts/langgraph-workflows|LangGraph]] framework.
Here's a summary of the video's content:
**1\. Introduction & Initial Demonstration (0:00-0:56)**

* The [[entities/speaker|speaker]] introduces the LangChain Deep Research Agent, emphasizing its configurability and open-source nature.
...
## Related Concepts
- [[concepts/langgraph-framework|LangGraph Framework]] — [Wikipedia](https://en.wikipedia.org/wiki/LangGraph_Framework)
- [[concepts/deep-research-agent|Deep Research Agent]] — [Wikipedia](https://en.wikipedia.org/wiki/Deep_Research_Agent)
