...
These are the foundational [[concepts/models|models]]. While they seem interchangeable, each has a distinct "Superpower."

### 🤖 [[entities/chatgpt|ChatGPT]] ([[entities/openai|OpenAI]])
...
* **Best for:** [[concepts/complex-workflows|Complex workflows]], following strict instructions, and logic-heavy tasks where missing a step breaks the result.
...
* **[[concepts/context-window|Context Window]]:** Has a massive 1M - 2M token window, allowing for huge file uploads.
