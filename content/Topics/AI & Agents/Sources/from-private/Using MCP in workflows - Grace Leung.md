...
This video provides a detailed explanation of the Model Context Protocol (MCP) and its significance in building powerful AI [[concepts/agents|agents]] and workflows that can interact with external tools and data.
...
* **Powerful AI Agents/Workflows:** Distinguished by their ability to **access and use external tools** (calendars, databases, [[entities/email|email]], [[concepts/business-applications|business applications]]) to perform tasks on the fly.
...
* **Key Benefit: Model Agnostic:** AI applications become model agnostic, meaning you can swap different AI models ([[entities/chatgpt|ChatGPT]], [[concepts/gemini|Gemini]], [[entities/claude-4|Claude]], etc.) at any time without rebuilding the underlying integrations from scratch.

**3\. MCP [[concepts/architecture|Architecture]]: Servers and Clients**

* **[[concepts/mcp-servers|MCP Servers]]:** These are the business tools or systems that provide capabilities (data access, functions). They expose their functionalities via the MCP protocol.
...
- [[concepts/workflow|workflows]] — [Wikipedia](https://en.wikipedia.org/wiki/workflows)
- [[concepts/open-source-protocol|open-source protocol]] — [Wikipedia](https://en.wikipedia.org/wiki/open-source_protocol)
