...
platform, effectively acting as a remote control for Claude [[concepts/running|running]] on a
...
- [[concepts/mobile-to-desktop-ai-interaction|Mobile-to-Desktop AI Interaction]] — [Wikipedia](https://en.wikipedia.org/wiki/Mobile-to-Desktop_AI_Interaction)
- [[concepts/persistent-ai-conversation|Persistent AI Conversation]] — [Wikipedia](https://en.wikipedia.org/wiki/Persistent_AI_Conversation)
...
- [[concepts/local-data-processing|Local Computing]] Environment [[concepts/integration|Integration]] — [Wikipedia](https://en.wikipedia.org/wiki/Local_Computing_Environment_Integration)
...
- [[concepts/autonomous-workflows|Autonomous AI Workflows]] — [Wikipedia](https://en.wikipedia.org/wiki/Autonomous_AI_Workflows)
- [AI-driven Remote Control](https://en.wikipedia.org/wiki/AI-driven_Remote_Control) — [Wikipedia](https://en.wikipedia.org/wiki/AI-driven_Remote_Control)
