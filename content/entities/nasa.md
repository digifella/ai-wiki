...
- **Space Shuttle Program**: Retired in 2011 but paved the way for new spacecraft development.
- **International Space Station (ISS)**: A joint project between NASA and international partners.

## Recent Updates
### Artemis II Simulated Mission Report
- [[concepts/crew-operations|Crew Operations]]
- [[concepts/orion-systems|Orion Systems]] Overview
- [[entities/spacex|SpaceX]] [[concepts/starship|Starship Updates]]

### In-flight Challenges and Orion Systems
- The uncrewed **[[entities/artemis-ii|Artemis II mission]]** successfully completed its [[concepts/trans-lunar-injection|trans-lunar injection]] burn on Day 2, setting the stage for a [[concepts/human-lunar-flyby|human lunar flyby]] after over five decades.
