...
- **[[concepts/assisted-culling|Assisted Culling]] (Early Access)**
  - Streamlines the process of selecting photos by analyzing image content and suggesting high-quality [[concepts/images|images]].
  - Integrates seamlessly with Lightroom Classic's existing culling tools to provide a more efficient workflow.

- **Auto Stacking (Early Access)**
  - Automatically groups similar or related photos into stacks, making it easier to find specific images within large collections.
  - Enhances [[concepts/organization|organization]] and [[concepts/accessibility|accessibility]] of photo archives.

### Related Concepts
- [[concepts/ai-in-photography|AI in Photography]]
- [[concepts/lightroom|Lightroom]] Classic Overview
