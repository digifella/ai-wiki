...
[[concepts/bumblebees|Bumblebees]] are among the most extensively studied insects in neurobiology research. They exhibit individual learning, [[concepts/memory|memory]] formation, and the ability to learn from observing other bees—a capacity previously thought to be rare in insects. Bumblebees can solve novel problems, such as manipulating objects to access food rewards, and retain learned solutions over time. These cognitive abilities occur within a brain containing roughly one million neurons, highlighting how neural [[concepts/organization|organization]] rather than sheer neuron count determines behavioral complexity.
