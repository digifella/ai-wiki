...
A collection management system typically handles the documentation and description of collection items using standardized metadata schemas. This includes recording information about an item's origin, condition, location, and [[concepts/relationships|relationships]] to other materials. Systems also manage access controls, allowing institutions to restrict sensitive materials while making appropriate content publicly available. Many CMS platforms support [[concepts/asset-management|digital asset management]], enabling the [[entities/storage|storage]] and retrieval of digitized versions of physical objects.
