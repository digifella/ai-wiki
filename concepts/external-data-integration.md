...
- **[[concepts/model-context-protocol]] (MCP):** A "[[concepts/universal-plug|universal plug]]" protocol that allows [[concepts/ai-models|AI models]] (e.g., [[concepts/claude-code|Claude Code]]) to connect to external data and tools. It transforms [[concepts/ai-bots|chatbots]] into powerful agents by enabling direct access to external systems, bypassing the limitation of only accessing manually uploaded files.

## Context
- [[concepts/llm]]s require external interaction with tools and services to be functionally useful in real-[[entities/earth|world]] applications.
