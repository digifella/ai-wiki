...
- **AF-C ([[concepts/continuous-autofocus|Continuous Autofocus]])**: Designed for [[concepts/moving-subjects|moving subjects]]; causes unnecessary refocusing on stationary targets and should be avoided.
...
For [[entities/fujifilm|Fujifilm]]-specific optimization of these modes, see [[entities/fujifilm|Fujifilm]] Autofocus [[concepts/setup|Setup]] Guide: Modes, Features, and Optimization.
