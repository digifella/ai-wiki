...
Ollama previously operated as a CLI-first and API-driven platform, primarily serving users comfortable with [[concepts/terminal-based-workflows|command-line workflows]]. The introduction of a native UI addresses a broader user base and lowers the barrier to entry for those seeking graphical interaction with the platform's features.
