...
Systems that perform complex operations without human intervention, leveraging local processing for [[concepts/privacy|privacy]], [[concepts/software-reliability|reliability]], and [[concepts/247-operation|continuous operation]].

## Key Implementations

- [[entities/openclaw]]: [[concepts/local-ai-assistant|Local AI assistant]] (formerly ClawdBot/MoltBot) running on [[entities/raspberry-pi|Raspberry Pi]], operating 24/7 to autonomously execute [[concepts/complex-tasks|complex tasks]] like [[concepts/monitoring-and-alerting|system monitoring]] and automation—functioning as a personal "[[entities/jarvis|Jarvis]]" without cloud dependency.
- [[concepts/local-ai]]: Enables [[concepts/privacy|privacy]]-preserving [[concepts/workflow-automation|task execution]] on-device (e.g., Raspberry Pi deployments).
- [[concepts/automation]]: Core capability of [[concepts/voice-assistants|autonomous systems]], including scheduled and [[concepts/business-event-response|event-triggered workflows]].
- Raspberry Pi: Common hardware platform for resource-efficient [[concepts/agentic-performance|autonomous task execution]].
