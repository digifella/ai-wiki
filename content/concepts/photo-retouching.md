...
- **[[concepts/combining-photos|Combining photos]] in [[software/photoshop|Photoshop]]**:
	- **[[concepts/scenarios|Use cases]]**: Bringing elements from one image to another or fixing closed eyes in group photos.
	- **Core technique**: Loading [[concepts/images|images]] into a stack, auto-aligning them, and using [[concepts/layer-masks|layer masks]] to selectively reveal parts of different layers.
