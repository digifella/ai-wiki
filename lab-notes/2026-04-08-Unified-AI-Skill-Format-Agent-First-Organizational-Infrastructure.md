...
- Agent-Readable [[concepts/markdown|Markdown]] — [Wikipedia](https://en.wikipedia.org/wiki/Agent-Readable_Markdown)
- [Skill Trading](https://en.wikipedia.org/wiki/Skill_Trading) — [Wikipedia](https://en.wikipedia.org/wiki/Skill_Trading)
- [Deterministic vs. Probabilistic AI](https://en.wikipedia.org/wiki/Deterministic_vs._Probabilistic_AI) — [Wikipedia](https://en.wikipedia.org/wiki/Deterministic_vs._Probabilistic_AI)
- [Skill Contracts](https://en.wikipedia.org/wiki/Skill_Contracts) — [Wikipedia](https://en.wikipedia.org/wiki/Skill_Contracts)
- [[concepts/automated-skill-invocation|Skill Invocation]] — [Wikipedia](https://en.wikipedia.org/wiki/Skill_Invocation)
- [Agent-First Descriptions](https://en.wikipedia.org/wiki/Agent-First_Descriptions) — [Wikipedia](https://en.wikipedia.org/wiki/Agent-First_Descriptions)
- [[concepts/workflow-automation|Workflow Integration]] — [Wikipedia](https://en.wikipedia.org/wiki/Workflow_Integration)
- Skill [[concepts/testing|Testing]] and Versioning — [Wikipedia](https://en.wikipedia.org/wiki/Skill_Testing_and_Versioning)
- Skill-based [[concepts/prompt-based-modeling|Prompt Engineering]] — [Wikipedia](https://en.wikipedia.org/wiki/Skill-based_Prompt_Engineering)
