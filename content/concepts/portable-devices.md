...
Portable devices refer to a broad category of [[concepts/portable-computing|mobile computing]] gadgets and tools designed for ease-of-use and mobility. They include smartphones, tablets, laptops, and other handheld computers. The concept has evolved significantly with advancements in technology allowing more powerful and compact [[concepts/hardware|hardware]] configurations.
...
The landscape of [[concepts/running|running]] large [[concepts/ai-models|AI models]] on portable devices is rapidly changing. Innovations such as [[entities/lm-studio|LM Studio]]'s [[entities/lm-link|LM Link]] enable [[concepts/remote-access|remote access]] to [[concepts/large-language-models|large language models (LLMs)]] from more modest hardware configurations, thereby democratizing access to advanced [[concepts/ai-workflow|AI capabilities]].
