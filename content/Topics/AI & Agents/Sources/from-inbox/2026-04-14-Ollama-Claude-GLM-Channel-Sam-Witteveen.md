...
By default, Ollama uses a context length of **4096 tokens**. This is insufficient for coding [[concepts/agents|agents]] like Claude Code, which will cause the model to forget instructions or fail to use tools.
