...
The video introduces [[concepts/gemini-powered-extraction|LangExtract]], a new open-source project from Google that is a Gemini-powered [[concepts/document-processing|information extraction]] library. \[0:00\] Its primary purpose is to convert [[concepts/unstructured-text|unstructured text]] data into [[concepts/structured-data|structured data]]. \[0:06\]
...
* **[[concepts/llm-backend|LLM Backend]] Flexibility:** It supports both cloud-based Large Language Models (LLMs) like [[entities/gemini-ai|Google's Gemini]] family and open-source on-device models. \[1:06\]
...
* **Advanced Relationship Extraction (Clinical Note):** This is highlighted as a main power of LangExtract. It extracts medication information (name, dosage, route, frequency, duration) and their [[concepts/relationships|relationships]] to medical conditions. \[7:03\] It uses `extraction_passes=2` to tell the LLM to process the information multiple times for better relationship detection, which can improve [[concepts/accuracy|accuracy]]. \[9:07\] The output can be visualized as a [[concepts/knowledge-graphs|knowledge graph]] showing relationships between conditions (red [[concepts/nodes|nodes]]), medications (green nodes), and patients (blue node). \[10:13\] For example, it shows which medication "treats" which condition. \[10:18\]

**Disclaimer:** The video explicitly states that LangExtract is _not an officially supported Google product_. It is an open-source project from some Googlers. \[11:30\] Usage is subject to the [[concepts/apache-2.0-license|Apache 2.0 License]], and for health-related applications, it is also subject to the [[concepts/health|Health]] AI Developer Foundations Terms of Use. \[11:31\]

## Related Concepts
- [[concepts/unstructured-text-processing|Structured Data Extraction]] — [Wikipedia](https://en.wikipedia.org/wiki/Structured_Data_Extraction)
- [[concepts/custom-schemas|Custom Schemas]] — [Wikipedia](https://en.wikipedia.org/wiki/Custom_Schemas)
