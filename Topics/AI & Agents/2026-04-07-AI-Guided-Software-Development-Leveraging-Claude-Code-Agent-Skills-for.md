...
**Clip title:** 5 [[concepts/ai-assisted-coding|Claude Code]] skills I use every single day
...
process in leveraging AI, particularly large language models (LLMs) like
...
him to develop a suite of "[[concepts/agent-harnesses|Agent Skills]]" – codified processes that guide
...
The speaker concludes by emphasizing that these skills effectively treat [[concepts/ai-connectors|AI agents]] like human engineers, complete with their unique constraints, and
...
- [[concepts/claude-code-agent-skills|Claude Code agent skills]] — [Wikipedia](https://en.wikipedia.org/wiki/Claude_Code_agent_skills)
...
- [[concepts/agent-skills|Agent skills codification]] — [Wikipedia](https://en.wikipedia.org/wiki/Agent_skills_codification)
