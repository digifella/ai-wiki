...
- **Impact**: [[concepts/causes|Causes]] loss of life, damage to infrastructure, economic impacts, and environmental degradation.
- **Frequency & Intensity**: Increasing due to [[concepts/climate-change|climate change]], leading to more frequent and severe events globally.

### Related Concepts
- [[concepts/climate-change]]
- [[concepts/vulnerable-populations|vulnerable populations]]
- [[concepts/unhealthy-air-quality|unhealthy-air-quality]]

### New Information
- The video "How Climate Affects [[concepts/population-health|Community Health]]" by the [[entities/cdc|Centers for Disease Control and Prevention]] (CDC) discusses the increasing [[concepts/health|health]] risks posed by climate change to U.S. communities, including:
  - More frequent and severe extreme weather events.
  - [[concepts/unhealthy-air-quality|Unhealthy air quality]] exacerbating respiratory issues.
