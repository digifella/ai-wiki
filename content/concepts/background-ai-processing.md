...
The execution of computationally intensive [[entities/ai|artificial intelligence]] tasks in a secondary thread or decoupled process, allowing the primary [[concepts/user-interface|user interface]] to remain responsive and preventing interruption of the active user [[concepts/workflow|workflow]].
