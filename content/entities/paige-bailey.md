...
- **[[concepts/gemini|Gemini]] Pro Slide Deck [[concepts/workflow|Workflow]]**: Select "[[entities/canvas|Canvas]]" → type "Please create a slide deck about [topic]" → export to [[entities/google-slides|Slides]]. [Source: [[concepts/date-2026-04-13|2026]] 04 14 Getting [[entities/gemini-app|Gemini Pro]] to create slide deck]
