...
---
## [[entities/anthropic-claude|Anthropic Claude]] [[entities/opus|Opus]] 4.7: Agentic [[concepts/coding|Coding]], Multimodal, and [[concepts/memory|Memory]] Advancements
...
- Claude Opus 4.7 — [Wikipedia](https://en.wikipedia.org/wiki/Claude_Opus_4.7)