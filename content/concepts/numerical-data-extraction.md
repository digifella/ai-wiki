...
Numerical [[concepts/data-extraction|data extraction]] refers to the automated process of identifying and retrieving numeric values from unstructured or semi-structured documents. This task is fundamental in [[concepts/security|security]] infrastructure and data processing workflows, where organizations need to systematically convert document contents into machine-readable numeric formats for analysis, [[concepts/compliance|compliance]], and [[concepts/integration|integration]] with downstream systems.

## LiteParse Implementation

[[concepts/chart-extraction|LiteParse]] is [[entities/llamaindex|LlamaIndex]]'s agentic [[concepts/document-processing|document processing]] [[concepts/solution|solution]] built to extract [[concepts/json-structuring|structured data]] using language [[concepts/models|models]]. The system is designed to handle [[concepts/document-parsing|document parsing]] [[concepts/assistive-technology|at]] a local level, reducing dependency on external APIs while maintaining extraction [[concepts/accuracy|accuracy]]. LiteParse operates as an [[entities/agent|agent]] capable of processing various document formats and identifying numerical content within them, making it applicable to [[concepts/scenarios|scenarios]] ranging from financial records to technical specifications.
