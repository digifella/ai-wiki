...
Dylan Davis channel
At the end of making the output you can then ask [[entities/claude-4|Claude]] to export as a PDF.
<https://www.youtube.com/watch?v=TZ3yYXAz_i8>
[Console.anthropic.com](https://Console.anthropic.com)
Can be used to create high quality prompt such as the system prompt the author used
...
# 🚀 The 5-Step Method to AI Slides ([[concepts/date-2026-04-13|2026]] Guide)

Traditional slide tools like PowerPoint are often constrained by [[concepts/templates|templates]]. This method uses **[[entities/claude-ai|Claude AI]]** and **[[concepts/code|Code]] (HTML/CSS)** to create highly customized, professional, and unique presentations.

## 📋 The 5 Steps at a Glance

1. **Write Script**: Create the foundation of your content.
2. **Claude Project**: Set up a persistent environment for [[concepts/logical-consistency|consistency]].
3. **[[entities/opus|Opus]] 4.5 + Extended Thinking**: Use the high-end model for maximum quality.
4. **Quick Edits**: Refine the [[concepts/design|design]] within the [[entities/claude-chat|Claude chat interface]].
5. **Code Editor**: Use **[[entities/cursor|Cursor]]** or **[[concepts/claude-code|Claude Code]]** for the final polish.
...
* **[[concepts/persistence|Persistence]]**: Once set up, you can simply drop in new scripts in the future, and Claude [[entities/will|will]] generate consistent slides every time.
...
* **Model**: Select **[[concepts/claude-opus-45|Claude Opus 4.5]]**.
* **Mode**: Ensure **Extended Thinking** is turned on.
* **Why**: This model handles [[concepts/ambiguity|ambiguity]] and multi-step design tasks significantly better than Sonnet or other standard models.
...
> **Role**: You are a professional presentation designer and front-end [[entities/developer|developer]]. **Task**: Create a single, self-contained HTML file containing a full slide presentation based on provided [[concepts/notes|notes]]. **Design [[concepts/philosophy|Philosophy]]**:
> 
...
> * Modern, Apple-[[concepts/style|style]] minimalist aesthetic.
...
1. **[[entities/github|GitHub]]**: Create a public repository and upload your `index.html` and any images.
...
## Related Concepts
- [[concepts/ai-powered-presentations|AI-powered presentations]] — [Wikipedia](https://en.wikipedia.org/wiki/AI-powered_presentations)
- [[concepts/claude-ai|Claude AI]] — [Wikipedia](https://en.wikipedia.org/wiki/Claude_AI)
- [[concepts/htmlcss|HTML/CSS]] — [Wikipedia](https://en.wikipedia.org/wiki/HTML/CSS)
- [[concepts/high-quality-prompts|high-quality prompts]] — [Wikipedia](https://en.wikipedia.org/wiki/high-quality_prompts)

## Related Entities
- [[entities/dylan-davis|Dylan Davis]] — [Wikipedia](https://en.wikipedia.org/wiki/Dylan_Davis)
- [[entities/consoleanthropiccom|Console.anthropic.com]] — [Wikipedia](https://en.wikipedia.org/wiki/Console.anthropic.com)