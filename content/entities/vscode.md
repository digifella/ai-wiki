...
The extension marketplace is central to VS Code's functionality, allowing developers to customize and extend the editor with [[concepts/multilingual-support|language support]], themes, debuggers, and tools. Thousands of community-maintained and official extensions are available, enabling users to tailor the editor for specific [[concepts/development-workflows|development workflows]] or languages.
