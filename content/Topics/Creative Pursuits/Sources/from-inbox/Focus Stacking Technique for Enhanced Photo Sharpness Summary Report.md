...
Here is a detailed [[concepts/summary|summary]] of the video "[[concepts/focus-stacking|Focus Stacking]] in Landscape Photography" by [[entities/mark-denney|Mark Denney]]:

**Overview**
In this video, landscape photographer Mark Denney explains how to solve the common problem of capturing a landscape photo that looks sharp on the camera screen but reveals soft, blurry areas (like the foreground) when zoomed in. The [[concepts/solution|solution]] is "focus stacking," a technique that has become significantly easier and faster with modern post-processing tools. The [[concepts/tutorial|tutorial]] breaks down the entire process from shooting on location to blending the final image in [[concepts/photoshop|Photoshop]].
...
**Phase 1: Shooting on Location**
To get the right source [[concepts/files|files]] in the field, Mark recommends the following steps:
*   **Gear & Settings:** While it can be done handheld, using a tripod yields the best results. Keep your [[concepts/camera-settings|camera settings]] consistent across all shots. ISO and shutter [[concepts/speed|speed]] don't matter as much, but for landscapes, an aperture between **f/11 and f/16** is the sweet spot. Once set, do not change your settings between shots.
...
**Phase 2: Post-Processing [[concepts/workflow|Workflow]]**
Mark emphasizes doing your "heavy lifting" on the RAW files in [[concepts/lightroom|Lightroom]] before moving to Photoshop for the blend.
...
Mark points out that the most common mistake people make is **not taking enough photos in the field**, resulting in "gaps." If you jump your focus point too far between the foreground and background, you might end up with a blended image that is sharp in the front and back, but unfixably soft in the middle. To prevent this, always take "insurance shots" by capturing extra images with focus points slightly closer together than you think you need.