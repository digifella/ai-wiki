...
Starch absorption refers to the processes by which starch molecules take up and retain moisture during cooking. In potatoes, starch granules swell and absorb water when heated, which affects both [[concepts/texture|texture]] and the potential for achieving crispness. Understanding starch behavior is fundamental to producing crispy potatoes through various [[concepts/cooking-methods|cooking methods]].
