---
title: "Midjourney Medical: AI Ultrasound Scanners for Longitudinal Health Monitoring"
date: 2026-06-21
...
modes: Summary
---
# Midjourney Medical: AI Ultrasound Scanners for Longitudinal Health Monitoring
Generated: 2026-06-21 · API: Gemini 2.5 Flash · Modes: Summary

---

## Midjourney Medical: AI Ultrasound Scanners for Longitudinal Health Monitoring
**Clip title:** Midjourney's New Scanner Could Change Everything
**Author / channel:** Dr. Know-it-all Knows it all
**URL:** https://www.youtube.com/watch?v=vOZMpik6MUY

### Summary
The video discusses Midjourney's surprising announcement of "Midjourney Medical," a new division planning to develop a global network of full-body ultrasound scanners. Expected to launch its first location in San Francisco by 2027, the goal is to provide 60-second full-body scans using ultrasound technology, with the ambition of scaling to tens of thousands, potentially millions, of devices worldwide. The presenter initially expresses surprise at this move, given Midjourney's primary focus on AI image generation, but then reveals a deeper connection to the company's core mission.

Midjourney's underlying expertise, and that of its founder David Holz (who also created Leap Motion), lies in "reconstructing reality from incomplete information." Just as Midjourney generates believable images from noise and Leap Motion reconstructs hand positions from sensor data, Midjourney Medical aims to reconstruct the internal landscape of the human body from ultrasound signals. This "AI-first imaging" approach leverages cheaper, more accessible ultrasound hardware, combined with massive data and advanced AI compute, to potentially achieve and even surpass the precision of expensive MRI machines. The vision is to make medical imaging routine, shifting healthcare from a reactive model (scans only after symptoms appear) to a proactive, longitudinal one where individuals continuously monitor their health over years or decades.

The potential implications of such a system are enormous, promising early detection of diseases like cancer long before symptoms manifest, thereby significantly improving patient outcomes and fundamentally changing humanity's understanding of its own health. The proposed scanner offers a "spa-like" experience, submerging individuals in body-temperature water for a minute-long, non-claustrophobic scan up to the neck, a stark contrast to the often anxiety-inducing MRI experience.

However, the ambitious project faces significant challenges. Firstly, there are physics and engineering hurdles, as ultrasound inherently has limitations compared to MRI (e.g., air and bone block sound, lower resolution). Midjourney's success hinges on whether AI can sufficiently compensate for these physical constraints. Secondly, a major concern is the "false positive trap," where a high volume of scans on healthy individuals might generate numerous harmless anomalies, leading to unnecessary follow-up procedures, anxiety, and a "boy who cried wolf" scenario that could undermine trust and overwhelm the healthcare system. Lastly, the regulatory hurdle is substantial; Midjourney Medical plans to initially launch as a wellness/body composition tracking device, not a diagnostic one, to bypass immediate stringent FDA approval. Achieving diagnostic clearance would require years of rigorous clinical trials, validation of accuracy, and proof of improved patient outcomes, all while navigating the immense medical liability risks associated with false negatives.

Despite these hurdles, the presenter remains cautiously optimistic about the project's long-term potential. While he estimates a high likelihood (80%+) for the first scanner's appearance and moderate success (60-70%) for the wellness product, the odds of achieving MRI-comparable imaging (30%) or becoming an FDA-cleared diagnostic platform (20-25%) are lower within the next 5-10 years. The ultimate "civilization-changing" impact is given a 10-15% chance, but due to the outsized benefits if successful, even this low probability makes the endeavor incredibly worthwhile and admirable.

### Video Description & Links
#### Description
Get 5% off your Jowua order: https://www.jowua-life.com/special_deals_by_drknow

*Get your FREE 90 Days to AI PDF,* and book me at https://dr-john-gibbs-consulting.vercel.app. Want help navigating AI, robotics, and the future of tech? I offer keynotes, hands-on workshops, strategy sprints, and advisory services. 

*You can purchase My Intelli-Cut AI-based video editing software here: https://dreamweaver6171.gumroad.com/l/mcnzgp

Source industrial arms, AMRs, and cobots. Find the right integration partners for your factory floor.
...
Access the world's largest network of industrial 3D printing service bureaus and hardware vendors.
...
--Apple M4 MacBook Pro: https://amzn.to/4mo3WIP
...
or Youtube — https://www.youtube.com/channel/UCM4r7zhQrvc0o8MrNe8fxmg
...
https://x.com/mark_k/status/2067569844661215631
https://x.com/Scobleizer/status/2067489364725412345
