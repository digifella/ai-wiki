...
aliases:
  - "Build Process"
  - "Code Compilation"
summary: "The process of compiling source code into a runnable application, including dependency resolution, configuration, and artifact generation."
updated: 2026-04-16
group: applied-ai-workflows
---
# Application Build

The process of compiling source code into a runnable application, including dependency resolution, configuration, and artifact generation.

## Benchmark Example

- [[concepts/one-shot-build]] benchmark [[concepts/testing|testing]] [[concepts/large-language-models]] for [[concepts/app-creation|application development]] using a massive [[concepts/product-requirements-document|Product Requirements Document]] ([[concepts/prd|PRD]]) for "[[entities/showbiz|Showbiz]]" (movie/TV companion app).
- PRD required processing [[concepts/technical-specs|technical specs]], [[concepts/design|design]] [[concepts/tokens|tokens]], and personality guidelines from a large documentation folder.
- Compared [[entities/claude-opus|Claude Opus]] 4.5 ([[entities/anthropic|Anthropic]]) vs [[concepts/gpt-5|GPT-5]].2 ([[entities/openai|OpenAI]]) in generating complete application build from PRD.
