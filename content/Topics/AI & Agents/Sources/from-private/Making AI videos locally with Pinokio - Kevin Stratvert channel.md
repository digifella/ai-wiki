...
Here is a [[concepts/summary|summary]] of the guide on generating AI videos locally on your PC, based on the video transcript.

# How to Generate Free AI Videos Locally on PC

This guide covers how to run [[concepts/open-source-ai-video-models|open-source AI video models]] (like LTX-2 and Wan) directly on your computer using a tool called Pinokio. This method ensures [[concepts/privacy|privacy]], requires no subscription, and has no [[concepts/usage-limits|usage limits]].

## 1\. System Requirements

Running [[concepts/ai-video-automation|AI video generation]] locally is resource-intensive.
...
* **How to check VRAM ([[entities/windows|Windows]]):**
	...
	3. Click **GPU**.
	4. Look for "Dedicated [[concepts/vram|GPU memory]]."

## 2\. Install Pinokio

Pinokio is a "one-click installer" for [[concepts/ai-tools|AI tools]] that manages complex dependencies ([[entities/python|Python]], [[concepts/cuda|CUDA]], etc.) automatically.
...
3. **Settings:**
	* **[[concepts/solution|Resolution]]:** Start with **720p** for faster results.
...
* **Cost:** 100% Free.
* **[[concepts/privacy|Privacy]]:** Everything stays on your local machine.
* **Control:** No restrictions on content or usage frequency.
* **Capabilities:** Generates video, sound, and speech.

## Related Concepts
- [[concepts/vram-management|AI Video Generation]] — [Wikipedia](https://en.wikipedia.org/wiki/AI_Video_Generation)
...
- [[concepts/pinokio-tool|Pinokio Tool]] — [Wikipedia](https://en.wikipedia.org/wiki/Pinokio_Tool)
- [[entities/ltx-2|LTX-2]] — [Wikipedia](https://en.wikipedia.org/wiki/LTX-2)
- [[entities/wan|Wan]] — [Wikipedia](https://en.wikipedia.org/wiki/Wan)
- [[concepts/nvidia-rtx-gpus|NVIDIA]] — [Wikipedia](https://en.wikipedia.org/wiki/NVIDIA)

## Related Entities
- [[entities/ltx-2|LTX-2]] — [Wikipedia](https://en.wikipedia.org/wiki/LTX-2)
- [[entities/wan|Wan]] — [Wikipedia](https://en.wikipedia.org/wiki/Wan)
- [[entities/nvidia|NVIDIA]] — [Wikipedia](https://en.wikipedia.org/wiki/NVIDIA)
- [[entities/pinokio|Pinokio]] — [Wikipedia](https://en.wikipedia.org/wiki/Pinokio)