...
The video provides an overview of challenges and strategies for secure identity propagation within agentic systems, particularly relevant with the increasing [[concepts/adoption|adoption]] of Generative AI (GenAI) and Retrieval Augmented Generation (RAG) [[concepts/models|models]].
