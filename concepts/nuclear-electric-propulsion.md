...
**Nuclear Electric Propulsion (NEP)** utilizes a nuclear-reactor to generate electricity powering electric-propulsion (e.g., ion-propulsion, Hall-effect-thrusters). Characterized by high specific-[[concepts/impulse|impulse]] ($I_{sp}$) and low thrust-to-weight ratio, NEP optimizes fuel efficiency for long-duration [[concepts/deep-space-exploration|deep-space]] missions.
...
## Mission Profiles
- Rapid transit to [[concepts/mars|Mars]] and outer planets.
...
- Power processing unit (PPU) [[concepts/software-reliability|reliability]] at high voltages.
