---
wiki-ingested: true
title: "Using generative upscale in Photoshop - Cafe channel"
...
---
# Using [[concepts/generative-upscale|generative upscale]] in [[concepts/photoshop|Photoshop]] - Cafe channel

---
---
<https://www.youtube.com/watch?v=UorIb_rGZuc>
This video by [[entities/colin-smith|Colin Smith]] from [[entities/photoshopcafe|PhotoshopCAFE]] compares three upscaling tools available in Photoshop (specifically [[entities/photoshop-beta|Photoshop Beta]] at the time of recording) that utilize AI: Generative Upscale, [[concepts/preserve-details-20|Preserve Details 2.0]] (found in [[concepts/image-size|Image Size]]), and [[concepts/super-zoom|Super Zoom]] (a [[entities/neural-filter|Neural Filter]]).
**Video Overview:**
The [[concepts/tutorial|tutorial]] aims to demonstrate the effectiveness of these [[concepts/ai-powered-tools|AI-powered tools]] in enlarging images and increasing resolution, comparing their performance on both a photograph and a graphic [[concepts/design|design]].
...
* **Functionality:** Allows [[concepts/scaling|scaling]] the image by 2x, 3x, or 4x. **Note:** In the [[concepts/beta-version|Beta version]], the maximum output resolution is 4096px, and generative credits are not deducted.
...
* **Demo 2 (Graphic Design - Book Cover):** Original size: 572px x 1000px. Upscaled to 4x (2288px x 4032px). **Observation:** For [[concepts/typography|typography]] and sharp lines, Generative Upscale often generates smoother, less crisp edges, sometimes losing the original [[concepts/sharpness|sharpness]] of text and fine graphic elements. It might also subtly alter facial features in the embedded photo.
...
* **Demo 1 (Photograph - Violinist):** Upscaled to 4x using default settings. **Observation (compared to Generative Upscale & Preserve Details 2.0):** Super Zoom tended to smooth out [[concepts/faces|faces]] more than Preserve Details 2.0. While it offers good upscaling, it didn't consistently outperform the other two for natural photographic detail.
