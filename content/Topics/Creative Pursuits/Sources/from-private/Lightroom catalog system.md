...
Here is a detailed [[concepts/markdown|Markdown]] [[concepts/summary|summary]] of the [[concepts/lightroom-catalog|Lightroom Catalog]] lesson from Will’s _Master of Editing_ course.

# Mastering Lightroom Catalogs

**Instructor:** Will **Context:** A lesson from the _Lightroom [[concepts/master-of-editing|Master of Editing]] Course_ **Goal:** To explain exactly what a Lightroom catalog is, how it functions, and the [[concepts/best-practices|best practices]] for managing your [[concepts/photography-workflow|photo workflow]].
...
## Related Concepts
- [[concepts/catalog|Catalog]] — [Wikipedia](https://en.wikipedia.org/wiki/Catalog)
- [[concepts/edit-history|edit history]] — [Wikipedia](https://en.wikipedia.org/wiki/edit_history)
- [[concepts/adjustments|adjustments]] — [Wikipedia](https://en.wikipedia.org/wiki/adjustments)
- [[concepts/star-ratings|star ratings]] — [Wikipedia](https://en.wikipedia.org/wiki/star_ratings)
- [[concepts/flags|flags]] — [Wikipedia](https://en.wikipedia.org/wiki/flags)
- [[concepts/color-labels|color labels]] — [Wikipedia](https://en.wikipedia.org/wiki/color_labels)
- [[concepts/keywords|keywords]] — [Wikipedia](https://en.wikipedia.org/wiki/keywords)
- [[concepts/notes|notes]] — [Wikipedia](https://en.wikipedia.org/wiki/notes)

## Related Entities
- [[entities/will|Will]] — [Wikipedia](https://en.wikipedia.org/wiki/Will)
- Lightroom Master of Editing Course — [Wikipedia](https://en.wikipedia.org/wiki/Lightroom_Master_of_Editing_Course)