...
transformed into [[concepts/organizational-infrastructure|organizational infrastructure]]. This shift is driven by
[[concepts/agents|agents]] now making hundreds of [[concepts/skill-calls|skill calls]] per run, compared to humans
...
quality criteria, and principles to enable [[concepts/agents|agents]] to generalize effectively
...
## Related Concepts
- [[concepts/unified-ai-skill-format|Unified AI Skill Format]] — [Wikipedia](https://en.wikipedia.org/wiki/Unified_AI_Skill_Format)
- [[concepts/agent-first-organizational-infrastructure|Agent-First Organizational Infrastructure]] — [Wikipedia](https://en.wikipedia.org/wiki/Agent-First_Organizational_Infrastructure)
...
- [[concepts/llm-skill-ecosystem|AI Skill Format]] — [Wikipedia](https://en.wikipedia.org/wiki/AI_Skill_Format)
- [Skill-calling Frequency](https://en.wikipedia.org/wiki/Skill-calling_Frequency) — [Wikipedia](https://en.wikipedia.org/wiki/Skill-calling_Frequency)
- [Version-Controlled Skills](https://en.wikipedia.org/wiki/Version-Controlled_Skills) — [Wikipedia](https://en.wikipedia.org/wiki/Version-Controlled_Skills)
- [Skill Trading](https://en.wikipedia.org/wiki/Skill_Trading) — [Wikipedia](https://en.wikipedia.org/wiki/Skill_Trading)
- Markdown-encoded [[concepts/instructions|Instructions]] — [Wikipedia](https://en.wikipedia.org/wiki/Markdown-encoded_Instructions)
- [Skill Description Optimization](https://en.wikipedia.org/wiki/Skill_Description_Optimization) — [Wikipedia](https://en.wikipedia.org/wiki/Skill_Description_Optimization)
- [Agent-First Routing Signals](https://en.wikipedia.org/wiki/Agent-First_Routing_Signals) — [Wikipedia](https://en.wikipedia.org/wiki/Agent-First_Routing_Signals)
- [Skill Handoff Chains](https://en.wikipedia.org/wiki/Skill_Handoff_Chains) — [Wikipedia](https://en.wikipedia.org/wiki/Skill_Handoff_Chains)
- [Skill Composability](https://en.wikipedia.org/wiki/Skill_Composability) — [Wikipedia](https://en.wikipedia.org/wiki/Skill_Composability)
- [Skill Contracts](https://en.wikipedia.org/wiki/Skill_Contracts) — [Wikipedia](https://en.wikipedia.org/wiki/Skill_Contracts)
- Quantitative Skill [[concepts/testing|Testing]] — [Wikipedia](https://en.wikipedia.org/wiki/Quantitative_Skill_Testing)
- [Agent-Readable Documentation](https://en.wikipedia.org/wiki/Agent-Readable_Documentation) — [Wikipedia](https://en.wikipedia.org/wiki/Agent-Readable_Documentation)
- Skill-based [[concepts/workflow|Workflow]] [[concepts/integration|Integration]] — [Wikipedia](https://en.wikipedia.org/wiki/Skill-based_Workflow_Integration)
- Reasoning-based Methodology — [Wikipedia](https://en.wikipedia.org/wiki/Reasoning-based_Methodology)
- [Edge Case Specification](https://en.wikipedia.org/wiki/Edge_Case_Specification) — [Wikipedia](https://en.wikipedia.org/wiki/Edge_Case_Specification)
