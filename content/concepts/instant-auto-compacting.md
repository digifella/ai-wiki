...
Instant Auto Compacting is a feature update introduced in [[entities/anthropic-institute|Anthropic]]'s [[concepts/ai-assisted-coding|Claude Code]] [[concepts/cli-tool|CLI tool]]. The feature relates to how the tool manages context and token usage during extended [[concepts/coding|coding]] sessions, automatically compacting information to maintain efficiency without requiring manual intervention.
