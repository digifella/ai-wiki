...
The structural [[concepts/design|design]] and orchestration of modular [[concepts/capabilities|capabilities]] within an AI [[entities/agent|Agent]] or [[concepts/ai-personal-assistant-framework]]. It defines the logic by which an LLM accesses tools, manages state, and executes Automated Pipelines.
