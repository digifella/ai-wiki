...
Multi-step tasks [[concepts/automation|automation]] refers to the use of [[concepts/agentic-ai|AI agents]] to execute [[concepts/complex-workflows|complex workflows]] that require sequential actions across multiple systems or platforms. [[concepts/general-purpose-ai-agent|ChatGPT Agent]] is a feature within [[entities/chatgpt|ChatGPT]] designed to handle this type of automation by breaking down larger objectives into smaller, manageable steps and executing them in sequence without continuous human intervention.
