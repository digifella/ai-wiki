...
The technique involves crafting detailed [[concepts/system-prompts|system prompts]] or custom instructions that specify the relevant jurisdiction, applicable laws, procedural rules, and local legal conventions. These [[concepts/instructions|instructions]] guide the [[entities/ai-assistant|AI assistant]] to prioritize jurisdiction-appropriate sources, [[concepts/terminology|terminology]], and legal [[concepts/reasoning|reasoning]]. Effective jurisdiction-specific [[concepts/prompting|prompting]] typically includes information about controlling authorities, key statutes and regulations, procedural requirements, and any local practice conventions that affect legal work in that jurisdiction.
