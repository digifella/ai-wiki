...
Scanning film at home is a valuable [[concepts/skill|skill]] that can save money on lab costs and give you greater control over your images. While there are two main methods—using a flatbed scanner (easier/cheaper) or using a digital camera (higher quality)—this guide focuses on the **[[concepts/camera-scanning|Camera Scanning]]** method.
...
3. **Adjustments:** Tweak exposure, [[concepts/contrast|contrast]], highlights, and shadows as you normally would.
