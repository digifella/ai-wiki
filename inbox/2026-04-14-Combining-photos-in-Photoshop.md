---
wiki-ingested: true
title: "Combining photos in Photoshop"
...
# [[concepts/combining-photos|Combining photos]] in [[concepts/photoshop|Photoshop]]
...
This Photoshop [[concepts/tutorial|tutorial]] by [[entities/colin-smith|Colin Smith]] of [[entities/photoshopcafe|PhotoshopCAFE]] demonstrates how to combine the best elements from multiple similar photos, even if they weren't shot with a tripod. The core technique involves loading images into a stack, auto-aligning them, and then using [[concepts/layer-masks|layer masks]] to selectively reveal parts of different layers.
Here's a detailed [[concepts/summary|summary]] of the steps and key takeaways:
