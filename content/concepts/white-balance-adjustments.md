...
**White Balance (WB)** is the process of removing unnatural [[concepts/color-casts|color casts]] from [[concepts/images|images]], ensuring that white objects appear truly white under different lighting conditions. It involves adjusting the relative intensity of red, green, and blue channels to match the color temperature (measured in **Kelvin**) and tint of the [[concepts/light|light]] source.
...
- **Enhanced [[concepts/layer-masks|Masking]] [[concepts/integration|Integration]]**: Tighter coupling between subject/sky masks and white balance adjustments for targeted correction.
