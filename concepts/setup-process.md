...
aliases:
  - "Data Formulator Installation"
summary: The setup process for Data Formulator involves installing the package via pip and utilizes large language models for data visualization.
updated: 2026-07-12
...
- [[entities/data-formulator|Data Formulator]] ([[entities/microsoft|Microsoft]]):
	- **[[concepts/installation|Installation]]**: Use [[concepts/python|Python]]'s PIP via `pip install data_formulator`.
	- **Backend**: Leverages [[concepts/large-language-model|large language model]] (LLM) to [[concepts/ambition|drive]] [[concepts/information-visualization|data visualization]].
