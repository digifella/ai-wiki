...
A technique for searching within text bodies, enabling efficient [[concepts/document-retrieval|retrieval]] of documents containing specific words or phrases. Commonly implemented in databases and [[concepts/knowledge-bases|information retrieval]] systems.
...
- Video discussion: [[concepts/database-search|Database search]] setup - Channel [[entities/tech-with-tim|Tech with Tim]] (2026-04-14) covers implementation and implications for database search evolution.
