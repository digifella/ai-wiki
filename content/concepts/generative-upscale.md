...
[[concepts/ai-powered-upscaling|Generative Upscale]] is an AI-powered [[concepts/image-resolution|image upscaling]] feature available in [[entities/adobe-photoshop-beta|Adobe Photoshop Beta]]. It uses generative [[concepts/ai-technologies|artificial intelligence]] to enlarge [[concepts/images|images]] while attempting to preserve or intelligently reconstruct image details. The tool is designed as an alternative to traditional upscaling methods, offering users another approach to increasing image resolution.
