...
Logical container in [[entities/azure|Azure]] for grouping related resources, enabling unified management, access [[concepts/power|control]], and billing.

**Key characteristics**:
- Shared lifecycle and deletion behavior
- RBAC [[concepts/assistive-technology|at]] group level
