...
aliases:
  ...
  - "Azure Dashboard"
  - "Azure Web Interface"
summary: The Azure Portal is Microsoft's web-based unified management interface for provisioning, configuring, and monitoring cloud resources and services.
updated: 2026-07-11
...
- Integration with Azure CLI/PowerShell
...
- [[entities/azure|Azure]] [[concepts/foundry|Foundry]] (referenced in [[concepts/agentic-rag|agentic RAG]] system setup)
