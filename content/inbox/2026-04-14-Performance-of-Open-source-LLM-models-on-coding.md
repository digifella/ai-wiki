...
---
# Performance of [[concepts/open-source|Open source]] [[concepts/llm-models|LLM models]] on coding

---
---
<https://www.youtube.com/watch?v=xRnK2IFI31E>

The video presents a comparison of several leading [[concepts/ai-models|AI models]], including Qwen3, Kimi K2, [[entities/claude-opus-4|Claude Opus 4]], and Deepseek-V3-0324, showcasing their performance across various benchmarks and practical tasks. The speaker aims to highlight the strengths and weaknesses of each model, particularly focusing on the recently updated Qwen3.
**Qwen3 and its [[concepts/hybrid-reasoning-model|Hybrid Reasoning Model]]:** Qwen3, developed by Alibaba, initially introduced a "hybrid [[concepts/thinking-mode|thinking mode]]" that allowed the model to reason step-by-step for complex problems (Thinking Mode) or provide quick [[concepts/responses|responses]] for simpler queries ([[concepts/non-thinking-mode|Non-Thinking Mode]]). However, Qwen has since shifted its strategy, releasing separate Instruct and [[concepts/thinking-models|Thinking models]] to maximize quality. The Qwen3-235B-A22B-Instruct-2507 is an updated "non-thinking" variant, optimized for [[concepts/instruction-following|instruction following]], logical reasoning, [[concepts/mathematics|mathematics]], science, coding, and tool usage, and features a 256K [[concepts/context-window|context window]].
...
* **ARC-AGI (Reasoning):** The video specifically mentions Qwen3 Instruct-2507 achieving 41.8, which the speaker notes is impressive for a [[concepts/non-reasoning-model|non-reasoning model]] and higher than Claude 4's 30.3 when thinking is disabled.
