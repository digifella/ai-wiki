...
<https://www.youtube.com/watch?v=K0K-pMPFzGY>
...
## 1\. The [[concepts/historical-context|Historical Context]]: The Fore Tribe & Kuru
...
Prions (_Proteinaceous Infectious Particles_) were identified by **Stanley Prusiner**, challenging the central dogma of biology.

* **Mechanism:** A healthy protein ($PrP^C$) misfolds into an infectious shape ($PrP^{Sc}$).
...
For decades, the dominant [[concepts/theory|theory]] for the origin of life was the **RNA World Hypothesis** (RNA came before DNA and proteins).
...
* **[[concepts/memory|Memory]] Formation:** In mammals, a protein called **CPEB** acts like a prion in neurons to stabilize synapses, facilitating long-term memory.
...
* **Chemical Evidence:** Simple reactions using [[concepts/hydrogen-atom|Hydrogen]] Cyanide, Hydrogen Sulfide, and UV light can produce precursors for _both_ RNA and proteins simultaneously.
...
## Related Concepts
- [[concepts/prion|Prion]] — [Wikipedia](https://en.wikipedia.org/wiki/Prion)
- [[concepts/protein-world-hypothesis|Protein World Hypothesis]] — [Wikipedia](https://en.wikipedia.org/wiki/Protein_World_Hypothesis)
- [[concepts/rogue-protein|Rogue Protein]] — [Wikipedia](https://en.wikipedia.org/wiki/Rogue_Protein)
- RNA World Hypothesis — [Wikipedia](https://en.wikipedia.org/wiki/RNA_World_Hypothesis)
- Amyloid Fibrils — [Wikipedia](https://en.wikipedia.org/wiki/Amyloid_Fibrils)
- Mad Cow Disease — [Wikipedia](https://en.wikipedia.org/wiki/Mad_Cow_Disease)
- Peptide-RNA World — [Wikipedia](https://en.wikipedia.org/wiki/Peptide-RNA_World)

## Related Entities
- [[entities/fore-tribe|Fore tribe]] — [Wikipedia](https://en.wikipedia.org/wiki/Fore_tribe)
- [[entities/papua-new-guinea|Papua New Guinea]] — [Wikipedia](https://en.wikipedia.org/wiki/Papua_New_Guinea)
- [[entities/kuru|Kuru]] — [Wikipedia](https://en.wikipedia.org/wiki/Kuru)
- Stanley Prusiner — [Wikipedia](https://en.wikipedia.org/wiki/Stanley_Prusiner)
