---
wiki-ingested: true
title: "Bonzai 8B PrismMLs Revolutionary 1-Bit LLM First Look  Test"
...
### Summary
This video introduces [[entities/bonzai-8b|Bonzai 8B]], a revolutionary 1-bit [[concepts/large-language-model|large language model]]
(LLM) developed by [[entities/prismml|PrismML]], touted as the first commercially viable 1-bit
...
"[[concepts/intelligence-density|Intelligence Density]]," allowing powerful [[concepts/ai-models|AI models]] to run on devices with
...
substantial [[concepts/compression|compression]], benchmark comparisons presented by PrismML show
...
[[concepts/compression|compression]], particularly how it handles sign [[concepts/classical-bits|bits]] and FP16 [[concepts/scaling|scaling]],
...
- [[concepts/web-development|Web development (HTML/CSS/JS)]] — [Wikipedia](https://en.wikipedia.org/wiki/Web_development_%28HTML/CSS/JS%29)
