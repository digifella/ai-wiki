...
Here is a [[concepts/markdown|markdown]] [[concepts/summary|summary]] of the video transcript, detailing the [[concepts/workflow|workflow]] for effective long-running [[concepts/ai-coding|AI coding]] [[concepts/agents|agents]].
...
* `**features_list.json**`: A JSON file listing every feature and its testing steps.
	* _Note:_ JSON is used instead of Markdown because [[concepts/models|models]] are less likely to corrupt the structure.
