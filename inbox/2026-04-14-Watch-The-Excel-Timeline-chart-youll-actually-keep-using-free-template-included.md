---
wiki-ingested: true
title: "Watch The Excel Timeline chart you'll actually keep using (free template included) on YouTube"
...
# Watch The [[entities/excel|Excel]] Timeline chart you'll actually keep using (free template included) on [[entities/youtube|YouTube]]

---
---
<https://www.youtube.com/watch?v=GP1W4fKWUrA>

Here is a [[concepts/markdown|Markdown]] [[concepts/summary|summary]] of the video [[concepts/tutorial|tutorial]] on creating a [[concepts/dynamic-project-timeline|dynamic project timeline]] in Excel.

# How to Create a Dynamic Project Timeline in Excel

This tutorial explains how to turn a standard Excel dataset into a professional, [[concepts/dynamic-timeline-chart|dynamic timeline chart]] in just a few minutes, avoiding the manual work required in PowerPoint.

## 1\. Data [[concepts/setup|Setup]]

Before creating the chart, organize your data into an [[concepts/excel-table|Excel Table]] ([[entities/ctrl-t|Ctrl + T]]) with three columns:

* **Date:** The date of the event.
* **Milestone:** The description of the event.
* **Level ([[concepts/helper-column|Helper Column]]):** This column determines the height and direction of the timeline "stems" to prevent text overlap.
