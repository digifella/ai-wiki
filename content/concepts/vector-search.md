...
## Core Mechanisms
- **Vector Embeddings**: Numerical representations of data (text, [[concepts/images|images]]) in a continuous vector space (e.g., via [[entities/bert|BERT]], Sentence [[concepts/transformers|Transformers]]).
...
- **[[concepts/graph-rag|Graph RAG]]**: A flexible alternative using [[concepts/knowledge-graphs|knowledge graphs]] and LLMs for structured retrieval. Does *not* require consistent models for embedding vs. retrieval, enabling more adaptable systems.
...
## Applications
- Semantic search in enterprise [[concepts/knowledge-bases|knowledge bases]]
- Personalized recommendations
- Contextual LLM augmentation via [[concepts/rag]]

2026 04 14 IBM Explainer creating [[concepts/graph-retrieval-augmented-generation|GraphRAG]]
