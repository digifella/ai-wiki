...
Git's operational [[concepts/open-source-philosophy|logic]] is rooted in its underlying data structures rather than a mere collection of memorized [[concepts/commands|commands]].

### Core Data Structures
- [[concepts/commits]]: Snapshots representing the state of the project at specific points in time.
