...
Pan searing is a cooking technique used to develop a flavorful crust on meat, particularly steak, by cooking it in a hot pan with minimal liquid. The method relies on high heat to trigger the [[concepts/maillard-reaction|Maillard reaction]], a chemical process that creates complex flavors and browning on the meat's surface. This approach contrasts with methods that use added moisture or lower temperatures, which can inhibit [[concepts/crust-formation|crust formation]].
