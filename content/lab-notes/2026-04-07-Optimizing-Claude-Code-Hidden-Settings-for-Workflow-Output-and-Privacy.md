---
wiki-ingested: true
title: "Optimizing Claude Code: Hidden Settings for Workflow, [Output](https://en.wikipedia.org/wiki/output), and Privacy"
...
**Clip title:** 12 [[concepts/output-control|Hidden Settings]] To Enable In Your [[concepts/ai-assisted-coding|Claude Code]] [[concepts/setup|Setup]]
...
managing [[concepts/conversation-history|conversation history]] and increasing output limits to orchestrating
...
- output — [Wikipedia](https://en.wikipedia.org/wiki/output)
...
- [[concepts/developer|developer]] — [Wikipedia](https://en.wikipedia.org/wiki/developer)
