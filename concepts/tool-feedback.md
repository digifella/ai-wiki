...
- **Essential Context Components**:
	...
	- External Knowledge
	- Tool feedback
- **Orchestration**: Frameworks like [[concepts/langgraph-framework|LangGraph]] support strategies for managing these inputs during agent trajectories.

**Source**:
- 2026 04 14 [[entities/langchain|Langchain]] [[concepts/ai-performance-optimization|context engineering]]
