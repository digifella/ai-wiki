...
Earthquake base isolation is a structural engineering technique that decouples buildings and other structures from ground motion during [[concepts/earthquakes|seismic events]]. Rather than anchoring a building rigidly to the ground, isolation systems use specialized bearings—typically installed between the foundation and the building superstructure—to allow limited relative [[concepts/exercise|movement]]. This decoupling reduces the transfer of seismic energy into the building, significantly decreasing the forces and accelerations experienced by the [[concepts/structure|structure]] and its contents.
