...
Google opened experimental access to Gemini Diffusion to selected users in mid-2025. Access is provided through a controlled rollout program, with notification sent to eligible accounts via Google's notification system. The experimental status indicates the model remains under active development and evaluation before potential wider release.
