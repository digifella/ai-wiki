...
---
## RAM
**RAM (Random Access [[concepts/memory|Memory]])** is a form of computer data [[entities/storage|storage]] that stores data and machine [[concepts/instructions|instructions]] currently being used. This volatile memory type allows data to be read or written in almost the same amount of time, regardless of the physical location of data inside the memory.
