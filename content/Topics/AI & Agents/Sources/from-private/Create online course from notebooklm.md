...
3. **Add [[concepts/training|Training]]:** It is recommended to attach a short video (via [[entities/youtube|YouTube]] or [[concepts/google-drive|Google Drive]]) demonstrating _how_ to log in and navigate the NotebookLM interface.
