...
Generated: 2026-07-11 · API: [[concepts/gemini-25-models|Gemini 2.5]] Flash · Modes: Summary
...
- [[concepts/schema-constrained-ai|Schema-Constrained AI]] — [Wikipedia](https://en.wikipedia.org/wiki/Schema-Constrained_AI)
- [[concepts/json-generation|JSON Generation]] — [Wikipedia](https://en.wikipedia.org/wiki/JSON_Generation)
...
- [[concepts/multi-language-support|Multi-Language Support]] — [Wikipedia](https://en.wikipedia.org/wiki/Multi-Language_Support)
- [[concepts/large-language-models|Large Language Models]] — [Wikipedia](https://en.wikipedia.org/wiki/Large_Language_Models)
- [[concepts/data-accuracy|Data Accuracy]] — [Wikipedia](https://en.wikipedia.org/wiki/Data_Accuracy)
- [[concepts/document-parsing|Document Parsing]] — [Wikipedia](https://en.wikipedia.org/wiki/Document_Parsing)
- [[concepts/malformed-json|Malformed JSON]] — [Wikipedia](https://en.wikipedia.org/wiki/Malformed_JSON)
- [[concepts/schema-constrained-ai|Schema-Constrained Decoding]] — [Wikipedia](https://en.wikipedia.org/wiki/Schema-Constrained_Decoding)
- [[concepts/document-based-qa|Hallucination Prevention]] — [Wikipedia](https://en.wikipedia.org/wiki/Hallucination_Prevention)
- Field Accuracy — [Wikipedia](https://en.wikipedia.org/wiki/Field_Accuracy)
- Null Handling — [Wikipedia](https://en.wikipedia.org/wiki/Null_Handling)
- [[concepts/gpu-acceleration|GPU Acceleration]] — [Wikipedia](https://en.wikipedia.org/wiki/GPU_Acceleration)
- Invoice Extraction — [Wikipedia](https://en.wikipedia.org/wiki/Invoice_Extraction)
- Ledger Processing — [Wikipedia](https://en.wikipedia.org/wiki/Ledger_Processing)

## Related Entities
- [[entities/lift|Lift]] — [Wikipedia](https://en.wikipedia.org/wiki/Lift)
- [[entities/datalab|Datalab]] — [Wikipedia](https://en.wikipedia.org/wiki/Datalab)
...
- Gemini Flash 3.5 — [Wikipedia](https://en.wikipedia.org/wiki/Gemini_Flash_3.5)
- Datalab API — [Wikipedia](https://en.wikipedia.org/wiki/Datalab_API)