...
Here is a [[concepts/summary|summary]] of the video on **[[entities/gary-explains|Clawdbot]]**, the [[concepts/open-source|open-source]] personal [[concepts/ai-assistant|AI assistant]].
...
## 🛠️ Integrations & [[concepts/setup|Setup]]
...
* **Model Agnostic:** Works with frontier [[concepts/models|models]] ([[entities/claude-4|Claude]] Opus/Sonnet, [[concepts/gpt-4|GPT-4]], [[concepts/gemini|Gemini]]) or **local models** via [[entities/lm-studio|LM Studio]].
...
## 💻 Local Models & [[concepts/cost|Cost]] Management
