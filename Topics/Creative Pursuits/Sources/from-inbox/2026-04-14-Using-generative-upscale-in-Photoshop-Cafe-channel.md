...
This video by [[entities/colin-smith|Colin Smith]] from [[entities/photoshopcafe|PhotoshopCAFE]] compares three upscaling tools available in Photoshop (specifically [[entities/photoshop-beta|Photoshop Beta]] at the time of recording) that utilize AI: Generative Upscale, Preserve Details 2.0 (found in [[concepts/image-size|Image Size]]), and [[concepts/super-zoom|Super Zoom]] (a [[entities/neural-filter|Neural Filter]]).
**Video Overview:**
