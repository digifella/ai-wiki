...
* It features a "[[concepts/reasoning|Reasoning]] Effort" setting (Low, Medium, High), similar to [[entities/claude-4|Claude]] 3 [[concepts/models|models]].
...
- [[entities/api|API]] — [Wikipedia](https://en.wikipedia.org/wiki/API)
