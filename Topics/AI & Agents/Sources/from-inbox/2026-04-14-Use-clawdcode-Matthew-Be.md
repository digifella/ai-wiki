...
Here is a summary of the video on **[[entities/gary-explains|Clawdbot]]**, the [[concepts/open-source|open-source]] [[concepts/personal-ai-assistant|personal AI assistant]].
...
* **Model Agnostic:** Works with frontier models (Claude Opus/Sonnet, GPT-4, [[concepts/gemini|Gemini]]) or **local models** via [[entities/lm-studio|LM Studio]].
