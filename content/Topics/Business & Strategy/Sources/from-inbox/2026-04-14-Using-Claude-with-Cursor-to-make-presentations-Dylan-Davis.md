...
---
# Using Claude with Cursor to make presentations. [[entities/dylan-davis|Dylan Davis]]
...
4. **Quick Edits**: Refine the design within the [[entities/claude-chat|Claude chat interface]].
