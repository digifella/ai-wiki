...
## Related Concepts
- [[concepts/minimalist-ai-architecture|Minimalist AI architecture]] — [Wikipedia](https://en.wikipedia.org/wiki/Minimalist_AI_architecture)
- [[concepts/read-tool|Read tool]] — [Wikipedia](https://en.wikipedia.org/wiki/Read_tool)
- [[concepts/write-tool|Write tool]] — [Wikipedia](https://en.wikipedia.org/wiki/Write_tool)
- [[concepts/edit-tool|Edit tool]] — [Wikipedia](https://en.wikipedia.org/wiki/Edit_tool)
- [[concepts/bash-tool|Bash tool]] — [Wikipedia](https://en.wikipedia.org/wiki/Bash_tool)
...
- [Modular AI agent toolkit](https://en.wikipedia.org/wiki/Modular_AI_agent_toolkit) — [Wikipedia](https://en.wikipedia.org/wiki/Modular_AI_agent_toolkit)
- Terminal UI (TUI) — [Wikipedia](https://en.wikipedia.org/wiki/Terminal_UI_%28TUI%29)
- [AI Agent Runtime](https://en.wikipedia.org/wiki/AI_Agent_Runtime) — [Wikipedia](https://en.wikipedia.org/wiki/AI_Agent_Runtime)
- [Unified LLM API](https://en.wikipedia.org/wiki/Unified_LLM_API) — [Wikipedia](https://en.wikipedia.org/wiki/Unified_LLM_API)
- [Conversation branching](https://en.wikipedia.org/wiki/Conversation_branching) — [Wikipedia](https://en.wikipedia.org/wiki/Conversation_branching)
- [Self-updating AI agents](https://en.wikipedia.org/wiki/Self-updating_AI_agents) — [Wikipedia](https://en.wikipedia.org/wiki/Self-updating_AI_agents)
- Unrestricted AI execution (YOLO mode) — [Wikipedia](https://en.wikipedia.org/wiki/Unrestricted_AI_execution_%28YOLO_mode%29)
...
- [Automated system monitoring](https://en.wikipedia.org/wiki/Automated_system_monitoring) — [Wikipedia](https://en.wikipedia.org/wiki/Automated_system_monitoring)
- [AI-driven UI modification](https://en.wikipedia.org/wiki/AI-driven_UI_modification) — [Wikipedia](https://en.wikipedia.org/wiki/AI-driven_UI_modification)
- [Custom AI extensions](https://en.wikipedia.org/wiki/Custom_AI_extensions) — [Wikipedia](https://en.wikipedia.org/wiki/Custom_AI_extensions)
- Bash-based [[concepts/automation|automation]] — [Wikipedia](https://en.wikipedia.org/wiki/Bash-based_automation)
- [Context-aware conversation management](https://en.wikipedia.org/wiki/Context-aware_conversation_management) — [Wikipedia](https://en.wikipedia.org/wiki/Context-aware_conversation_management)
