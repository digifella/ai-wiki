...
Here is a comprehensive [[concepts/markdown|Markdown]] summary and guide based on the video:

# The Ultimate Claude Code Desktop App [[concepts/workflow|Workflow]]

This guide details the "Master Workflow" for using the **Claude Code Desktop App**. By combining [[concepts/coding|local coding]], [[concepts/cloud-agents|cloud agents]], and a "[[concepts/co-pilot-ceo|Co-Pilot CEO]]" strategy within a single window, you can dramatically increase [[concepts/development-speed|development speed]] (10x) by running multiple work streams in parallel.
...
2. **Cloud Agent:** Builds features in the cloud via [[concepts/github-integration|GitHub integration]] (while you work locally).
