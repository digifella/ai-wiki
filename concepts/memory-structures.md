...
Architectural frameworks within [[concepts/agentic-ai]] used to regulate information [[concepts/storing|retention]], [[concepts/document-retrieval|retrieval]], and processing utility over time.
...
- Engineered specifically to mitigate [[concepts/context-rot]] (the degradation of information relevance and accuracy as [[concepts/context-windows|context windows]] expand).
- Focuses on structured retrieval to maintain agent performance across extended context usage.

## Key Terminology
- [[concepts/context-rot]]: The phenomenon where an agent's ability to retrieve or [[concepts/purpose|reason]] accurately degrades due to information [[concepts/density|density]], noise, or "lost in the middle" effects within a large [[concepts/context-window|context window]].
- [[concepts/ai-recall]]: The [[concepts/accuracy|precision]] and latency with which an agent retrieves specific historical or [[concepts/external-data|external data]] points from its memory layers.
