...
- **Primary [[concepts/vulnerability|Vulnerability]]**: The implementation of Shor's Algorithm on sufficiently large-scale, error-corrected quantum [[concepts/hardware|hardware]].
