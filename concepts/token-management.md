...
Strategies for optimizing token usage in language models, particularly addressing [[concepts/context-window|context window]] constraints and [[concepts/cost-efficient-solutions|cost efficiency]] in extended interactions.
...
## Effective Solutions
- **[[concepts/claude-code|Claude Code]] Workflow**: [[entities/anthropic-institute|Anthropic]]-developed technique for long-running [[concepts/coding|coding]] sessions, avoiding "one-shot" approaches by:
...
- **Progressive Context Loading**: [[concepts/retrieving|Retrieving]] only relevant [[concepts/historical-context|historical context]] per step
