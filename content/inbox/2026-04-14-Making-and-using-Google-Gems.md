---
wiki-ingested: true
title: "Making and using Google Gems"
...
---
# Making and using [[entities/google|Google]] Gems
...
Here is a detailed [[concepts/summary|summary]] of the video by [[entities/tim-peakman|Tim Peakman]] regarding how to optimize [[concepts/workflow|workflow]] using **[[concepts/google-gemini-gems|Google Gemini Gems]]**.

### **The Core Problem**

Peakman argues that the majority of people use [[concepts/large-language-models|Large Language Models]] (LLMs) like [[entities/chatgpt|ChatGPT]], [[concepts/claude|Claude]], and Gemini incorrectly. They waste time in a "back-and-forth" chat [[concepts/loop|loop]] trying to refine answers, often resulting in dissatisfaction. For solopreneurs and small teams, this inefficiency is costly. The [[concepts/solution|solution]] is moving from generic chatting to **[[concepts/custom-assistants|Custom Assistants]]**.

### **The Solution: Google Gemini Gems**

"Gems" are Google’s version of [[concepts/custom-gpts|Custom GPTs]]. They allow users to create [[concepts/specialized-ai-assistants|specialized AI assistants]] pre-loaded with specific [[concepts/instructions|instructions]] and knowledge, drastically reducing the need for repetitive [[concepts/prompting|prompting]].
...
2. **Task:** Define exactly what the AI needs to do. (e.g., "Create a keyword-rich [[entities/youtube|YouTube]] description designed to drive clicks.")
3. **Context:** Provide the background information necessary to complete the task. (e.g., "I [[entities/will|will]] provide the [[concepts/text-transcript|transcript]] and title; you simply need to ask me for them.")
4. **Format:** Be specific about the [[concepts/structure|structure]] of the output. (e.g., "Always start and end with the Call to Action link. Use bullet points for key learnings.")
