...
Kai is a [[concepts/aimm-ai-maturity-model|personal AI infrastructure]] project developed by [[entities/daniel-miessler|Daniel Miessler]] that integrates [[concepts/claude-ai|Claude]] as its core [[concepts/statistical-language-modeling|language model]] component. The project focuses on building practical systems for interacting with and leveraging [[concepts/capabilities|AI capabilities]] in individual workflows.
