...
aliases:
  ...
  - "Task-Based Memory Activation"
  - "Scalable Lookup System"
summary: Conditional memory is an LLM optimization technique that selectively activates memory modules based on task complexity to distinguish between deep reasoning and simple recall, thereby reducing computational waste in tran
updated: 2026-07-11
...
- **Mechanism**: Models conditionally access pre-stored knowledge only when required, reducing unnecessary computation for [[concepts/retrieving|recall]] tasks.
