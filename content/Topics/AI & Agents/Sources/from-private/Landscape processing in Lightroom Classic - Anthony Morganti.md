...
1. **Initial Image [[concepts/preparation|Preparation]]:**
	The presenter starts with a landscape image that has already undergone basic adjustments: straightening and minor tweaks to [[concepts/exposure|Exposure]], [[concepts/highlights|Highlights]], Shadows, Whites, and [[concepts/blacks|Blacks]] sliders in the Basic panel.
