...
The periodic table has traditionally been limited to around 118 elements, with the heaviest naturally occurring element being uranium (element 92). Beyond this point, scientists have synthesized increasingly heavy nuclei in particle accelerators, extending the table to include superheavy elements. However, these synthetic elements are extremely unstable, decaying almost instantaneously, which has raised fundamental questions about the limits of nuclear stability and whether the periodic table could extend even further.
