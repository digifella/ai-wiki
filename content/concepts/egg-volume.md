...
- **Raw vs Cooked**: The volume of eggs increases when they are cooked due to protein denaturation.
- **Egg Size Variability**: Large, [[entities/medium|medium]], and small eggs have different volumes, affecting recipes' ingredient ratios.
- **Impact on Recipes**: Egg volume directly influences the success of baked goods and custards.
...
### New Information from Scrambled Eggs Techniques Note:

- [[concepts/salting-eggs|Salting eggs]] before cooking draws out moisture, concentrating flavors.
- Using cream or milk adds volume to scrambled eggs for a richer texture.
- Choosing the right cookware is essential; stainless steel and cast iron are preferred over non-stick surfaces for better heat [[concepts/distribution|distribution]].
