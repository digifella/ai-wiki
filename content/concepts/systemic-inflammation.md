...
Systemic inflammation refers to chronic, low-grade inflammatory [[concepts/responses|responses]] occurring throughout the body rather than in a localized area. Unlike acute inflammation, which is a protective response to injury or infection, systemic inflammation persists over extended periods and has been linked to numerous age-related diseases including cardiovascular disease, diabetes, cognitive decline, and certain cancers. Biomarkers such as C-reactive protein and interleukin-6 are commonly measured to assess systemic inflammatory status.
