...
The primary function of hover states is to bridge the gap between static [[concepts/design|design]] and user interaction. By signaling interactivity before a user clicks, hover states reduce uncertainty and improve usability. They help prevent accidental clicks and [[entities/make|make]] interfaces feel more responsive and polished. Hover states also serve as [[concepts/affordances|affordances]]—visual cues that communicate an element's function—making it clear which parts of an interface can be acted upon.
