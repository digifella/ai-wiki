...
- "script-building"
  - "ai"
  - "video-production"
  - "[[concepts/ai-integrated-notebooks|notebooklm]]"
  - "[[concepts/gemini|gemini]]"
  - "[[concepts/veo|veo]]"
  - "ai-scripting"
  - "video-production-[[concepts/workflow|workflow]]"
  - "automated-narrative-generation"
  - "[[concepts/gemini|gemini]]-[[concepts/canvas|canvas]]"
group: [[concepts/architecture|architecture]]-cities-[[concepts/cultural-heritage|heritage]]

# Script Building

Generating structured narratives for media using [[concepts/ai-tools|AI tools]] to transform knowledge into compelling content.
