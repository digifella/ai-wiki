...
---
## [[entities/adobe|Adobe]] [[concepts/camera-raw|Camera Raw]] 18.3: Depth [[concepts/masking|Masking]], Lens Correction, Film Presets Overview
...
- Multi-depth Masks — [Wikipedia](https://en.wikipedia.org/wiki/Multi-depth_Masks)
- Edge Distortion Reduction — [Wikipedia](https://en.wikipedia.org/wiki/Edge_Distortion_Reduction)
- Cinematic Look — [Wikipedia](https://en.wikipedia.org/wiki/Cinematic_Look)
- Classic Film Emulation — [Wikipedia](https://en.wikipedia.org/wiki/Classic_Film_Emulation)
...
- [[entities/julianne-kost|Julianne Kost]] — [Wikipedia](https://en.wikipedia.org/wiki/Julianne_Kost)