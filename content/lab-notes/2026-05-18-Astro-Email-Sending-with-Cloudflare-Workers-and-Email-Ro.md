...
## Astro Email Sending with Cloudflare Workers and Email Routing
**[[concepts/clip-title|Clip title]]:** Send Emails with Cloudflare [[entities/email|Email]] Routing + Astro
...
So, let's [[entities/make|make]] it together. 💣 
