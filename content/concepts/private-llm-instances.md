...
[[concepts/deployment|Deployment]] of [[concepts/large-language-models|Large Language Models]] (LLMs) on isolated, user-controlled [[concepts/hardware|hardware]] or private clouds to ensure [[concepts/ai-security]] and eliminate third-party data logging.
...
- **Mobile [[concepts/accessibility|Accessibility]]**: Expansion of interaction capabilities beyond desktop environments.
    - [[entities/anythingllm]] 1.12 "Channels" enables mobile interaction with [[concepts/self-hosted-llms]] without requiring complex [[concepts/setup|setup]] or configuration.
