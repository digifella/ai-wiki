...
Animated cartoons represent the most widely recognized form of the medium, using sequences of drawings or digital [[concepts/images|images]] to create the illusion of [[concepts/exercise|movement]]. Animation studios have produced cartoons for theatrical release, television broadcast, and [[concepts/movie-streaming|streaming platforms]], ranging from short-form content lasting minutes to feature-length films. The medium has evolved from traditional cel animation to computer-generated imagery, though hand-drawn techniques remain in use.
