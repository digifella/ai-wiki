...
aliases:
  ...
  - "Primordial Universe"
  - "First Light Era"
summary: The early universe encompasses the periods following the Big Bang, including cosmic inflation, recombination, and the Dark Ages, with recent JWST observations providing evidence for primordial Population III stars.
updated: 2026-07-11
...
The study of the [[concepts/primordial-universe|early universe]] focuses on understanding the first stages after the [[concepts/big-bang|Big Bang]], including [[concepts/cosmic-inflation|cosmic inflation]] and the formation of matter. Key elements include:
...
- Potential detection of [[concepts/population-iii-stars|Population III stars]] in [[entities/gn-z11|GN-z11]] by the [[concepts/jwst|James Webb Space Telescope]] ([[entities/jwst|JWST]]).
  - Evidence suggests these are among the universe's [[concepts/first-generation-of-stars|first generation of stars]].
