...
- The Fujifilm Autofocus Setup Guide details [[concepts/algorithmic-optimization|optimization techniques]] for AF-S, though Manual Focus is primarily used when autofocus must be disengaged.

## Adobe Lightroom Camera App
- [[entities/adobe-lightroom|Adobe Lightroom]] (LR) has released a beta [[concepts/camera-app|camera app]] for [[entities/iphone-13-pro|iPhone 13 Pro]] and later, featuring advanced low-light capabilities including [[concepts/night-shots|night shots]], zoom, and [[concepts/reflection-removal|reflection removal]] (e.g., from [[entities/windows|windows]]/glasses).
...
2026 04 14 For those using LR and running iPhones this new Camera App from [[entities/adobe|Adobe]] is for YOU
## Source Notes
