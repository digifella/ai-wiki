...
type: "source-summary"
---
## Cloudflare [[entities/email|Email]] Service Beta: Integrated Email Sending, Routing, and AI [[concepts/workflow|Workflows]]
...
- Cloudflare Workers — [Wikipedia](https://en.wikipedia.org/wiki/Cloudflare_Workers)
- [[entities/gemma|Gemma]] Model — [Wikipedia](https://en.wikipedia.org/wiki/Gemma_Model)

## Related Entities
- Cloudflare Developers — [Wikipedia](https://en.wikipedia.org/wiki/Cloudflare_Developers)
- Cloudflare Email Service Beta — [Wikipedia](https://en.wikipedia.org/wiki/Cloudflare_Email_Service_Beta)
