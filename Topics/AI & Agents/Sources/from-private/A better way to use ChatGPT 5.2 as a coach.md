...
<https://www.youtube.com/watch?v=5t6p5OE48HQ>
Here is a [[concepts/markdown|Markdown]] summary and implementation guide based on the video transcript.

# The AI [[concepts/time-clarity-interview-system|Time Clarity Interview System]]

**The Core Concept:** Most business owners don't have a _time_ problem; they have a _clarity_ problem. They are on a "treadmill"—moving fast but not heading in a specific direction. This system flips the standard AI interaction: instead of you [[concepts/prompting|prompting]] the AI, the **AI interviews you** to audit how you spend your time.
...
* **The Format:** A 20–30 minute [[concepts/speech-recognition|voice-to-text]] interview.
* **The Tool:** [[entities/chatgpt|ChatGPT]] (specifically a model with [[concepts/reasoning|reasoning]] capabilities, like [[entities/gpt-52|GPT-5.2]] or GPT-4o) set to **Auto Mode** (allowing it to switch between fast responses for questions and deep thinking for the final audit).
...
* **Focus:** Alignment.
* **The Logic:** Compares _what you say you want_ vs. _what you actually do_.
...
### Step 3: [[entities/the-interview|The Interview]] (Dictation)
...
_To execute this, you need to paste a prompt into the AI. Here are the key components of that prompt based on the video:_
**Role & Objective:**
...
1. **Where Your Time is Going:** A reflection of personal patterns/habits.
2. **Where the Misalignment Is:** Name specific gaps between stated values and time allocation.
3. **What to Consider Changing:** Specific, actionable shifts or experiments.
4. **The Question to Sit With:** One deep, resonant question the user cannot answer quickly.
...
* **Testing:** Don't just assume your tasks are necessary. The AI [[entities/will|will]] push you to prove _why_ a task drives results (e.g., "How do you know _concretely_ that scripting is driving the value?").

## Related Concepts
- [[concepts/time-clarity|Time Clarity]] — [Wikipedia](https://en.wikipedia.org/wiki/Time_Clarity)
- [[concepts/ai-interview-system|AI Interview System]] — [Wikipedia](https://en.wikipedia.org/wiki/AI_Interview_System)
- [[concepts/treadmill-metaphor|Treadmill Metaphor]] — [Wikipedia](https://en.wikipedia.org/wiki/Treadmill_Metaphor)

## Related Entities
- The AI Time Clarity Interview System (system) — [Wikipedia](https://en.wikipedia.org/wiki/The_AI_Time_Clarity_Interview_System_%28system%29)
- [[entities/john-lee-dumas-channel|John Lee Dumas (channel)]] — [Wikipedia](https://en.wikipedia.org/wiki/John_Lee_Dumas_%28channel%29)