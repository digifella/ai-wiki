...
- **[[concepts/multi-modal-researcher|Langchain researcher]] with [[concepts/gemini|Gemini]] 2.5**
    - A multi-modal researcher tool utilizing [[entities/google-gemini|Google Gemini]] 2.5's [[concepts/native-capabilities|native capabilities]].
...
- **[[entities/google-labs|Google Labs]] [[entities/google-opal|Opal]]**
    ...
    - Utilizes natural language and [[concepts/visual-editing|visual editing]] to chain together [[concepts/prompt-engineering|prompts]], [[concepts/models|models]], and tools.
