...
Standard [[concepts/rag]] workflows process documents by chunking [[concepts/text|text]] into segments and storing embeddings in [[concepts/vector-databases]]. This approach [[concepts/faces|faces]] critical issues when:
...
- **Visualization**: Provides visualization [[concepts/capabilities|capabilities]] for the extraction process and results.
