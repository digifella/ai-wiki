...
- Virtualization: [[concepts/running|Running]] multiple isolated environments on a single host; requires robust network stability to ensure service [[concepts/continuity|continuity]].
