...
# Use [[concepts/gemini|Gemini]] [[concepts/deep-think|Deep Think]]

---
---
<https://www.youtube.com/watch?v=lWAH-gCQRbA>
Here is a summary of the video introducing Google's **[[entities/gemini-3-pro-deep-think|Gemini 3 Pro Deep Think]]**, covering how it works, its best [[concepts/use-cases|use cases]], practical demos, and the creator's current AI toolset.
...
* **The Result:**
	...
	2. **Quality Ideas:** It avoided generic "Start a SaaS" advice and offered specific concepts like a marketplace for AI [[entities/cursor|cursor]] rules ("RuleBook") or a "Context Cleaner" for GitHub repos ("RepoSensei").
...
* **Coding:** [[entities/claude-4|Claude]] 3.5 Sonnet / [[entities/claude-opus|Opus 4.5]] ("Still King")
* **Simple Q&A:** Gemini 3
...
* **Image Generation:** [[entities/nano-banana|Nanobanana]] Pro
