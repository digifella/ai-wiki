...
### Core Principles
- **Information Per Bit**: Maximizing semantic utility and [[concepts/reasoning|reasoning]] [[concepts/accuracy|accuracy]] within [[concepts/reduced-precision|reduced-precision]] [[concepts/weights|weights]].
...
### Recent Developments
- [[entities/bonzai-8b]] (developed by [[entities/prismml]]): An [[concepts/adoption|implementation]] of a [[concepts/1-bit-llm|1-bit LLM]] based on the [[concepts/qwen-3-8b|Qwen 2.0 8B]] [[concepts/architecture|architecture]], achieving high intelligence density.
- **[[concepts/transformer-training|Demystifying AI]]: Transformer [[concepts/training|Training]] on a [[entities/pdp-1144|1979 PDP-11]]**
    ...
    - [[concepts/summary|Summary]]: Demonstrates the [[concepts/training-process|training process]] of a [[concepts/neural-network|neural network]] using a transformer on a vintage 1979 [[concepts/pdp-1144|PDP-11/44]] computer with single [[concepts/cpu|CPU]] and limited [[concepts/memory|memory]], highlighting the core principles without relying on modern [[concepts/gpu-clusters|GPU clusters]].
