...
[[concepts/turing-completeness|Turing completeness]] describes the computational [[concepts/power|power]] of a system—whether it can solve any computable problem, given sufficient time and [[concepts/memory|memory]]. Because the formal definition involves abstract [[concepts/history-of-science-and-conceptsmathematicsmathematics|mathematical concepts]], analogies are useful for developing intuition about what Turing completeness means and why it matters.
