...
- Launch [[concepts/cost-optimization|cost optimization]] — [Wikipedia](https://en.wikipedia.org/wiki/Launch_cost_optimization)
- [Orbital bandwidth](https://en.wikipedia.org/wiki/Orbital_bandwidth) — [Wikipedia](https://en.wikipedia.org/wiki/Orbital_bandwidth)
- [[concepts/techno-economic-modeling|Space-based infrastructure]] — [Wikipedia](https://en.wikipedia.org/wiki/Space-based_infrastructure)
