...
for AI, providing it with persistent [[concepts/memory|memory]] and context.
...
an interactive "second brain."

The [[concepts/setup-process|setup process]] begins by downloading and installing Obsidian, then
creating a new [local vault](https://en.wikipedia.org/wiki/Local_vault). Key community plugins are essential: "Terminal"
for running shell [[concepts/commands|commands]] directly within Obsidian, and "Templater" for
...
provides troubleshooting tips for common issues like the [Terminal plugin](https://en.wikipedia.org/wiki/Terminal_plugin)'s
resizing problems.
...
- [[concepts/smart-coding-agent|AI coding agent]] — [Wikipedia](https://en.wikipedia.org/wiki/AI_coding_agent)
...
- Terminal plugin — [Wikipedia](https://en.wikipedia.org/wiki/Terminal_plugin)
- [Templater plugin](https://en.wikipedia.org/wiki/Templater_plugin) — [Wikipedia](https://en.wikipedia.org/wiki/Templater_plugin)
- [[concepts/pdp-11-conceptsarchitecturearchitecture|Instruction set]] — [Wikipedia](https://en.wikipedia.org/wiki/Instruction_set)
- [[concepts/automation|Automation]] architecture — [Wikipedia](https://en.wikipedia.org/wiki/Automation_architecture)
- [[concepts/autonomous-task-execution|Task execution]] — [Wikipedia](https://en.wikipedia.org/wiki/Task_execution)
- Local vault — [Wikipedia](https://en.wikipedia.org/wiki/Local_vault)
