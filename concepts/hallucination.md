...
A phenomenon where an [[concepts/ai-system|AI system]] generates content that is not grounded in its [[concepts/training-data|training data]] or [[concepts/external-knowledge|external knowledge]] sources, often appearing as fabricated or incorrect information.
...
## Causes
- **Data gaps**: Insufficient or noisy [[concepts/language-data|training data]].
...
- **[[concepts/expertise-based-ai-assistants|Multi-agent systems]]**: Combining multiple LLMs to cross-validate outputs.
...
## References
- 2026 04 14 [[entities/anthropic|Anthropic]] multi agent [[entities/deep-research|deep Research]] agent
