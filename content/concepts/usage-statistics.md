...
Metrics and monitoring [[concepts/capabilities|capabilities]] within [[entities/claude-code]] used to track resource consumption, [[concepts/session|session]] history, and operational limits.
