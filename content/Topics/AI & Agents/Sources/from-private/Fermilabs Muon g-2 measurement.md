...
---
<https://www.youtube.com/watch?v=6LAgV9j9ra8>
This video provides an overview of the [[concepts/muon|Muon]] g-2 experiment at Fermilab, its [[concepts/purpose|purpose]], [[concepts/methodology|methodology]], and the significance of its upcoming 2025 results.
Here's a detailed [[concepts/summary|summary]]:
**1\. Introduction to the Muon g-2 Experiment:**

* The Muon g-2 experiment is a large-scale [[concepts/particle-physics|particle physics]] experiment housed in a building-sized facility at Fermilab.
* Its primary goal is to study a fundamental property of muons, which are subatomic particles.
* The experiment is designed to test the Standard Model of particle physics, which is the current comprehensive [[concepts/theory|theory]] describing all known elementary particles and forces.

**2\. Understanding Muons and the [[concepts/g-factor|g-factor]]:**

* Muons are subatomic particles that, in some ways, are similar to electrons but are much heavier. They are constantly "raining" from the sky due to [[concepts/cosmic-rays|cosmic rays]].
...
**3\. [[concepts/historical-context|Historical Context]] and Fermilab's Role:**
...
* The Fermilab experiment aims for unprecedented precision, targeting 140 parts per billion (ppb) sensitivity. Simon Corrodi illustrates this precision by saying it's like measuring his 36-year life to an [[concepts/accuracy|accuracy]] of 2 minutes.
* Data collection involves Fermilab's accelerators sending muons into a [[entities/storage|storage]] ring. The experiment can store about 5,000 muons at a time.
...
* **Systematic Uncertainty:** This relates to potential biases or inaccuracies in the experimental [[concepts/setup|setup]] and data acquisition methods. Over the course of the experiment, new subsystems were implemented to reduce these systematic uncertainties.
...
* The measured value for the muon's anomalous magnetic moment (a\_mu) is **0.001165920705**, achieved with a remarkable precision of approximately **127 parts per billion**.
...
* **Implications for New Physics:** This persistent discrepancy suggests that the Standard Model, despite its successes, may not be complete. It hints at the existence of unknown particles or forces that interact with muons and contribute to their anomalous magnetic moment. The extreme precision of the Muon g-2 measurement puts very tight constraints on new theoretical [[concepts/models|models]] that attempt to explain this phenomenon, guiding physicists towards discovering fundamental new aspects of nature.
...
## Related Concepts
- [[concepts/muon-g-2-experiment|Muon g-2 Experiment]] — [Wikipedia](https://en.wikipedia.org/wiki/Muon_g-2_Experiment)
- [[concepts/standard-model-of-particle-physics|Standard Model of particle physics]] — [Wikipedia](https://en.wikipedia.org/wiki/Standard_Model_of_particle_physics)
- [[concepts/muons|muons]] — [Wikipedia](https://en.wikipedia.org/wiki/muons)
- [[concepts/subatomic-particles|subatomic particles]] — [Wikipedia](https://en.wikipedia.org/wiki/subatomic_particles)
- [[concepts/particle-physics-experiments|particle physics experiments]] — [Wikipedia](https://en.wikipedia.org/wiki/particle_physics_experiments)

## Related Entities
- [[entities/muon-g-2-experiment|Muon g-2 experiment]] — [Wikipedia](https://en.wikipedia.org/wiki/Muon_g-2_experiment)
- Fermilab — [Wikipedia](https://en.wikipedia.org/wiki/Fermilab)
- Dirac's theory — [Wikipedia](https://en.wikipedia.org/wiki/Dirac%27s_theory)
- Brookhaven National Laboratory — [Wikipedia](https://en.wikipedia.org/wiki/Brookhaven_National_Laboratory)
- Simon Corrodi — [Wikipedia](https://en.wikipedia.org/wiki/Simon_Corrodi)