...
Here is a [[concepts/markdown|Markdown]] summary of the [[concepts/claude-code|Claude Code]] updates discussed in the video.
...
* **Function:** Displays detailed usage metrics including:
	...
	* Cost breakdown by model (e.g., Sonnet vs. [[entities/opus|Opus]]).
	* [[concepts/coding|Coding]] streaks and session duration.
* _Note:_ Allows users to track spend on specific models (e.g., [[entities/claude-opus|Opus 4.5]] vs Sonnet 3.5).
