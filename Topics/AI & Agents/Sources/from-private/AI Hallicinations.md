...
## title: [[entities/youtube|YouTube]] Summary Report date: 2026-03-06 source\_type: youtube\_summary api: [[entities/gemini-25-flash|Gemini 2.5 Flash]] modes: Summary, Key Timestamps
...
* \[02:55\] — **Explanation 1: Data Distribution Imbalances.** Models struggle with "long-tail facts" (rare information) from their vast [[concepts/training-data|training data]], leading to fabrication.
