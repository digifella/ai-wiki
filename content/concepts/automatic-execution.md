...
- **[[concepts/execution-orchestration|AI Agent Orchestration]]**: Using predefined [[entities/agent|agent]] behaviors (like [[concepts/instruction-reuse|Claude Skills]]) to chain actions across tools, reducing human oversight in multi-step processes.
- **[[concepts/workflow|Workflow]] [[concepts/templates|Templates]]**: Pre-configured execution paths (e.g., data processing, content generation) that trigger automatically upon input conditions.
