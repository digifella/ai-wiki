...
An experimental [[concepts/no-code]] tool from [[entities/google-labs]] designed for describing, creating, and sharing [[concepts/ai-mini-applications]].

- **Mechanism**: Uses [[concepts/natural-language-descriptions|natural language descriptions]] and [[concepts/visual-editing|visual editing]] to chain together prompts, [[concepts/models]], and tools.
- **Objective**: Facilitates the democratization of [[concepts/software|software]] creation by allowing users to build [[concepts/ai-powered-applications|AI-powered applications]] without traditional programming [[concepts/skills|skills]].
