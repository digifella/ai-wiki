...
## [[entities/hermes|Hermes]] [[entities/agent|Agent]]: [[concepts/intelligence-explosion|Self-Improving AI]] for Adaptive User [[concepts/learning|Learning]]
...
- Model-Agnosticity — [Wikipedia](https://en.wikipedia.org/wiki/Model-Agnosticity)
...
- OpenPortal — [Wikipedia](https://en.wikipedia.org/wiki/OpenPortal)
