...
The system mimics [[concepts/coding|coding]] [[concepts/agents|agents]] (like [[concepts/claude-code|Claude Code]]) and utilizes an event-driven loop via **[[entities/llamaindex|LlamaIndex]]**.
