...
Colorization is commonly applied to historical photographs, preserving visual materials from the pre-color photography era. The process is useful for archival work and creating alternative visual presentations of existing images. However, colorization produces interpretive results rather than historically accurate reproduction, since the original color information is absent from the source material.
