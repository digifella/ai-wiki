---
wiki-ingested: true
title: "Using Claude code for product build"
...
# Using [[concepts/claude-code|Claude code]] for product build

---
---
<https://www.youtube.com/watch?v=qNymWffkcgc>
Need to create [[concepts/product-requirements-document|Product Requirements Document]] as a [[concepts/markdown|markdown]]

Then Claude can produce a [Taskmanager.md](https://Tasks.md) file that can it can use to build [[concepts/subagents|subagents]]

This video details a [[entities/developer|developer]]'s journey to overcome "errors and hallucinations" encountered while using Claude Code for a project, attributing these issues to an improper setup and inefficient [[concepts/workflow|workflow]]. The [[entities/speaker|speaker]] shares a structured approach that significantly improved his productivity and clarity.
**The Problem:** Initially, the developer encountered numerous issues when transitioning his project from [[entities/boltnew|Bolt.new]] to Claude Code. His primary challenge was Claude's tendency to generate errors and "hallucinate" incorrect solutions. He realized the core problem stemmed from:
