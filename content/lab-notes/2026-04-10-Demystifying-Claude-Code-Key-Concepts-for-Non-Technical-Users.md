...
code. Interaction is simplified by explaining the **[[concepts/terminal|Terminal]] / CLI** as
...
- Tools (Read, Write, Bash) — [Wikipedia](https://en.wikipedia.org/wiki/Tools_%28Read%2C_Write%2C_Bash%29)
