...
Power outages result from both natural and human-made causes. [[concepts/severe-weather-events|Severe weather events]]—particularly [[concepts/winter-storms|winter storms]], hurricanes, and ice storms—represent primary triggers, as high winds damage transmission lines, heavy snow and ice add weight to infrastructure, and lightning strikes equipment. Equipment failures, maintenance accidents, and grid management errors also cause outages. In regions with aging [[concepts/electrical-grid-management|electrical infrastructure]] or insufficient generation capacity, demand surges during extreme temperatures can overwhelm the system.
