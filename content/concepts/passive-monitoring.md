...
Passive monitoring refers to the continuous, automated collection of [[concepts/health|health]] and wellness data through [[concepts/wearable-devices|wearable devices]] without requiring active user engagement. Unlike traditional health monitoring that depends on patients consciously recording information or attending appointments, passive monitoring operates in the background, collecting data through [[concepts/embedded-sensors|embedded sensors]] as users go about their daily activities. This approach has become increasingly valuable in [[concepts/allied-health|allied health]] settings, where ongoing observation of patient status can inform treatment decisions and early intervention strategies.
