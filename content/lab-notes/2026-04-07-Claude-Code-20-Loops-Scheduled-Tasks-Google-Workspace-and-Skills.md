...
Workspace Access, and Built-in [[concepts/skills-testing|Skills Testing]] (also known as Skills 2.0),
each addressing different facets of AI-powered task management and
development.
...
Finally, "[[concepts/built-in-skills-testing|Built-in Skills Testing]]," or Skills 2.0, introduces a
...
`eval-viewer` feature runs multiple skill variations in parallel, providing
...
- [[concepts/google-workspace-access|Google Workspace Access]] — [Wikipedia](https://en.wikipedia.org/wiki/Google_Workspace_Access)
...
- [[concepts/ai-powered-task-management|AI-powered task management]] — [Wikipedia](https://en.wikipedia.org/wiki/AI-powered_task_management)
...
- [Automated skill evaluation](https://en.wikipedia.org/wiki/Automated_skill_evaluation) — [Wikipedia](https://en.wikipedia.org/wiki/Automated_skill_evaluation)
