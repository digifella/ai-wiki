---
wiki-ingested: true
title: "Real use cases for ChatGPT Agent Grace Leung - marketing use"
...
# Real [[concepts/scenarios|use cases]] for [[concepts/chatgpt-agent|ChatGPT Agent]] [[entities/grace-leung|Grace Leung]] - marketing use

---
---
<https://www.youtube.com/watch?v=SGRX7crXpV8>
This video provides an exciting overview of **ChatGPT Agent**, a new feature within ChatGPT that aims to automate complex, multi-step tasks by allowing the AI to control a browser, conduct [[entities/deep-research|deep research]], and leverage all of ChatGPT's existing [[concepts/capabilities|capabilities]] (image generation, scheduling, connectors, project management).
Here's a detailed [[concepts/summary|summary]] of its features and demonstrated use cases:
**What is ChatGPT Agent?** ChatGPT Agent is described as a "[[concepts/general-purpose-ai-agent|general-purpose AI agent]] that actually does things for you." It combines:

* **[[concepts/browser-control|Browser Control]]:** Allows ChatGPT to navigate websites, click elements, and interact with web pages directly.
...
* **Stability Issues:** May occasionally crash or lose [[concepts/connection|connection]], requiring re-engagement or re-starting.
...
* Require **Research + Building** (all in one [[concepts/workflow|workflow]]).
* Involve **Cross-platforms** AND need **complex [[concepts/decision-making|decision-making]]**.
* Are **time-consuming manual work** that **cannot be fully automated** by standard tools.
* Require **[[concepts/reasoning|reasoning]]**, **complex decision-making**, **taking actions across platforms**, and **cannot benefit from standard [[concepts/ai-automation|AI automation]]**.
