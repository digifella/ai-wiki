...
- **Protocol-based Standardization**: The [[concepts/model-context-protocol]] (MCP) is emerging as a way to relate APIs to the specific needs of [[concepts/agentic-ai]], facilitating more seamless [[concepts/integration|integration]] of context.

---
**Source**: 2026 04 14 MCP vs API for LLM by [[entities/ibm|IBM]]
## Source Notes
