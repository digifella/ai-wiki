...
- [[concepts/ai-image-workflows|AI image workflows]] — [Wikipedia](https://en.wikipedia.org/wiki/AI_image_workflows)
- JSON-structured prompts — [Wikipedia](https://en.wikipedia.org/wiki/JSON-structured_prompts)
- [image consistency](https://en.wikipedia.org/wiki/image_consistency) — [Wikipedia](https://en.wikipedia.org/wiki/image_consistency)
- aspect ratio [[concepts/adjustments|adjustments]] — [Wikipedia](https://en.wikipedia.org/wiki/aspect_ratio_adjustments)
- [[concepts/ai-image-editing|in-image editing]] — [Wikipedia](https://en.wikipedia.org/wiki/in-image_editing)
- storyboarding — [Wikipedia](https://en.wikipedia.org/wiki/storyboarding)
- [[concepts/ai-image-generation|sequential image generation]] — [Wikipedia](https://en.wikipedia.org/wiki/sequential_image_generation)
- [[concepts/thinking-mode|Thinking mode]] — [Wikipedia](https://en.wikipedia.org/wiki/Thinking_mode)
- [AI image artifacts](https://en.wikipedia.org/wiki/AI_image_artifacts) — [Wikipedia](https://en.wikipedia.org/wiki/AI_image_artifacts)
- narrative development — [Wikipedia](https://en.wikipedia.org/wiki/narrative_development)
- [image-to-image consistency](https://en.wikipedia.org/wiki/image-to-image_consistency) — [Wikipedia](https://en.wikipedia.org/wiki/image-to-image_consistency)
