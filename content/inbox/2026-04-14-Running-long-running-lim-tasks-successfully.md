...
---
# [[concepts/running|Running]] long running lim tasks successfully

---
---
<https://www.youtube.com/watch?v=TJ-vWGCosdQ>
Here is a [[concepts/summary|summary]] of the video [[concepts/text-transcript|transcript]] discussing the paper **"Solving a Million-Step LLM Task with [[concepts/zero-errors|Zero Errors]],"** published by [[entities/cognizant-ai-lab|Cognizant AI Lab]] in November 2025.
...
While AI agents [[entities/excel|excel]] at short tasks (5-minute demos), they catastrophic fail at [[concepts/long-horizon-tasks|long-horizon tasks]] like migrating databases or [[concepts/writing|writing]] novels.

* **The Culprits:** [[concepts/context-drift|Context drift]] and [[concepts/hallucination|hallucination]].
...
The researchers discovered a new [[concepts/scaling-law|scaling law]]: **Small [[concepts/models|Models]] + Voting < Big Models (Cost)**.
...
## 👨‍💻 [[entities/developer|Developer]] Blueprint: How to Apply MAKER Today

If you are building [[concepts/software|software]] agents, stop waiting for [[concepts/gpt-5|GPT-5]] and change your architecture:

1. **Define Atomic State:** Stop relying on chat history. Define state via file [[concepts/systems|systems]], dataframes, or compiler logs.
