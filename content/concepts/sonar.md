...
Active sonar generates its own sound waves and measures the returning reflections, making it effective for precise [[concepts/object-detection|object detection]] and ranging but also more likely to be detected by others. Passive sonar listens for sound waves produced by other sources, such as ship engines or marine life, without emitting signals of its own. This approach is quieter and harder to detect but provides less detailed information about target location and characteristics.
