...
Despite frontier models like **[[concepts/gpt-52|GPT-5.2]]**, **[[entities/claude-4|Claude 4]].6**, and **[[entities/gemini-3|Gemini 3]]** scoring 90%+ on standard benchmarks, they fail at real-world professional tasks.

* **The [[concepts/apex-benchmark|APEX Benchmark]]:** A new [[concepts/benchmark-testing|benchmark testing]] [[concepts/agents|agents]] on [[concepts/long-horizon-professional-work|long-horizon professional work]] (consultancy, law, investment analysis).
* **Results:** The best models (Opus 4.6) achieved only a **29.8% success rate**.
...
* The harness handles:
	...
	* What tools it can use ([[concepts/tool-orchestration|Tool Orchestration]]).
	* How it recovers from errors (Error Recovery).
	* How it tracks progress over long periods (Memory).
...
* **Core Insight:** Performance gain came from **removing** complex [[concepts/document-retrieval|document retrieval]] [[concepts/systems|systems]] and fancy routing logic.
* **External Memory:** They treated the **file system ([[concepts/markdown|Markdown]] files)** as external memory instead of stuffing everything into the [[concepts/context-window|context window]]. This prevents "[[concepts/context-rot|context rot]]" where noise drowns out the signal in long tasks.
...
* **The Shift:** Engineers no longer write code; they **[[concepts/design|design]] environments and [[concepts/feedback|feedback]] loops** for agents.
...
Referencing Richard Sutton’s "The Bitter Lesson," the video argues that [[concepts/methods|methods]] [[concepts/scaling|scaling]] with [[concepts/compute|compute]] and simplicity always beat those relying on human-engineered complexity.
...
### **5\. [[entities/developer|Developer]] Recommendations for 2026**
