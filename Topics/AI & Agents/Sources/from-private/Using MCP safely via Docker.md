...
Here is a detailed [[concepts/markdown|Markdown]] summary of the video transcript regarding the evolution of the Model Context Protocol (MCP) and [[concepts/docker|Docker]]'s new solutions.
...
* **Inefficiency:** Agents become slow and expensive because they are aware of too many tools they [[entities/will|will]] never use in a specific [[concepts/session|session]].
