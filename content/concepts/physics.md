...
Physics investigates phenomena across multiple domains of scale and complexity. Classical physics addresses the motion of macroscopic objects and the behavior of forces in everyday experience. Modern physics extends understanding to extreme conditions: [[concepts/quantum-mechanics|quantum mechanics]] governs the subatomic realm, while general relativity describes [[concepts/gravitational-pull|gravity]] and the [[concepts/structure|structure]] of spacetime. Physicists employ both [[concepts/theoretical-frameworks|theoretical frameworks]] and experimental methods, using controlled observations to test predictions and refine existing theories.
