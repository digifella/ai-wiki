...
* \[4:27\] — Key Example of Harness Impact: The _same_ Claude model scored 78% on a benchmark when running in Claude Code's harness, but only 42% when running in a different harness ("Small Agents"), demonstrating the dramatic influence of the harness.
