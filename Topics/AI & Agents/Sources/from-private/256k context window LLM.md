...
This video provides a detailed overview and demonstration of **AI21 [[entities/labs|Labs]]' newly released Jamba 1.7 model**, emphasizing its unique **hybrid SSM-Transformer [[concepts/architecture|architecture]]**. <https://www.ai21.com/jamba/>
**Key Information about Jamba 1.7:**

* **Release:** Just released by AI21 Labs.
* **Flavors:** Available in Jamba Mini 1.7 and [[entities/jamba|Jamba Large 1.7]]. The video focuses on **Jamba Large 1.7**.
* **Architecture:** It features a novel **Hybrid SSM-Transformer foundation model**. **[[concepts/transformers|Transformers]]:** Known for powerful self-[[concepts/attention|attention]] and understanding complex context (like GPT models), but computationally expensive and slow for very long texts. **SSM ([[concepts/state-space-model|State Space Model]]):** Highly efficient at processing long sequences of data, uses less [[concepts/memory|memory]], and is much faster for long contexts, but traditionally less powerful at complex [[concepts/reasoning|reasoning]]. **Hybrid Approach:** Jamba combines the strengths of both. It strategically uses Transformer components for their [[concepts/deep-reasoning|deep reasoning]] abilities and SSM components for their speed and efficiency with long sequences. This allows it to process an "enormous amount of information" (up to **256k [[concepts/context-window|context window]]**) while remaining efficient and fast.
* **Previous Versions:** The speaker [[concepts/notes|notes]] they have covered previous Jamba versions (1.5, 1.6) and highlights the rapid evolution of these models.
...
- 256k [[concepts/context-window|context window]] — [Wikipedia](https://en.wikipedia.org/wiki/256k_context_window)
- [[concepts/artificial-general-intelligence|Self-supervised learning]] — [Wikipedia](https://en.wikipedia.org/wiki/Self-supervised_learning)
- Long sequence processing — [Wikipedia](https://en.wikipedia.org/wiki/Long_sequence_processing)

## Related Entities
- [[entities/ai21-labs|AI21 Labs]] — [Wikipedia](https://en.wikipedia.org/wiki/AI21_Labs)
- [[entities/jamba-17|Jamba 1.7]] — [Wikipedia](https://en.wikipedia.org/wiki/Jamba_1.7)
- Transformers — [Wikipedia](https://en.wikipedia.org/wiki/Transformers)
- State Space Model (SSM) — [Wikipedia](https://en.wikipedia.org/wiki/State_Space_Model_%28SSM%29)
- GPT models — [Wikipedia](https://en.wikipedia.org/wiki/GPT_models)
- 256k context window — [Wikipedia](https://en.wikipedia.org/wiki/256k_context_window)