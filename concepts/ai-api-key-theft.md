...
## Overview
Attackers target [[concepts/api-keys|API keys]] to access [[concepts/large-language-model]] endpoints, exploit [[concepts/computational-resources|computational resources]], and manipulate outputs. Threats range from static credential leaks to active injection campaigns.
...
- **IBM Analysis**: [[entities/ibm-technology]] highlights LLMjacking as a primary concern; hackers "stick you with the bill" by maximizing API consumption before detection.
