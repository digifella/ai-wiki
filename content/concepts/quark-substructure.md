...
The hypothesis that quarks are not fundamental, [[concepts/point-like-particles|point-like particles]] but instead possess an internal composition of even smaller constituents.

## Theoretical Framework
- Under the [[concepts/standard-model]], quarks are classified as [[concepts/elementary-particles|elementary particles]] with no known internal [[concepts/structure|structure]].
- Any evidence of internal complexity would necessitate the development of [[concepts/physics|physics]] beyond the [[concepts/standard-model]].
