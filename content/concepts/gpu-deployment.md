...
[[concepts/deployment|Deployment]] of [[concepts/artificial-intelligence-models|machine learning models]] utilizing Graphics Processing Units for parallel computation acceleration. Critical for [[concepts/inference|inference]] and [[concepts/training|training]] of [[concepts/large-language-model-llm|large language models]] where throughput and latency requirements exceed [[concepts/cpu|CPU]] [[concepts/capabilities|capabilities]]. Involves [[concepts/vram-management|VRAM management]], tensor splitting, and offloading strategies to handle parameter counts exceeding single-device [[concepts/memory|memory]] limits.
...
- [[concepts/model-compression]]: [[concepts/precision-reduction|Precision reduction]] (e.g., Q4, Q8) to minimize [[concepts/vram|VRAM]] footprint while maintaining acceptable [[concepts/output|output]] quality.

## Recent Implementations
- **[[entities/m27|MiniMax-M2.7]]**: 229B parameter [[concepts/open-source-model|open-source model]] deployed locally via [[entities/llamacpp]] with aggressive [[concepts/parameter-reduction|quantization]]. Demonstrates viable CPU/GPU hybrid inference for massive [[concepts/models|models]] on accessible [[concepts/hardware|hardware]] configurations. [[lab-notes/2026-05-18-MiniMax-M2.7-Local-CPUGPU-Deployment-via-llama.cpp-Quant|MiniMax-M2.7 Local CPU/GPU Deployment via llama.cpp Quantization]]
