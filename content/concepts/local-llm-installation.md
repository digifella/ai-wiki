...
The [[concepts/deployment|deployment]] of [[concepts/large-language-models]] on local [[concepts/hardware|hardware]] to ensure [[concepts/privacy|privacy]] and enable [[concepts/agentic-ai]] [[concepts/workflow|workflows]] through Tool Use.
...
- **[[concepts/capabilities|Capabilities]]**: [[concepts/agentic-ai]], [[concepts/tool-calling|Function Calling]], Tool Use.

## Recent Developments
- **[[concepts/qwen-model|Qwen3-Coder-Flash]] [[concepts/adoption|Implementation]]**:
    - Specialized focus on [[concepts/agentic-ai]] and [[concepts/tool-use-capabilities|Tool Use capabilities]].
    - Comprehensive installation and [[concepts/testing|testing]] guide by [[entities/fahd-mirza|Fahd Mirza]]: [Video Link](https://www.youtube.com/watch?v=IaqzrByS8yA)
    - Covers full workflow from environment [[concepts/setup|setup]] to advanced functional demonstration.
