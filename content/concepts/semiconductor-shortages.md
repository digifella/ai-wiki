...
Semiconductor shortages occur when global supply of chips falls below demand, constraining production across industries that depend on computing [[concepts/hardware|hardware]]. These constraints became particularly acute following the COVID-19 pandemic, disrupting automotive manufacturing, consumer electronics, and data center expansion. The underlying causes include concentrated manufacturing capacity in specific regions, long production lead times, and unpredictable demand spikes. Recovery from shortage periods typically takes 18-24 months as fabrication capacity [[concepts/musical-scales|scales]].
