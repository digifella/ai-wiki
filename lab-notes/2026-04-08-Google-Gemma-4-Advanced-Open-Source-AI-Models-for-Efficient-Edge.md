...
capabilities. It supports [[concepts/advanced-reasoning|advanced reasoning]], including [multi-step planning](https://en.wikipedia.org/wiki/Multi-step_planning)
...
understanding, and native audio input), and multilingual support across
