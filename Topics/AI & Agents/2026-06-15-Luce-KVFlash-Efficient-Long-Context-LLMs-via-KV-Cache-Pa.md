...
## Related Concepts
- [[concepts/kv-cache-paging|KV Cache Paging]] — [Wikipedia](https://en.wikipedia.org/wiki/KV_Cache_Paging)
- [[concepts/vram-management|GPU Memory Optimization]] — [Wikipedia](https://en.wikipedia.org/wiki/GPU_Memory_Optimization)
- [[concepts/long-context-llms|Long-Context LLMs]] — [Wikipedia](https://en.wikipedia.org/wiki/Long-Context_LLMs)
- GPU [[concepts/low-vram-generation|VRAM Optimization]] — [Wikipedia](https://en.wikipedia.org/wiki/GPU_VRAM_Optimization)
- Long-Context [[concepts/llm-inference|LLM Inference]] — [Wikipedia](https://en.wikipedia.org/wiki/Long-Context_LLM_Inference)
- Virtual [[concepts/memory-management|Memory Management]] — [Wikipedia](https://en.wikipedia.org/wiki/Virtual_Memory_Management)
- Host RAM Offloading — [Wikipedia](https://en.wikipedia.org/wiki/Host_RAM_Offloading)
- Key-Value Cache Bottleneck — [Wikipedia](https://en.wikipedia.org/wiki/Key-Value_Cache_Bottleneck)
- Dynamic Data Fetching — [Wikipedia](https://en.wikipedia.org/wiki/Dynamic_Data_Fetching)
- Resident KV Pool — [Wikipedia](https://en.wikipedia.org/wiki/Resident_KV_Pool)
- Cold Chunk Management — [Wikipedia](https://en.wikipedia.org/wiki/Cold_Chunk_Management)
- Prompt Prefilling Efficiency — [Wikipedia](https://en.wikipedia.org/wiki/Prompt_Prefilling_Efficiency)
- Decoding [[concepts/speed-enhancements|Speed Optimization]] — [Wikipedia](https://en.wikipedia.org/wiki/Decoding_Speed_Optimization)
...
- Owen3.6-27B — [Wikipedia](https://en.wikipedia.org/wiki/Owen3.6-27B)
- [[entities/gemini-25-flash|Gemini 2.5 Flash]] — [Wikipedia](https://en.wikipedia.org/wiki/Gemini_2.5_Flash)
- Lucebox — [Wikipedia](https://en.wikipedia.org/wiki/Lucebox)
